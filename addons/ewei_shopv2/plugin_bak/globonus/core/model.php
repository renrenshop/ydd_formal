		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			else if (($message_type == TM_GLOBONUS_UPGRADE) && empty($usernotice['globonus_upgrade'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成为' . $data['newlevel']['levelname'] . $set['texts']['partner'], 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '股东等级升级通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的股东等级从' . $data['oldlevel']['levelname'] . '升级到' . $data['newlevel']['levelname'] . ',特此通知！', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
			...
			else if (($message_type == TM_GLOBONUS_BECOME) && empty($usernotice['globonus_become'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成为' . $set['texts']['center'] . '的股东', 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '成为股东通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '恭喜您成为股东', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
				}
