	...
	class CycelbuyModel extends PluginModel 
	{
		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			else if ($message_type == TM_CYCELBUY_SELLER_SEND) 
			{
				...
				$message = array( 'first' => array('value' => '您有订单需要发货，请及时安排！', 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '订单发货通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '订单发货通知', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
				$datas[] = array('name' => '订单编号', 'value' => $data['ordersn']);
