...
class CashierModel extends PluginModel 
{
    ...
    public $setmeal = array();
    static public $UserSet = array();
    public function __construct($name = '')
    {
        parent::__construct();
        $this->resetClassInnerParam();
    }
    protected function resetClassInnerParam(){
        self::$paytype = array(0 => ''.$this->lang['lang_plugin_cashier_core_model_0'].'', 1 => ''.$this->lang['lang_plugin_cashier_core_model_1'].'', 2 => ''.$this->lang['lang_plugin_cashier_core_model_2'].'', 3 => ''.$this->lang['lang_plugin_cashier_core_model_3'].'', 101 => ''.$this->lang['lang_plugin_cashier_core_model_4'].'', 102 => ''.$this->lang['lang_plugin_cashier_core_model_5'].'');
        $this->setmeal = array(''.$this->lang['lang_plugin_cashier_core_model_6'].'', ''.$this->lang['lang_plugin_cashier_core_model_7'].'');
    }
	public function perm()
	{
		$perm = array('index' => ''.$this->lang['lang_plugin_cashier_core_model_8'].'', 'goods' => ''.$this->lang['lang_plugin_cashier_core_model_9'].'', 'order' => ''.$this->lang['lang_plugin_cashier_core_model_10'].'', 'statistics' => ''.$this->lang['lang_plugin_cashier_core_model_11'].'', 'sysset' => ''.$this->lang['lang_plugin_cashier_core_model_12'].'', 'sale' => ''.$this->lang['lang_plugin_cashier_core_model_13'].'', 'clearing' => ''.$this->lang['lang_plugin_cashier_core_model_14'].'', 'goodsmanage' => ''.$this->lang['lang_plugin_cashier_core_model_15'].'');
	...
	public function savaUser(array $params, $diyform = array()) 
	{
		...
		{
			show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_16'].'!');
		}
		if (empty($params['manageopenid'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_17'].'!');
		}
		if (empty($params['name'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_18'].'!');
		}
		if (empty($params['mobile'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_19'].'!');
		}
		if (empty($params['username'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_20'].'!');
		}
	...
	public function sendMessage($params, $type, $openid = NULL) 
	{
		...
		switch ($type) 
		{
			case self: $datas = array('['.$this->lang['lang_plugin_cashier_core_model_21'].']' => $params['name'], '['.$this->lang['lang_plugin_cashier_core_model_22'].']' => $params['mobile'], '['.$this->lang['lang_plugin_cashier_core_model_23'].']' => date('Y-m-d H:i:s', $params['createtime']));
			break;
			default: switch ($type) 
			{
				case self: $datas = array('['.$this->lang['lang_plugin_cashier_core_model_24'].']' => $params['name'], '['.$this->lang['lang_plugin_cashier_core_model_25'].']' => $params['mobile'], '['.$this->lang['lang_plugin_cashier_core_model_26'].']' => $params['status'], '['.$this->lang['lang_plugin_cashier_core_model_27'].']' => $params['createtime'], '['.$this->lang['lang_plugin_cashier_core_model_28'].']' => $params['reason']);
				break;
				default: switch ($type) 
				{
					case self: $datas = array('['.$this->lang['lang_plugin_cashier_core_model_29'].']' => $params['name'], '['.$this->lang['lang_plugin_cashier_core_model_30'].']' => $params['mobile'], '['.$this->lang['lang_plugin_cashier_core_model_31'].']' => $params['createtime'], '['.$this->lang['lang_plugin_cashier_core_model_32'].']' => $params['money']);
					break;
					default: switch ($type) 
					{
						case self: $datas = array('['.$this->lang['lang_plugin_cashier_core_model_33'].']' => $params['name'], '['.$this->lang['lang_plugin_cashier_core_model_34'].']' => $params['mobile'], '['.$this->lang['lang_plugin_cashier_core_model_35'].']' => $params['createtime'], '['.$this->lang['lang_plugin_cashier_core_model_36'].']' => $params['paytime'], '['.$this->lang['lang_plugin_cashier_core_model_37'].']' => $params['money'], '['.$this->lang['lang_plugin_cashier_core_model_38'].']' => $params['realmoney']);
						break;
						default: switch ($type) 
						{
							case self: $datas = array('['.$this->lang['lang_plugin_cashier_core_model_39'].']' => $params['logno'], '['.$this->lang['lang_plugin_cashier_core_model_40'].']' => $params['money'], '['.$this->lang['lang_plugin_cashier_core_model_41'].']' => $params['deduction'], '['.$this->lang['lang_plugin_cashier_core_model_42'].']' => $params['paytime'], '['.$this->lang['lang_plugin_cashier_core_model_43'].']' => $params['cashier_title']);
							break;
							default: switch ($type) 
							{
								case self: $datas = array('['.$this->lang['lang_plugin_cashier_core_model_44'].']' => $params['logno'], '['.$this->lang['lang_plugin_cashier_core_model_45'].']' => $params['money'], '['.$this->lang['lang_plugin_cashier_core_model_46'].']' => $params['deduction'], '['.$this->lang['lang_plugin_cashier_core_model_47'].']' => $params['paytime'], '['.$this->lang['lang_plugin_cashier_core_model_48'].']' => $params['cashier_title']);
								break;
								break;
	...
	public function createOrder(array $array, $return = NULL, $can_sale = true) 
	{
		...
		$title = $_W['cashieruser']['title'] . ''.$this->lang['lang_plugin_cashier_core_model_49'].'';
		...
		if (!($res)) 
		{
			return error(-2, ''.$this->lang['lang_plugin_cashier_core_model_50'].','.$this->lang['lang_plugin_cashier_core_model_51'].'!');
		}
	...
	public function pay($data, $auth_code = NULL) 
	{
		...
		if (($data['money'] <= 0) || ($data['paytype'] == 3)) 
		{
			...
			m('member')->setCredit($data['openid'], 'credit2', -$data['deduction'], array(0, ''.$this->lang['lang_plugin_cashier_core_model_52'].' ' . $_W['cashieruser']['title'], ''.$this->lang['lang_plugin_cashier_core_model_53'].''));
	...
	public function refund($id) 
	{
		...
		if ($pay_log['status'] != 1) 
		{
			return error(-1, ''.$this->lang['lang_plugin_cashier_core_model_54'].'!');
		}
		...
		switch ($pay_log['paytype']) 
		{
			...
			break;
			case '1': $res = m('finance')->newAlipayRefund(array('out_trade_no' => $pay_log['logno'], 'refund_amount' => $pay_log['money'], 'refund_reason' => $_W['cashieruser']['title'] . ' '.$this->lang['lang_plugin_cashier_core_model_55'].'! '.$this->lang['lang_plugin_cashier_core_model_56'].': ' . $out_trade_no), json_decode($_W['cashieruser']['alipay'], true));
			break;
			case '2': m('member')->setCredit($pay_log['openid'], 'credit2', $pay_log['money'] + $pay_log['deduction'], $_W['cashieruser']['title'] . ' '.$this->lang['lang_plugin_cashier_core_model_57'].'! '.$this->lang['lang_plugin_cashier_core_model_58'].'' . $out_trade_no);
			break;
			case '3': $res = true;
			break;
		...
		{
			m('member')->setCredit($pay_log['openid'], 'credit1', -$pay_log['present_credit1'], $_W['cashieruser']['title'] . ' '.$this->lang['lang_plugin_cashier_core_model_59'].'! '.$this->lang['lang_plugin_cashier_core_model_60'].'' . $out_trade_no);
		}
	...
	public function updateOrder($log) 
	{
		...
		if (($res['trade_state'] == 'REFUND') || ($res['message'] == ''.$this->lang['lang_plugin_cashier_core_model_61'].'')) 
		{
	...
	public function paySuccess($log, $user) 
	{
		...
		if (!(empty($log['deduction'])) && ($log['paytype'] != 2)) 
		{
			...
			m('member')->setCredit($userinfo['openid'], 'credit2', -$log['deduction'], array(0, ''.$this->lang['lang_plugin_cashier_core_model_62'].' ' . $_W['cashieruser']['title'], ''.$this->lang['lang_plugin_cashier_core_model_63'].''));
		}
	...
	public function paytype($paytype = 0, $auto_code = NULL) 
	{
		...
		{
			return error(-101, ''.$this->lang['lang_plugin_cashier_core_model_64'].'!');
		}
		if (($paytype == -1) && ($auto_code !== NULL)) 
		{
			...
			if (in_array($type, $alipay)) 
			{
				...
				{
					return error(-101, ''.$this->lang['lang_plugin_cashier_core_model_65'].'!');
				}
				$paytype = 1;
			}
	...
	public function createGoodsOrder($goods, $openid = '') 
	{
		...
		foreach ($goods as $g ) 
		{
			...
			if (empty($goodsid)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_66'].','.$this->lang['lang_plugin_cashier_core_model_67'].'!');
			}
			...
			if (!(empty($data['hasoption']))) 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_cashier_core_model_68'].'' . $data['title'] . ''.$this->lang['lang_plugin_cashier_core_model_69'].','.$this->lang['lang_plugin_cashier_core_model_70'].'!');
				}
			}
			...
			if (!(empty($optionid))) 
			{
				...
				if (!(empty($option))) 
				{
					if ($option['stock'] != -1) 
					{
						...
						{
							show_json(-1, $data['title'] . '<br/>' . $option['title'] . ' '.$this->lang['lang_plugin_cashier_core_model_71'].'!');
						}
					}
	...
	public function goodsCalculate($selfgoods = array(), $shopgoods = array(), $params, $return = false) 
	{
		...
		if (!(empty($selfgoods))) 
		{
			foreach ($selfgoods as $key => $val ) 
			{
				...
				if (($g['total'] < $data['total']) && ($g['total'] != -1)) 
				{
					...
					return array('res' => error('-101', $g['title'] . ' '.$this->lang['lang_plugin_cashier_core_model_72'].', '.$this->lang['lang_plugin_cashier_core_model_73'].' ' . $g['total']));
				}
		...
		return array('res' => error('-101', ''.$this->lang['lang_plugin_cashier_core_model_74'].'!'));
	}
	...
	public function sendCredit1($log, $userset = NULL) 
	{
		...
		$credit1 = com_run('sale::getCredit1', $log['openid'], $price, 37, 1, 0, $log['title'] . ''.$this->lang['lang_plugin_cashier_core_model_75'].' : ' . $log['logno'] . '  '.$this->lang['lang_plugin_cashier_core_model_76'].'');
		return $credit1;
	}
	public function upload_cert($fileinput) 
	{
		...
		if (!(empty($filename)) && !(empty($tmp_name))) 
		{
			...
			if ($ext != '.pem') 
			{
				...
				{
					$errinput = 'CERT'.$this->lang['lang_plugin_cashier_core_model_77'].'';
				}
				else if ($fileinput == 'key_file') 
				{
					$errinput = 'KEY'.$this->lang['lang_plugin_cashier_core_model_78'].'';
				}
				else if ($fileinput == 'root_file') 
				{
					$errinput = 'ROOT'.$this->lang['lang_plugin_cashier_core_model_79'].'';
				}
				show_json(0, $errinput . ','.$this->lang['lang_plugin_cashier_core_model_80'].'!');
			}
	...
	public function refundWechat($openid, $out_trade_no, $out_refund_no, $totalmoney, $refundmoney = 0, $app = false, $refund_account = false) 
	{
		...
		if (empty($openid)) 
		{
			return error(-1, 'openid'.$this->lang['lang_plugin_cashier_core_model_81'].'');
		}
		$wechatpay = json_decode($_W['cashieruser']['wechatpay'], true);
		if (!(is_array($wechatpay))) 
		{
			return error(1, ''.$this->lang['lang_plugin_cashier_core_model_82'].'');
		}
		...
		$xml = array2xml($pars);
		$extras = array();
		$errmsg = ''.$this->lang['lang_plugin_cashier_core_model_83'].'->'.$this->lang['lang_plugin_cashier_core_model_84'].'!';
		if (is_array($certs)) 
		{
		...
		{
			return error(-2, ''.$this->lang['lang_plugin_cashier_core_model_85'].'');
		}
