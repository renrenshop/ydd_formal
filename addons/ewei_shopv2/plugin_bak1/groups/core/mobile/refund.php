...
class Refund_EweiShopV2Page extends PluginMobileLoginPage 
{
	protected function globalData() 
	{
		...
		if (empty($order)) 
		{
			...
			{
				show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_0'].'');
			}
		}
		if (($order['heads'] == 1) && ($order['success'] == 0)) 
		{
			$_err = ''.$this->lang['lang_plugin_groups_core_mobile_refund_1'].'';
		}
		$goodRefund = false;
		...
		if ($order['status'] == 0) 
		{
			$_err = ''.$this->lang['lang_plugin_groups_core_mobile_refund_2'].'!';
		}
		else if ($order['status'] == 2) 
		{
			if ($goodRefund) 
			{
				$_err = ''.$this->lang['lang_plugin_groups_core_mobile_refund_3'].'!';
			}
		}
		else if ($order['status'] == 3) 
		{
			if ($goodRefund) 
			{
				$_err = ''.$this->lang['lang_plugin_groups_core_mobile_refund_4'].'!';
			}
			else if ($order['refundstate'] == 0) 
			{
				...
				if (0 < $refunddays) 
				{
					...
					if ($refunddays < $days) 
					{
						$_err = ''.$this->lang['lang_plugin_groups_core_mobile_refund_5'].' ' . $refunddays . ' '.$this->lang['lang_plugin_groups_core_mobile_refund_6'].', '.$this->lang['lang_plugin_groups_core_mobile_refund_7'].'!';
					}
				}
				else 
				{
					$_err = ''.$this->lang['lang_plugin_groups_core_mobile_refund_8'].', '.$this->lang['lang_plugin_groups_core_mobile_refund_9'].'!';
				}
			}
		}
		if (!empty($_err)) 
	...
	public function main() 
	{
		...
		try 
		{
			...
			if ($order['status'] == '-1') 
			{
				throw new Exception(''.$this->lang['lang_plugin_groups_core_mobile_refund_10'].'');
			}
			$refund = false;
			$imgnum = 0;
	...
	public function submit() 
	{
		...
		if ($order['status'] == '-1') 
		{
			show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_11'].'!');
		}
		...
		if ($rtype != 2) 
		{
			if (empty($price)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_12'].'0'.$this->lang['lang_plugin_groups_core_mobile_refund_13'].'');
			}
			if ($order['refundprice'] < $price) 
			{
				show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_14'].'' . $order['refundprice'] . ''.$this->lang['lang_plugin_groups_core_mobile_refund_15'].'');
			}
		}
	...
	public function express() 
	{
		...
		if (empty($refundid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_16'].'!');
		}
		if (empty($_GPC['expresssn'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_17'].'');
		}
	...
	public function receive() 
	{
		...
		if (empty($refund)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_groups_core_mobile_refund_18'].'!');
		}
		$time = time();
		$refund_data = array();
