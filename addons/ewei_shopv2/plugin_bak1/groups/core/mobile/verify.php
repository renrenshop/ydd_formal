...
class Verify_EweiShopV2Page extends PluginMobileLoginPage 
{
	...
	public function success() 
	{
		...
		$times = intval($_GPC['times']);
		$this->message(array('title' => ''.$this->lang['lang_plugin_groups_core_mobile_verify_0'].'', 'message' => ''.$this->lang['lang_plugin_groups_core_mobile_verify_1'].''), 'javascript:WeixinJSBridge.call("closeWindow");', 'success');
	}
}
?>