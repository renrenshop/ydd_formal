	...
	public function gettaskinfo() 
	{
		...
		if (intval($_GPC['id'])) 
		{
			...
			else if ($taskinfo['poster_type'] == 2) 
			{
				...
				$rankinfotwo = array(1 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_0'].'', 2 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_1'].'', 3 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_2'].'', 4 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_3'].'', 5 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_4'].'');
	...
	public function getcompleteinfo() 
	{
		...
		if (intval($_GPC['id'])) 
		{
			...
			else if ($taskinfo['task_type'] == 2) 
			{
				$rankinfo = array();
				$rankinfoone = array(1 => $res['taskranktitle'] . '1', 2 => $res['taskranktitle'] . '2', 3 => $res['taskranktitle'] . '3', 4 => $res['taskranktitle'] . '4', 5 => $res['taskranktitle'] . '5');
				$rankinfotwo = array(1 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_5'].'', 2 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_6'].'', 3 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_7'].'', 4 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_8'].'', 5 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_mobile_index2_9'].'');
				$rankinfothree = array(1 => $res['taskranktitle'] . 'A', 2 => $res['taskranktitle'] . 'B', 3 => $res['taskranktitle'] . 'C', 4 => $res['taskranktitle'] . 'D', 5 => $res['taskranktitle'] . 'E');
				if ($res['taskranktype'] == 1) 
				{
					$rankinfo = $rankinfoone;
