...
class TaskProcessor extends PluginProcessor 
{
	...
	{
		global $_W;
		return $obj->respText(''.$this->lang['lang_plugin_task_core_processor_0'].'!');
	}
	private function responseScan($obj) 
	{
		...
		if ($openid == $qr['openid']) 
		{
			...
			return m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_1'].','.$this->lang['lang_plugin_task_core_processor_2'].'~');
		}
		load()->func('logging');
		...
		else 
		{
			...
			if (!(empty($join_info)) && $scan_count) 
			{
				...
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_3'].'');
				}
			}
			else if (empty($join_info)) 
			{
				...
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_4'].'');
				}
			}
			else 
			{
				...
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_5'].'');
				}
			}
		}
	...
	private function responseSubscribe($obj) 
	{
		...
		if ($openid == $qr['openid']) 
		{
			...
			return m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_6'].','.$this->lang['lang_plugin_task_core_processor_7'].'~');
		}
		if ($member_info['isnew']) 
		{
			if (!(empty($join_info))) 
		...
		else 
		{
			...
			if (!(empty($join_info)) && $scan_count) 
			{
				...
				if (!(empty($default_text))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_8'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_9'].'');
				}
			}
			else if (empty($join_info)) 
			{
				...
				if (!(empty($default_text))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_10'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_11'].'');
				}
			}
			else 
			{
				...
				if (!(empty($default_text))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_12'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_13'].'');
				}
			}
		}
		$url = trim($poster['respurl']);
		...
		if (($join_info['needcount'] == $count) && ($join_info['is_reward'] == 0)) 
		{
			...
			foreach ($reward_data as $key => $val ) 
			{
				if ($key == 'rec') 
				{
					...
					{
						m('member')->setCredit($qr['openid'], 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_processor_14'].'+' . $val['credit']));
					}
					if (isset($val['money']) && (0 < $val['money']['num'])) 
					{
						...
						m('finance')->pay($qr['openid'], $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_processor_15'].'', false);
					}
					if (isset($val['bribery']) && (0 < $val['bribery'])) 
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $qr['openid'], 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_processor_16'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_processor_17'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_processor_18'].'');
				...
				else if ($key == 'sub') 
				{
					if (0 < $val['credit']) 
					{
						m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_processor_19'].'+' . $val['credit']));
					}
					if (0 < $val['money']['num']) 
					{
						$pay = $val['money']['num'];
						...
						$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_processor_20'].'', false);
						if (is_error($res)) 
						{
			...
			if (!(empty($default_text))) 
			{
				...
				if (!(empty($default_text['successscaner']))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_21'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_22'].'');
				}
				if (!(empty($default_text['complete']))) 
				{
					...
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_23'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_24'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
					}
				}
				else 
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_25'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_26'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_27'].'');
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_28'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_29'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
			}
		}
		else 
		{
			...
			foreach ($reward_data as $key => $val ) 
			{
				if ($key == 'sub') 
				{
					if (0 < $val['credit']) 
					{
						m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_processor_30'].'+' . $val['credit']));
					}
					if (0 < $val['money']['num']) 
					{
						$pay = $val['money']['num'];
						...
						$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_processor_31'].'', false);
					...
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $openid, 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_processor_32'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_processor_33'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_processor_34'].'');
						$err = m('common')->sendredpack($params);
			...
			if (!(empty($default_text))) 
			{
				...
				if (!(empty($default_text['successscaner']))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_35'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_36'].'');
				}
				if (!(empty($default_text['successtasker']))) 
				{
					...
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_37'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_38'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_39'].','.$this->lang['lang_plugin_task_core_processor_40'].'1'.$this->lang['lang_plugin_task_core_processor_41'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
					}
				}
				else 
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_42'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_43'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_44'].','.$this->lang['lang_plugin_task_core_processor_45'].'1'.$this->lang['lang_plugin_task_core_processor_46'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_47'].'');
				m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_48'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_49'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_50'].','.$this->lang['lang_plugin_task_core_processor_51'].'1'.$this->lang['lang_plugin_task_core_processor_52'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
			}
		}
	}
		...
		if (($join_info['needcount'] == $count) && ($join_info['is_reward'] == 0)) 
		{
			...
			foreach ($reward_data as $key => $val ) 
			{
				if ($key == 'rec') 
				{
					if (isset($val['credit']) && (0 < $val['credit'])) 
					{
						m('member')->setCredit($qr['openid'], 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_processor_53'].'+' . $val['credit']));
					}
					if (isset($val['money']) && (0 < $val['money']['num'])) 
					{
						$pay = $val['money']['num'];
						...
						m('finance')->pay($qr['openid'], $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_processor_54'].'', false);
					}
					if (isset($val['bribery']) && (0 < $val['bribery'])) 
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $qr['openid'], 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_processor_55'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_processor_56'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_processor_57'].'');
						$err = m('common')->sendredpack($params);
						if (!(is_error($err))) 
						{
							$reward = unserialize($reward);
				...
				else if ($key == 'sub') 
				{
					if (0 < $val['credit']) 
					{
						m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_processor_58'].'+' . $val['credit']));
					}
					if (0 < $val['money']['num']) 
					{
						$pay = $val['money']['num'];
						...
						$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_processor_59'].'', false);
						if (is_error($res)) 
						{
							logging_run($res['message']);
						}
			...
			if (!(empty($default_text))) 
			{
				...
				if (!(empty($default_text['successscaner']))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_60'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_61'].'');
				}
				if (!(empty($default_text['complete']))) 
				{
					$poster['okdays'] = $join_info['failtime'];
					...
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_62'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_63'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
					}
				}
				else 
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_64'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_65'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_66'].'');
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_67'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_68'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
			}
		}
		else 
		{
			...
			foreach ($reward_data as $key => $val ) 
			{
				if ($key == 'sub') 
				{
					if (0 < $val['credit']) 
					{
						m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_processor_69'].'+' . $val['credit']));
					}
					if (0 < $val['money']['num']) 
					{
						$pay = $val['money']['num'];
						...
						$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_processor_70'].'', false);
						logging_run('submoney' . json_encode($res));
						if (is_error($res)) 
						{
							logging_run('submoney' . $res['message']);
					...
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $openid, 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_processor_71'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_processor_72'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_processor_73'].'');
						$err = m('common')->sendredpack($params);
						logging_run('bribery' . json_encode($err));
						if (!(is_error($err))) 
						{
			...
			if (!(empty($default_text))) 
			{
				...
				if (!(empty($default_text['successscaner']))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_74'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_75'].'');
				}
				if (!(empty($default_text['successtasker']))) 
				{
					$poster['okdays'] = $join_info['failtime'];
					...
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_76'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_77'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_78'].','.$this->lang['lang_plugin_task_core_processor_79'].'1'.$this->lang['lang_plugin_task_core_processor_80'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
					}
				}
				else 
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_81'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_82'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_83'].','.$this->lang['lang_plugin_task_core_processor_84'].'1'.$this->lang['lang_plugin_task_core_processor_85'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_processor_86'].'');
				m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_processor_87'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_88'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_processor_89'].','.$this->lang['lang_plugin_task_core_processor_90'].'1'.$this->lang['lang_plugin_task_core_processor_91'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
			}
		}
	}
}
