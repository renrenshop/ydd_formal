...
class TaskModel extends PluginModel 
{
	...
	public function getQR($poster, $member) 
	{
		...
		if (empty($qr)) 
		{
			...
			if (empty($result)) 
			{
				return error(-1, ''.$this->lang['lang_plugin_task_core_model_0'].'');
			}
		...
		else 
		{
			...
			if ($qr['endtime'] < $time) 
			{
				...
				if (empty($result)) 
				{
					return error(-1, ''.$this->lang['lang_plugin_task_core_model_1'].'');
				}
				$barcode = $result['barcode'];
				$ticket = $result['ticket'];
				$qrimg = 'https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=' . $ticket;
	...
	{
		return array( 'task' => array('text' => $this->getName(), 'isplugin' => true, 'view' => ''.$this->lang['lang_plugin_task_core_model_2'].'', 'add' => ''.$this->lang['lang_plugin_task_core_model_3'].'-log', 'edit' => ''.$this->lang['lang_plugin_task_core_model_4'].'-log', 'delete' => ''.$this->lang['lang_plugin_task_core_model_5'].'-log', 'log' => ''.$this->lang['lang_plugin_task_core_model_6'].'', 'clear' => ''.$this->lang['lang_plugin_task_core_model_7'].'-log', 'setdefault' => ''.$this->lang['lang_plugin_task_core_model_8'].'-log') );
	}
	public function responseUnsubscribe($param = '') 
	{
		...
		if (isset($param['openid']) && !(empty($param['openid']))) 
		{
			...
			if ($task_info) 
			{
				...
				{
					m('message')->sendCustomNotice($val['join_user'], ''.$this->lang['lang_plugin_task_core_model_9'].'[' . $member['nickname'] . ']'.$this->lang['lang_plugin_task_core_model_10'].'');
				}
			}
		}
	}
	public function notice_complain($templete, $member, $poster, $scaner = '', $type = 1) 
	{
		...
		if ($templete) 
		{
			...
			$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_11'].']', $member['nickname'], $templete);
			$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_12'].']', $poster['title'], $templete);
			if ($poster['poster_type'] == 1) 
			{
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_13'].']', $poster['needcount'], $templete);
			}
			else if ($poster['poster_type'] == 2) 
			{
				$reward_data = unserialize($poster['reward_data']);
				$reward_data = array_shift($reward_data['rec']);
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_14'].']', $reward_data['needcount'], $templete);
			}
			$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_15'].']', date('Y'.$this->lang['lang_plugin_task_core_model_16'].'m'.$this->lang['lang_plugin_task_core_model_17'].'d'.$this->lang['lang_plugin_task_core_model_18'].' H:i', $poster['timestart']) . '-' . date('Y'.$this->lang['lang_plugin_task_core_model_19'].'m'.$this->lang['lang_plugin_task_core_model_20'].'d'.$this->lang['lang_plugin_task_core_model_21'].' H:i', $poster['timeend']), $templete);
			if (!(empty($scaner))) 
			{
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_22'].']', $scaner['nickname'], $templete);
			}
			if ($poster['reward_data']) 
			{
				$poster['reward_data'] = unserialize($poster['reward_data']);
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_23'].']', $poster['reward_data'][$reward_type]['money']['num'], $templete);
				if (isset($poster['reward_data'][$reward_type]['coupon']['total'])) 
				{
					$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_24'].']', $poster['reward_data'][$reward_type]['coupon']['total'], $templete);
				}
				else 
				{
					$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_25'].']', '', $templete);
				}
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_26'].']', $poster['reward_data'][$reward_type]['credit'], $templete);
				$reward_text = '';
				foreach ($poster['reward_data'][$reward_type] as $key => $val ) 
				{
					if ($key == 'credit') 
					{
						$reward_text .= ''.$this->lang['lang_plugin_task_core_model_27'].'' . $val . ' |';
					}
					if ($key == 'goods') 
					{
						$reward_text .= ''.$this->lang['lang_plugin_task_core_model_28'].'' . count($val) . ''.$this->lang['lang_plugin_task_core_model_29'].'';
					}
					if ($key == 'money') 
					{
						$reward_text .= ''.$this->lang['lang_plugin_task_core_model_30'].'' . $val['num'] . ''.$this->lang['lang_plugin_task_core_model_31'].' |';
					}
					if ($key == 'coupon') 
					{
						$reward_text .= ''.$this->lang['lang_plugin_task_core_model_32'].'' . $val['total'] . ''.$this->lang['lang_plugin_task_core_model_33'].' |';
					}
					if ($key == 'bribery') 
					{
						$reward_text .= ''.$this->lang['lang_plugin_task_core_model_34'].'' . $val . ''.$this->lang['lang_plugin_task_core_model_35'].' |';
					}
				}
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_36'].']', $reward_text, $templete);
			}
			else 
			{
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_37'].']', '0', $templete);
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_38'].']', '0', $templete);
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_39'].']', '0', $templete);
			}
			if (isset($poster['completecount'])) 
			{
				...
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_40'].']', $notcomplete, $templete);
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_41'].']', intval($poster['completecount']), $templete);
			}
			if (isset($poster['okdays'])) 
			{
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_42'].']', date('Y'.$this->lang['lang_plugin_task_core_model_43'].'m'.$this->lang['lang_plugin_task_core_model_44'].'d'.$this->lang['lang_plugin_task_core_model_45'].' H:i', $poster['okdays']), $templete);
			}
			...
			$rankinfotwo = array(1 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_model_46'].'', 2 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_model_47'].'', 3 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_model_48'].'', 4 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_model_49'].'', 5 => $res['taskranktitle'] . ''.$this->lang['lang_plugin_task_core_model_50'].'');
			...
			{
				$templete = str_replace('['.$this->lang['lang_plugin_task_core_model_51'].']', $rankinfo[$poster['reward_rank']], $templete);
			}
	...
	public function rec_notice_complain($poster) 
	{
		if ($poster['reward_data']) 
		{
			...
			foreach ($poster['reward_data'] as $key => $val ) 
			{
				if ($key == 'credit') 
				{
					$reward_text .= ''.$this->lang['lang_plugin_task_core_model_52'].':' . $val;
				}
				if ($key == 'goods') 
				{
					$reward_text .= ''.$this->lang['lang_plugin_task_core_model_53'].':' . count($val) . ''.$this->lang['lang_plugin_task_core_model_54'].'';
				}
				if ($key == 'money') 
				{
					$reward_text .= ''.$this->lang['lang_plugin_task_core_model_55'].':' . $val['num'] . ''.$this->lang['lang_plugin_task_core_model_56'].'';
				}
				if ($key == 'coupon') 
				{
					$reward_text .= ''.$this->lang['lang_plugin_task_core_model_57'].':' . $val['total'] . ''.$this->lang['lang_plugin_task_core_model_58'].'';
				}
				if ($key == 'bribery') 
				{
					$reward_text .= ''.$this->lang['lang_plugin_task_core_model_59'].':' . $val . ''.$this->lang['lang_plugin_task_core_model_60'].'';
				}
			}
		...
		if (($join_info['needcount'] == $count) && ($join_info['is_reward'] == 0)) 
		{
			...
			foreach ($reward_data as $key => $val ) 
			{
				if ($key == 'rec') 
				{
					...
					{
						m('member')->setCredit($qr['openid'], 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_model_61'].'+' . $val['credit']));
					}
					if (isset($val['money']) && (0 < $val['money']['num'])) 
					{
						...
						m('finance')->pay($qr['openid'], $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_model_62'].'', false);
					}
					if (isset($val['bribery']) && (0 < $val['bribery'])) 
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $qr['openid'], 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_model_63'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_model_64'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_model_65'].'');
				...
				else if ($key == 'sub') 
				{
					if (0 < $val['credit']) 
					{
						m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_model_66'].'+' . $val['credit']));
					}
					if (0 < $val['bribery']) 
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $openid, 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_model_67'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_model_68'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_model_69'].'');
						$err = m('common')->sendredpack($params);
						if (!(is_error($err))) 
						{
					...
					if (0 < $val['money']['num']) 
					{
						...
						$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_model_70'].'', false);
						if (is_error($res)) 
						{
			...
			if (!(empty($default_text))) 
			{
				...
				if (!(empty($default_text['successscaner']))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_71'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_72'].'');
				}
				if (!(empty($default_text['complete']))) 
				{
					...
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_73'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_74'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
					}
				}
				else 
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_75'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_76'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_77'].'');
				m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_78'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_79'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
			}
			if (p('lottery')) 
			{
		...
		else 
		{
			...
			foreach ($reward_data as $key => $val ) 
			{
				if ($key == 'sub') 
				{
					if (0 < $val['credit']) 
					{
						m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_model_80'].'+' . $val['credit']));
					}
					if (0 < $val['money']['num']) 
					{
						$pay = $val['money']['num'];
						...
						$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_model_81'].'', false);
						if (is_error($res)) 
						{
					...
					{
						$tid = rand(1, 1000) . time() . rand(1, 10000);
						$params = array('openid' => $openid, 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_model_82'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_model_83'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_model_84'].'');
						$err = m('common')->sendredpack($params);
						if (!(is_error($err))) 
						{
							$sub_reward = unserialize($sub_reward);
			...
			if (!(empty($default_text))) 
			{
				...
				if (!(empty($default_text['successscaner']))) 
				{
					...
					{
						m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_85'].'');
					}
				}
				else 
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_86'].'');
				}
				if ($poster['needcount'] < $count) 
				{
					if ($default_text['is_completed'] == 1) 
					{
						if (!(empty($default_text['completed']))) 
						{
							...
							{
								m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_87'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_88'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
							}
						}
						else 
						{
							m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_89'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_90'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
						}
					}
				}
				else if (!(empty($default_text['successtasker']))) 
				{
					...
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_91'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_92'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_model_93'].','.$this->lang['lang_plugin_task_core_model_94'].'1'.$this->lang['lang_plugin_task_core_model_95'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
					}
				}
				else 
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_96'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_97'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_model_98'].','.$this->lang['lang_plugin_task_core_model_99'].'1'.$this->lang['lang_plugin_task_core_model_100'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_101'].'');
				m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_102'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_103'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_model_104'].','.$this->lang['lang_plugin_task_core_model_105'].'1'.$this->lang['lang_plugin_task_core_model_106'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
			}
		}
	}
	...
	protected function reward_both($count, $reward_data, $qr, $join_info, $openid, $qrmember, $member_info, $poster) 
	{
		...
		foreach ($reward_data as $key => $val ) 
		{
			if ($key == 'rec') 
			{
				if (isset($val['credit']) && (0 < $val['credit'])) 
				{
					m('member')->setCredit($qr['openid'], 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_model_107'].'+' . $val['credit']));
				}
				if (isset($val['money']) && (0 < $val['money']['num'])) 
				{
					$pay = $val['money']['num'];
					...
					m('finance')->pay($qr['openid'], $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_model_108'].'', false);
				}
				if (isset($val['bribery']) && (0 < $val['bribery'])) 
				{
					$tid = rand(1, 1000) . time() . rand(1, 10000);
					$params = array('openid' => $qr['openid'], 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_model_109'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_model_110'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_model_111'].'');
					$err = m('common')->sendredpack($params);
					if (!(is_error($err))) 
					{
						$reward = unserialize($reward);
			...
			else if ($key == 'sub') 
			{
				if (0 < $val['credit']) 
				{
					m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_model_112'].'+' . $val['credit']));
				}
				if (0 < $val['money']['num']) 
				{
					$pay = $val['money']['num'];
					...
					$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_model_113'].'', false);
					if (is_error($res)) 
					{
						logging_run($res['message']);
					}
		...
		if (!(empty($default_text))) 
		{
			...
			if (!(empty($default_text['successscaner']))) 
			{
				...
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_114'].'');
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_115'].'');
			}
			if (!(empty($default_text['rankcomplete']))) 
			{
				...
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_116'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_117'].'', mobileUrl('task/getcompleteinfo', array('id' => $join_info['join_id']), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_118'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_119'].'', mobileUrl('task/getcompleteinfo', array('id' => $join_info['join_id']), true));
			}
		}
		else 
		{
			m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_120'].'');
			m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_121'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_122'].'', mobileUrl('task/getcompleteinfo', array('id' => $join_info['join_id']), true));
		}
		if (p('lottery')) 
		{
			$res = p('lottery')->getLottery($qrmember['openid'], 3, array('taskid' => $poster['id']));
	...
	protected function reward_scan($count, $reward_data, $qr, $join_info, $openid, $qrmember, $member_info, $poster) 
	{
		...
		foreach ($reward_data as $key => $val ) 
		{
			if ($key == 'sub') 
			{
				if (0 < $val['credit']) 
				{
					m('member')->setCredit($openid, 'credit1', $val['credit'], array(0, ''.$this->lang['lang_plugin_task_core_model_123'].'+' . $val['credit']));
				}
				if (0 < $val['money']['num']) 
				{
					$pay = $val['money']['num'];
					...
					$res = m('finance')->pay($openid, $val['money']['type'], $pay, '', ''.$this->lang['lang_plugin_task_core_model_124'].'', false);
					if (is_error($res)) 
					{
						logging_run('submoney' . $res['message']);
					}
				...
				{
					$tid = rand(1, 1000) . time() . rand(1, 10000);
					$params = array('openid' => $openid, 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_model_125'].'', 'money' => $val['bribery'], 'wishing' => ''.$this->lang['lang_plugin_task_core_model_126'].'', 'act_name' => $poster['title'], 'remark' => ''.$this->lang['lang_plugin_task_core_model_127'].'');
					$err = m('common')->sendredpack($params);
					if (!(is_error($err))) 
					{
						$sub_reward = unserialize($sub_reward);
		...
		if (!(empty($default_text))) 
		{
			...
			if (!(empty($default_text['successscaner']))) 
			{
				...
				{
					m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_128'].'');
				}
			}
			else 
			{
				m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_129'].'');
			}
			if ($poster['needcount'] < $count) 
			{
				if ($default_text['is_completed'] == 1) 
				{
					if (!(empty($default_text['completed']))) 
					{
						...
						{
							m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_130'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_131'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
						}
					}
					else 
					{
						m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_132'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_133'].'', mobileUrl('task', array('tabpage' => 'complete'), true));
					}
				}
			}
			else if (!(empty($default_text['successtasker']))) 
			{
				...
				{
					m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_134'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_135'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_model_136'].','.$this->lang['lang_plugin_task_core_model_137'].'1'.$this->lang['lang_plugin_task_core_model_138'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
				}
			}
			else 
			{
				m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_139'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_140'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_model_141'].','.$this->lang['lang_plugin_task_core_model_142'].'1'.$this->lang['lang_plugin_task_core_model_143'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
			}
		}
		else 
		{
			m('message')->sendCustomNotice($openid, ''.$this->lang['lang_plugin_task_core_model_144'].'');
			m('message')->sendCustomNotice($qrmember['openid'], ''.$this->lang['lang_plugin_task_core_model_145'].'' . $qrmember['nickname'] . ''.$this->lang['lang_plugin_task_core_model_146'].'' . $member_info['nickname'] . ''.$this->lang['lang_plugin_task_core_model_147'].','.$this->lang['lang_plugin_task_core_model_148'].'1'.$this->lang['lang_plugin_task_core_model_149'].'', mobileUrl('task', array('tabpage' => 'runninga'), true));
		}
	}
	...
	public function sendReward($reward_data = array()) 
	{
		...
		{
			m('member')->setCredit($_W['openid'], 'credit2', $reward_data['balance'], array(0, ''.$this->lang['lang_plugin_task_core_model_150'].'+' . $reward_data['balance']));
		}
		if (!(empty($reward_data['redpacket']))) 
		{
			$tid = rand(1, 1000) . time() . rand(1, 10000);
			$params = array('openid' => $_W['openid'], 'tid' => $tid, 'send_name' => ''.$this->lang['lang_plugin_task_core_model_151'].'', 'money' => $reward_data['redpacket'], 'wishing' => ''.$this->lang['lang_plugin_task_core_model_152'].'', 'act_name' => ''.$this->lang['lang_plugin_task_core_model_153'].'', 'remark' => ''.$this->lang['lang_plugin_task_core_model_154'].'');
			$err = m('common')->sendredpack($params);
			if (!(is_error($err))) 
			{
		...
		{
			m('member')->setCredit($_W['openid'], 'credit1', $reward_data['score'], array(0, ''.$this->lang['lang_plugin_task_core_model_155'].'+' . $reward_data['score']));
		}
	...
	public function getNewTask($id) 
	{
		...
		if (empty($task)) 
		{
			return ''.$this->lang['lang_plugin_task_core_model_156'].'';
		}
	...
	public function taskFilter($task) 
	{
		...
		{
			return ''.$this->lang['lang_plugin_task_core_model_157'].'';
		}
		switch ($type) 
		{
			...
			if (!(empty($all))) 
			{
				return ''.$this->lang['lang_plugin_task_core_model_158'].'';
			}
			break;
			...
			if (!(empty($res))) 
			{
				return ''.$this->lang['lang_plugin_task_core_model_159'].'';
			}
			...
			if (time() < $cantime) 
			{
				return ((''.$this->lang['lang_plugin_task_core_model_160'].'' . $cantime) - time()) . ''.$this->lang['lang_plugin_task_core_model_161'].'';
			}
			...
			{
				return ''.$this->lang['lang_plugin_task_core_model_162'].'' . $task['everyhours'] . ''.$this->lang['lang_plugin_task_core_model_163'].'' . $task['maxtimes'] . ''.$this->lang['lang_plugin_task_core_model_164'].'';
			}
			break;
			...
			if (!(empty($all))) 
			{
				return ''.$this->lang['lang_plugin_task_core_model_165'].'';
			}
			break;
			case 4: return ''.$this->lang['lang_plugin_task_core_model_166'].'';
			case 5: return ''.$this->lang['lang_plugin_task_core_model_167'].'';
		}
	}
	...
	public function returnName($taskclass) 
	{
		...
		{
			return ''.$this->lang['lang_plugin_task_core_model_168'].'';
		}
