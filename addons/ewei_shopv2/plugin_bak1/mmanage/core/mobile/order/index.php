...
class Index_EweiShopV2Page extends MmanageMobilePage 
{
	...
	public function detail() 
	{
		...
		if (empty($item)) 
		{
			$this->message(''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_0'].'!', referer(), 'error');
		}
		if ($_W['ispost']) 
		{
			pdo_update('ewei_shop_order', array('remark' => trim($_GPC['remark'])), array('id' => $item['id'], 'uniacid' => $_W['uniacid']));
			plog('order.op.remarksaler', ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_1'].'  ID: ' . $item['id'] . ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_2'].': ' . $item['ordersn']);
			$this->message(''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_3'].'', webUrl('order', array('op' => 'detail', 'id' => $item['id'])), 'success');
		}
					...
					if (empty($item['dispatchtype'])) 
					{
						foreach ($verifyinfo as &$v ) 
						{
							if ($v['verified'] || ($item['verifytype'] == 1)) 
							{
								...
								{
									$v['storename'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_4'].'';
								}
	...
	public function getlist() 
	{
		...
		$paytype = array( 0 => array('css' => 'default', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_5'].''), 1 => array('css' => 'danger', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_6'].''), 11 => array('css' => 'default', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_7'].''), 2 => array('css' => 'danger', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_8'].''), 21 => array('css' => 'success', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_9'].''), 22 => array('css' => 'warning', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_10'].''), 23 => array('css' => 'warning', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_11'].''), 3 => array('css' => 'primary', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_12'].'') );
		$orderstatus = array( -1 => array('css' => 'default', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_13'].''), 0 => array('css' => 'danger', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_14'].''), 1 => array('css' => 'info', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_15'].''), 2 => array('css' => 'warning', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_16'].''), 3 => array('css' => 'success', 'name' => ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_17'].'') );
		$is_merch = array();
		$is_merchname = 0;
		if ($merch_plugin) 
		{
		...
		if (!(empty($list))) 
		{
			...
			foreach ($list as &$value ) 
			{
				...
				if ($s == 1) 
				{
					if ($value['isverify'] == 1) 
					{
						$value['status'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_18'].'';
						if (0 < $value['sendtype']) 
						{
							$value['status'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_19'].'';
						}
					}
					else if (empty($value['addressid'])) 
					{
						...
						{
							$value['status'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_20'].'';
						}
						else 
						{
							$value['status'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_21'].'';
						}
					}
					else if (0 < $value['sendtype']) 
					{
						$value['status'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_22'].'';
					}
				}
				if ($s == -1) 
				{
					...
					{
						$value['status'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_23'].'';
					}
				}
				$value['paytypevalue'] = $pt;
				$value['css'] = $paytype[$pt]['css'];
				$value['paytype'] = $paytype[$pt]['name'];
				$value['dispatchname'] = ((empty($value['addressid']) ? ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_24'].'' : $value['dispatchname']));
				if (empty($value['dispatchname'])) 
				{
					$value['dispatchname'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_25'].'';
				}
				if ($pt == 3) 
				{
					$value['dispatchname'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_26'].'';
				}
				else if ($value['isverify'] == 1) 
				{
					$value['dispatchname'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_27'].'';
				}
				else if ($value['isvirtual'] == 1) 
				{
					$value['dispatchname'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_28'].'';
				}
				else if (!(empty($value['virtual']))) 
				{
					$value['dispatchname'] = ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_29'].'('.$this->lang['lang_plugin_mmanage_core_mobile_order_index_30'].')<br/>'.$this->lang['lang_plugin_mmanage_core_mobile_order_index_31'].'';
				}
				...
				foreach ($order_goods as &$og ) 
				{
					...
					{
						$goods .= ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_32'].': ' . $og['optiontitle'];
					}
					...
					if (!(empty($og['goodssn']))) 
					{
						$goods .= ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_33'].': ' . $og['goodssn'];
					}
					if (!(empty($og['productsn']))) 
					{
						$goods .= ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_34'].': ' . $og['productsn'];
					}
					$goods .= ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_35'].': ' . ($og['price'] / $og['total']) . ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_36'].': ' . ($og['realprice'] / $og['total']) . ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_37'].': ' . $og['total'] . ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_38'].': ' . $og['price'] . ' '.$this->lang['lang_plugin_mmanage_core_mobile_order_index_39'].': ' . $og['realprice'] . "\r\n" . ' ';
		...
		$r_type = array(''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_40'].'', ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_41'].'', ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_42'].'');
	...
	protected function getOrder($id) 
	{
		...
		if (empty($id)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_43'].'');
		}
		$item = pdo_fetch('SELECT * FROM ' . tablename('ewei_shop_order') . ' WHERE id = :id and uniacid=:uniacid', array(':id' => $id, ':uniacid' => $_W['uniacid']));
		if (empty($item)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_mmanage_core_mobile_order_index_44'].'');
		}
		return $item;
	}
