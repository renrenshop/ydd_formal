...
class Index_EweiShopV2Page extends MmanageMobilePage 
{
	public function main() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			if (empty($shopname)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_mmanage_core_mobile_shop_index_0'].'');
			}
			$data = $shopset['shop'];
			$data['name'] = $shopname;
			...
			plog('sysset.shop.edit', ''.$this->lang['lang_plugin_mmanage_core_mobile_shop_index_1'].'-'.$this->lang['lang_plugin_mmanage_core_mobile_shop_index_2'].'');
			show_json(1);
		}
