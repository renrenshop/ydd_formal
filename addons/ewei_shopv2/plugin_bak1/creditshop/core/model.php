...
if (!(class_exists('CreditshopModel'))) 
{
	class CreditshopModel extends PluginModel 
	{
		...
		public function packetmoney($goodsid) 
		{
			...
			if (!($goods)) 
			{
				return array('status' => 0, 'message' => ''.$this->lang['lang_plugin_creditshop_core_model_0'].'');
			}
		...
		public function getGoods($id, $member, $optionid = 0) 
		{
			...
			{
				return array('canbuy' => false, 'buymsg' => ''.$this->lang['lang_plugin_creditshop_core_model_1'].'');
			}
			...
			{
				$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_2'].'';
			}
			else 
			{
				if ($goods['goodstype'] == 3) 
				{
					...
					{
						$goods['canbuy'] = false;
						$goods['buymsg'] = ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_model_3'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_4'].''));
					}
				}
				...
				{
					$goods['canbuy'] = false;
					$goods['buymsg'] = ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_model_5'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_6'].''));
				}
				if ($goods['hasoption'] && $optionid) 
				{
					...
					{
						$goods['canbuy'] = false;
						$goods['buymsg'] = ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_model_7'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_8'].''));
					}
				}
				if ($goods['isverify'] == 0) 
				{
				...
				if ($goods['canbuy']) 
				{
					if (0 < $goods['totalday']) 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_model_9'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_10'].''));
						}
					}
				}
				if ($goods['canbuy']) 
				{
					if (0 < $goods['chanceday']) 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_model_11'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_12'].''));
						}
					}
				}
				if ($goods['canbuy']) 
				{
					if (0 < $goods['chance']) 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_model_13'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_14'].''));
						}
					}
				}
				if ($goods['canbuy']) 
				{
					if (0 < $goods['usermaxbuy']) 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_15'].'';
						}
					}
				}
				if ($goods['canbuy']) 
				{
					...
					{
						$goods['canbuy'] = false;
						$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_16'].'';
					}
				}
				if ($goods['canbuy']) 
				{
					if ($goods['istime'] == 1) 
					{
						if (time() < $goods['timestart']) 
						{
							...
							$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_17'].'';
						}
						else if ($goods['timeend'] < time()) 
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_18'].'';
						}
						else 
						{
				...
				if ($goods['canbuy']) 
				{
					if (($goods['isendtime'] == 1) && $goods['isverify']) 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_19'].'('.$this->lang['lang_plugin_creditshop_core_model_20'].')';
						}
					}
				}
				...
				if ($goods['canbuy']) 
				{
					if ($goods['buylevels'] != '') 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_21'].'';
						}
					}
				}
				if ($goods['canbuy']) 
				{
					if ($goods['buygroups'] != '') 
					{
						...
						{
							$goods['canbuy'] = false;
							$goods['buymsg'] = ''.$this->lang['lang_plugin_creditshop_core_model_22'].'';
						}
					}
				}
			}
			$goods['followtext'] = ((empty($goods['followtext']) ? ''.$this->lang['lang_plugin_creditshop_core_model_23'].'!' : $goods['followtext']));
			$set = $this->getSet();
		...
		public function sendMessage($id = 0) 
		{
			...
			if ((0 < $goods['credit']) & (0 < $goods['money'])) 
			{
				$credits = $goods['credit'] . ''.$this->lang['lang_plugin_creditshop_core_model_24'].'+' . $goods['money'] . ''.$this->lang['lang_plugin_creditshop_core_model_25'].'';
			}
			else if (0 < $goods['credit']) 
			{
				$credits = $goods['credit'] . ''.$this->lang['lang_plugin_creditshop_core_model_26'].'';
			}
			else if (0 < $goods['money']) 
			{
				$credits = $goods['money'] . ''.$this->lang['lang_plugin_creditshop_core_model_27'].'';
			}
			else 
			{
				$credits = '0';
			...
			if ($log['status'] == 2) 
			{
				if (!(empty($type))) 
				{
					if ($log['status'] == 2) 
					{
						$remark = "\r\n" . ' '.$this->lang['lang_plugin_creditshop_core_model_28'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_29'].'';
						if (($goods['goodstype'] == 0) && ($goods['isverify'] == 0)) 
						{
							if (0 < $goods['dispatch']) 
							{
								$remark = "\r\n" . ' '.$this->lang['lang_plugin_creditshop_core_model_30'].', '.$this->lang['lang_plugin_creditshop_core_model_31'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_32'].'';
							}
							else 
							{
								$remark = "\r\n" . ' '.$this->lang['lang_plugin_creditshop_core_model_33'].', '.$this->lang['lang_plugin_creditshop_core_model_34'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_35'].'';
							}
						}
						$msg = array( 'first' => array('value' => ''.$this->lang['lang_plugin_creditshop_core_model_36'].'~', 'color' => '#4a5077'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_37'].'', 'value' => ''.$this->lang['lang_plugin_creditshop_core_model_38'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_39'].'', 'color' => '#4a5077'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_40'].'', 'value' => date('Y-m-d H:i', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
						if (!(empty($tm['award']))) 
						{
				...
				{
					$remark = "\r\n" . ' '.$this->lang['lang_plugin_creditshop_core_model_41'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_42'].'';
					if ($log['dispatchstatus'] != -1) 
					{
						if (0 < $goods['dispatch']) 
						{
							$remark = "\r\n" . ' '.$this->lang['lang_plugin_creditshop_core_model_43'].', '.$this->lang['lang_plugin_creditshop_core_model_44'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_45'].'';
						}
						else 
						{
							$remark = "\r\n" . ' '.$this->lang['lang_plugin_creditshop_core_model_46'].', '.$this->lang['lang_plugin_creditshop_core_model_47'].'' . $shop['name'] . ''.$this->lang['lang_plugin_creditshop_core_model_48'].'';
						}
					}
					$msg = array( 'first' => array('value' => ''.$this->lang['lang_plugin_creditshop_core_model_49'].'~', 'color' => '#4a5077'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_50'].'', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_51'].'', 'value' => $credits, 'color' => '#4a5077'), 'keyword3' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_52'].'', 'value' => $credit, 'color' => '#4a5077'), 'keyword4' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_53'].'', 'value' => date('Y-m-d', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				...
				{
					$remark = ''.$this->lang['lang_plugin_creditshop_core_model_54'].':  '.$this->lang['lang_plugin_creditshop_core_model_55'].'';
					if (!(empty($log['addressid']))) 
					{
						...
						if (!(empty($address))) 
						{
							$remark = ''.$this->lang['lang_plugin_creditshop_core_model_56'].': ' . $address['realname'] . ' '.$this->lang['lang_plugin_creditshop_core_model_57'].': ' . $address['mobile'] . ' '.$this->lang['lang_plugin_creditshop_core_model_58'].': ' . $address['province'] . $address['city'] . $address['area'] . ' ' . $address['address'];
						}
						$remark .= ', '.$this->lang['lang_plugin_creditshop_core_model_59'].','.$this->lang['lang_plugin_creditshop_core_model_60'].'!';
					}
					$msg = array( 'first' => array('value' => ''.$this->lang['lang_plugin_creditshop_core_model_61'].'~', 'color' => '#4a5077'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_62'].'', 'value' => $log['logno'], 'color' => '#4a5077'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_63'].'', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword3' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_64'].'', 'value' => date('Y-m-d', $log['createtime']), 'color' => '#4a5077'), 'keyword4' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_65'].'', 'value' => ($goods['isverify'] ? ''.$this->lang['lang_plugin_creditshop_core_model_66'].'' : ''.$this->lang['lang_plugin_creditshop_core_model_67'].''), 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
			...
			{
				$info = ''.$this->lang['lang_plugin_creditshop_core_model_68'].'';
				if (!(empty($log['addressid']))) 
				{
					$address = pdo_fetch('select id,realname,mobile,address,province,city,area from ' . tablename('ewei_shop_member_address') . ' where id=:id and uniacid=:uniacid limit 1', array(':id' => $log['addressid'], ':uniacid' => $_W['uniacid']));
					if (!(empty($address))) 
					{
						$info = ' '.$this->lang['lang_plugin_creditshop_core_model_69'].': ' . $address['realname'] . ' '.$this->lang['lang_plugin_creditshop_core_model_70'].': ' . $address['mobile'] . ' '.$this->lang['lang_plugin_creditshop_core_model_71'].': ' . $address['province'] . $address['city'] . $address['area'] . ' ' . $address['address'];
					}
				}
				$msg = array( 'first' => array('value' => ''.$this->lang['lang_plugin_creditshop_core_model_72'].'~', 'color' => '#4a5077'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_73'].'', 'value' => ''.$this->lang['lang_plugin_creditshop_core_model_74'].' ' . $credits, 'color' => '#4a5077'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_75'].'', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword3' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_76'].'', 'value' => $info, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				if (!(empty($tm['send']))) 
				{
				...
				$msg_saler = array( 'first' => array('value' => ''.$this->lang['lang_plugin_creditshop_core_model_77'].'~', 'color' => '#4a5077'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_78'].'', 'value' => ''.$this->lang['lang_plugin_creditshop_core_model_79'].' ' . $credits, 'color' => '#4a5077'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_80'].'', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword3' => array('title' => ''.$this->lang['lang_plugin_creditshop_core_model_81'].'', 'value' => $info, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				if (!(empty($tm['send']))) 
				{
		...
		{
			return array( 'creditshop' => array( 'text' => $this->getName(), 'isplugin' => true, 'child' => array( 'cover' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_82'].''), 'goods' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_83'].'', 'view' => ''.$this->lang['lang_plugin_creditshop_core_model_84'].'', 'add' => ''.$this->lang['lang_plugin_creditshop_core_model_85'].'-log', 'edit' => ''.$this->lang['lang_plugin_creditshop_core_model_86'].'-log', 'delete' => ''.$this->lang['lang_plugin_creditshop_core_model_87'].'-log'), 'category' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_88'].'', 'view' => ''.$this->lang['lang_plugin_creditshop_core_model_89'].'', 'add' => ''.$this->lang['lang_plugin_creditshop_core_model_90'].'-log', 'edit' => ''.$this->lang['lang_plugin_creditshop_core_model_91'].'-log', 'delete' => ''.$this->lang['lang_plugin_creditshop_core_model_92'].'-log'), 'adv' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_93'].'', 'view' => ''.$this->lang['lang_plugin_creditshop_core_model_94'].'', 'add' => ''.$this->lang['lang_plugin_creditshop_core_model_95'].'-log', 'edit' => ''.$this->lang['lang_plugin_creditshop_core_model_96'].'-log', 'delete' => ''.$this->lang['lang_plugin_creditshop_core_model_97'].'-log'), 'log' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_98'].'', 'view0' => ''.$this->lang['lang_plugin_creditshop_core_model_99'].'', 'view1' => ''.$this->lang['lang_plugin_creditshop_core_model_100'].'', 'exchange' => ''.$this->lang['lang_plugin_creditshop_core_model_101'].'-log', 'export0' => ''.$this->lang['lang_plugin_creditshop_core_model_102'].'-log', 'export1' => ''.$this->lang['lang_plugin_creditshop_core_model_103'].'-log'), 'notice' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_104'].'', 'view' => ''.$this->lang['lang_plugin_creditshop_core_model_105'].'', 'save' => ''.$this->lang['lang_plugin_creditshop_core_model_106'].'-log'), 'set' => array('text' => ''.$this->lang['lang_plugin_creditshop_core_model_107'].'', 'view' => ''.$this->lang['lang_plugin_creditshop_core_model_108'].'', 'save' => ''.$this->lang['lang_plugin_creditshop_core_model_109'].'-log') ) ) );
		}
		public function allow($logid, $times = 0, $verifycode = '', $openid = '') 
		{
			...
			if (empty($saler)) 
			{
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_110'].'!');
			}
			if (empty($log)) 
			{
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_111'].'!');
			}
			if (($log['verifytime'] < time()) && (0 < $log['verifytime'])) 
			{
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_112'].'!');
			}
			if (empty($goods)) 
			{
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_113'].'!');
			}
			if (empty($goods['isverify'])) 
			{
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_114'].'!');
			}
			$storeids = array();
			...
			if (!(empty($storeids))) 
			{
				if (!(empty($saler['storeid']))) 
				{
					...
					{
						return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_115'].'!');
					}
				}
			}
			if ($goods['verifytype'] == 0) 
			{
				...
				if (!(empty($verifynum))) 
				{
					return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_116'].'');
					if ($goods['verifytype'] == 1) 
					{
						$verifynum = pdo_fetchcolumn('select COUNT(1) from ' . tablename('ewei_shop_creditshop_verify') . ' where uniacid = :uniacid and logid = :logid ', array(':uniacid' => $uniacid, ':logid' => $logid));
						if ($goods['verifynum'] <= $verifynum) 
						{
							return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_117'].'');
						}
						$lastverifys = $goods['verifynum'] - $verifynum;
						if (($lastverifys < 0) && !(empty($goods['verifytype']))) 
						{
							return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_118'].' ' . $goods['verifynum'] . ' '.$this->lang['lang_plugin_creditshop_core_model_119'].'!');
						}
					}
				}
			}
			...
			{
				$verifynum = pdo_fetchcolumn('select COUNT(1) from ' . tablename('ewei_shop_creditshop_verify') . ' where uniacid = :uniacid and logid = :logid ', array(':uniacid' => $uniacid, ':logid' => $logid));
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_120'].'');
				$lastverifys = $goods['verifynum'] - $verifynum;
				return error(-1, ''.$this->lang['lang_plugin_creditshop_core_model_121'].' ' . $goods['verifynum'] . ' '.$this->lang['lang_plugin_creditshop_core_model_122'].'!');
			}
			if (!(empty($saler['storeid']))) 
			{
				if (0 < $merchid) 
