...
class Detail_EweiShopV2Page extends CreditshopMobilePage 
{
	public function main() 
	{
		...
		if (!($id)) 
		{
			$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_0'].'!', mobileUrl('creditshop'), 'error');
		}
		...
		if (empty($goods)) 
		{
			$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_1'].'!', mobileUrl('creditshop'), 'error');
		}
		$showgoods = m('goods')->visit($goods, $member);
		if (empty($showgoods)) 
		{
			$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_2'].'!', mobileUrl('creditshop'), 'error');
		}
		...
		{
			$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_3'].'!', mobileUrl('creditshop'), 'error');
		}
		$log = array();
	...
	public function option() 
	{
		...
		if (!($options)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_4'].'');
		}
	...
	public function pay($a = array(), $b = array()) 
	{
		...
		if (!(empty($addressid))) 
		{
			...
			if (empty($address)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_5'].'');
			}
		}
		...
		if ($needpay) 
		{
			...
			if ($paytype == 'balance') 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_6'].'!');
				}
			...
			else if ($paytype == 'wechat') 
			{
				...
				if (!(is_weixin())) 
				{
					show_json(0, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_7'].'!');
				}
				if (empty($set['pay']['weixin']) && empty($set['pay']['weixin_jie'])) 
				{
					show_json(0, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_8'].'!');
				}
				...
				$params['title'] = $set['shop']['name'] . ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_9'].'' : ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_10'].'')) . ' '.$this->lang['lang_plugin_creditshop_core_mobile_detail_11'].':' . $log['logno'];
			...
			else if ($paytype == 'alipay') 
			{
				...
				$params['user'] = $openid;
				$params['fee'] = $goods['money'] + $goods['dispatch'];
				$params['title'] = $set['shop']['name'] . ((empty($goods['type']) ? ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_12'].'' : ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_13'].'')) . ' '.$this->lang['lang_plugin_creditshop_core_mobile_detail_14'].':' . $log['logno'];
				...
				if (!($alipay['success'])) 
				{
					show_json(0, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_15'].'!');
				}
	...
	public function creditshop_complete() 
	{
		...
		if (is_h5app()) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_16'].'(1)!', mobileUrl('order'));
			}
			...
			if ($alisign == 0) 
			{
				$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_17'].'(2)!', mobileUrl('order'));
			}
		}
		else 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_18'].'!', mobileUrl('order'));
			}
			if (!(m('finance')->isAlipayNotify($_GET))) 
			{
				...
				if (($lastlog['status'] == 1) && (0 < $lastlog['paystatus'])) 
				{
					if ($fromwechat) 
					{
						$this->message(array('message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_19'].'', 'title' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_20'].'!', 'buttondisplay' => false), NULL, 'success');
					}
					else 
					{
						$this->message(array('message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_21'].'', 'title' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_22'].'!'), mobileUrl('creditshop/log'), 'success');
					}
				}
				$this->message(array('message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_23'].'('.$this->lang['lang_plugin_creditshop_core_mobile_detail_24'].')!', 'buttondisplay' => ($fromwechat ? false : true)), ($fromwechat ? NULL : mobileUrl('order')));
			}
		}
		$lastlog = pdo_fetch('select * from ' . tablename('ewei_shop_creditshop_log') . "\r\n" . '                    where logno=:logno and uniacid=:uniacid limit 1', array(':logno' => $tid, ':uniacid' => $_W['uniacid']));
		if (empty($lastlog)) 
		{
			$this->message(array('message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_25'].'('.$this->lang['lang_plugin_creditshop_core_mobile_detail_26'].'2)!', 'buttondisplay' => ($fromwechat ? false : true)), ($fromwechat ? NULL : mobileUrl('order')));
		}
		if (is_h5app()) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_creditshop_core_mobile_detail_27'].'(4)!', mobileUrl('creditshop/log'));
			}
		}
		if ($lastlog['status'] < 1) 
		{
		...
		if ($fromwechat) 
		{
			$this->message(array('message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_28'].'', 'title' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_29'].'!', 'buttondisplay' => false), NULL, 'success');
			return;
		}
		$this->message(array('message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_30'].'', 'title' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_31'].'!'), mobileUrl('creditshop/detail/lottery', array('id' => $creditlog['id'])), 'success');
	}
	public function lottery() 
	{
		...
		if ($open_redis) 
		{
			...
			if (!(is_error($redis))) 
			{
				...
				{
					show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_32'].'!'));
				}
			}
		}
		$id = intval($_GPC['id']);
		...
		if (empty($log)) 
		{
			show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_33'].'!'));
		}
		if (1 <= $log['status']) 
		{
			show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_34'].'!'));
		}
		if (empty($goods['canbuy'])) 
		{
		...
		if (empty($log['paystatus'])) 
		{
			...
			{
				show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_35'].'!'));
			}
			if ((0 < $goods['money']) && ($money < $goods['money']) && ($log['paytype'] == 0)) 
			{
				show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_36'].'!'));
			}
		}
		if ((0 < ($goods['money'] + $goods['dispatch'])) && ($log['paystatus'] < 1)) 
		{
			if ($log['paytype'] == 0) 
			{
				m('member')->setCredit($openid, 'credit2', -($goods['money'] + $goods['dispatch']), ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_37'].' ' . $goods['money']);
				$update['paystatus'] = 1;
			}
			if ($log['paytype'] == 1) 
			{
				...
				{
					show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_38'].','.$this->lang['lang_plugin_creditshop_core_mobile_detail_39'].'(1)!'));
				}
			}
			if ($log['paytype'] == 2) 
			{
				if ($log['paystatus'] < 1) 
				{
					show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_40'].'!'));
				}
			}
		}
		if ((0 < $goods['credit']) && empty($log['creditpay'])) 
		{
			m('member')->setCredit($openid, 'credit1', -$goods['credit'], ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_41'].' ' . $goods['credit']);
			$update['creditpay'] = 1;
		...
		if ($status == 2) 
		{
			...
			{
				$credittype = 'credit2';
				$creditstr = ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_42'].'';
				...
				$data = array('openid' => $openid, 'logno' => $logno, 'uniacid' => $_W['uniacid'], 'type' => '0', 'createtime' => TIMESTAMP, 'status' => '1', 'title' => $set['name'] . ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_43'].'', 'money' => $num, 'remark' => $creditstr, 'rechargetype' => 'creditshop');
				pdo_insert('ewei_shop_member_log', $data);
				$mlogid = pdo_insertid();
				m('notice')->sendMemberLogMessage($mlogid);
				plog('finance.recharge.' . $credittype, ''.$this->lang['lang_plugin_creditshop_core_mobile_detail_44'].'' . $creditstr . ': ' . $num . ' <br/>'.$this->lang['lang_plugin_creditshop_core_mobile_detail_45'].': ID: ' . $member['id'] . ' /  ' . $member['openid'] . '/' . $member['nickname'] . '/' . $member['realname'] . '/' . $member['mobile']);
				$status = 3;
				$update['time_finish'] = time();
			}
