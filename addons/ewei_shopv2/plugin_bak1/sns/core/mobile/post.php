...
class Post_EweiShopV2Page extends SnsMobilePage 
{
	public function main() 
	{
		...
		if (empty($id)) 
		{
			$this->message(''.$this->lang['lang_plugin_sns_core_mobile_post_0'].'');
		}
		$post = $this->model->getPost($id);
		if (empty($post)) 
		{
			$this->message(''.$this->lang['lang_plugin_sns_core_mobile_post_1'].'!');
		}
		...
		if (empty($board)) 
		{
			$this->message(''.$this->lang['lang_plugin_sns_core_mobile_post_2'].'!');
		}
		...
		$level = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_sns_core_mobile_post_3'].'' : $set['levelname']), 'color' => (empty($set['levelcolor']) ? '#333' : $set['levelcolor']), 'bg' => (empty($set['levelbg']) ? '#eee' : $set['levelbg']));
	...
	public function checkPost() 
	{
		...
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_4'].'');
		}
	...
	public function submit() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_5'].'');
		}
		$bid = intval($_GPC['bid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_6'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_7'].'!');
		}
		...
		if ($len < 3) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_8'].'3'.$this->lang['lang_plugin_sns_core_mobile_post_9'].'~');
		}
		if (25 < $len) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_10'].'25'.$this->lang['lang_plugin_sns_core_mobile_post_11'].'~');
		}
		$content = trim($_GPC['content']);
		$len = istrlen($content);
		if ($len < 3) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_12'].'3'.$this->lang['lang_plugin_sns_core_mobile_post_13'].'~');
		}
		if (1000 < $len) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_14'].'1000'.$this->lang['lang_plugin_sns_core_mobile_post_15'].'~');
		}
		$checked = 0;
		if ($ismanager) 
		{
		...
		if (is_array($_GPC['images'])) 
		{
			...
			{
				show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_16'].'' . $imagesData['imagesnum'] . ''.$this->lang['lang_plugin_sns_core_mobile_post_17'].'');
			}
			if ((5 < $imgcount) && ($imagesData['imagesnum'] == 0)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_18'].'5'.$this->lang['lang_plugin_sns_core_mobile_post_19'].'');
			}
		}
		$time = time();
	...
	public function complain() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_20'].'');
		}
		$uniacid = $_W['uniacid'];
		$id = intval($_GPC['id']);
		$openid = $_W['openid'];
		...
		if (empty($posts)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_21'].'');
		}
		$type = intval($_GPC['type']);
		if (empty($type)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_22'].'');
		}
		$content = trim($_GPC['content']);
		$len = istrlen($content);
		if ($len < 3) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_23'].'3'.$this->lang['lang_plugin_sns_core_mobile_post_24'].'~');
		}
		if (500 < $len) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_25'].'500'.$this->lang['lang_plugin_sns_core_mobile_post_26'].'~');
		}
		...
		if (empty($insert_id)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_27'].'');
		}
		show_json(1);
	}
	public function reply() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_28'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		...
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_29'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_30'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_31'].'!');
		}
		...
		if ($len < 3) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_32'].'3'.$this->lang['lang_plugin_sns_core_mobile_post_33'].'~');
		}
		if (500 < $len) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_34'].'500'.$this->lang['lang_plugin_sns_core_mobile_post_35'].'~');
		}
		$checked = 0;
		if ($ismanager) 
		{
	...
	public function getlist() 
	{
		...
		foreach ($list as $key => &$row ) 
		{
			...
			$level = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_sns_core_mobile_post_36'].'' : $set['levelname']), 'color' => (empty($set['levelcolor']) ? '#333' : $set['levelcolor']), 'bg' => (empty($set['levelbg']) ? '#eee' : $set['levelbg']));
			if (!(empty($member['sns_level']))) 
			{
				$level = pdo_fetch('select * from ' . tablename('ewei_shop_sns_level') . ' where id=:id  limit 1', array(':id' => $member['sns_level']));
			}
	...
	public function like() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_37'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_38'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_39'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_40'].'!');
		}
		$isgood = 1;
	...
	public function delete() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_41'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_42'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_43'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_44'].'!');
		}
		$isManager = $this->model->isManager($bid);
		$isSuperManager = $this->model->isSuperManager();
		if (!($isManager) && !($isSuperManager)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_45'].'');
		}
	...
	public function check() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_46'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_47'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_48'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_49'].'!');
		}
		$isManager = $this->model->isManager($bid);
		$isSuperManager = $this->model->isSuperManager();
		if (!($isManager) && !($isSuperManager)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_50'].'');
		}
		if (!($post['checked'])) 
		{
	...
	public function best() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_51'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_52'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_53'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_54'].'!');
		}
		$isManager = $this->model->isManager($bid);
		$isSuperManager = $this->model->isSuperManager();
		if (!($isManager) && !($isSuperManager)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_55'].'');
		}
		$isbest = 1;
		if ($post['isboardbest']) 
		{
	...
	public function top() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_56'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_57'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_58'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_59'].'!');
		}
		$isManager = $this->model->isManager($bid);
		$isSuperManager = $this->model->isSuperManager();
		if (!($isManager) && !($isSuperManager)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_60'].'');
		}
		$istop = 1;
		if ($post['isboardtop']) 
		{
	...
	public function allbest() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_61'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_62'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_63'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_64'].'!');
		}
		$isManager = $this->model->isSuperManager();
		if (!($isManager)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_65'].'');
		}
		$isbest = 1;
		if ($post['isbest']) 
		{
	...
	public function alltop() 
	{
		...
		if (!($this->islogin)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_66'].'');
		}
		$bid = intval($_GPC['bid']);
		$pid = intval($_GPC['pid']);
		if (empty($bid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_67'].'');
		}
		$board = $this->model->getBoard($bid);
		if (empty($board)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_68'].'!');
		}
		$post = $this->model->getPost($pid);
		if (empty($post)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_69'].'!');
		}
		$isManager = $this->model->isSuperManager();
		if (!($isManager)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_sns_core_mobile_post_70'].'');
		}
		$istop = 1;
		if ($post['istop']) 
		{
