...
class Index_EweiShopV2Page extends PluginMobilePage 
{
	public function main() 
	{
		...
		if (!($merchid)) 
		{
			$this->message(''.$this->lang['lang_plugin_merch_core_mobile_index_0'].'', '', 'error');
		}
	...
	public function getpage($merchid) 
	{
		...
		$defaults = array( 'adv' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_1'].'', 'visible' => 1), 'search' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_2'].'', 'visible' => 1), 'nav' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_3'].'', 'visible' => 1), 'notice' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_4'].'', 'visible' => 1), 'cube' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_5'].'', 'visible' => 1), 'banner' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_6'].'', 'visible' => 1), 'goods' => array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_7'].'', 'visible' => 1) );
		$shop = p('merch')->getSet('shop', $merchid);
		$sorts = ((isset($shop['indexsort']) ? $shop['indexsort'] : $defaults));
		$sorts['recommand'] = array('text' => ''.$this->lang['lang_plugin_merch_core_mobile_index_8'].'', 'visible' => 1);
