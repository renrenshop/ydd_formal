...
class Index_EweiShopV2Page extends PluginMobileLoginPage 
{
	...
	public function bargain() 
	{
		...
		if ($ajax == 151) 
		{
			if ($isFollowed !== true) 
			{
				exit(''.$this->lang['lang_plugin_bargain_core_mobile_index_0'].'');
			}
		...
		else if ($type == 0) 
		{
			if (!(empty($share_res['bargain_title']))) 
			{
				...
				$share_res['bargain_title'] = str_replace('['.$this->lang['lang_plugin_bargain_core_mobile_index_1'].']', $res['bargain_price'], $share_res['bargain_title']);
				$share_res['bargain_title'] = str_replace('['.$this->lang['lang_plugin_bargain_core_mobile_index_2'].']', $weikan, $share_res['bargain_title']);
				$share_res['bargain_title'] = str_replace('['.$this->lang['lang_plugin_bargain_core_mobile_index_3'].']', $res['now_price'], $share_res['bargain_title']);
				$share_res['bargain_title'] = str_replace('['.$this->lang['lang_plugin_bargain_core_mobile_index_4'].']', $res2['start_price'], $share_res['bargain_title']);
				$share['title'] = str_replace('['.$this->lang['lang_plugin_bargain_core_mobile_index_5'].']', $res2['end_price'], $share_res['bargain_title']);
			}
			else 
			{
				$share['title'] = $res2['title'];
	...
	public function join() 
	{
		...
		if (empty($user_info)) 
		{
			exit(''.$this->lang['lang_plugin_bargain_core_mobile_index_6'].'');
		}
		...
		{
			$this->message(''.$this->lang['lang_plugin_bargain_core_mobile_index_7'].','.$this->lang['lang_plugin_bargain_core_mobile_index_8'].'', mobileUrl('bargain/detail', array('id' => $goods_id)));
		}
		if (!(empty($res['initiate']))) 
		{
			if (!(empty($count['id']))) 
		...
		{
			$this->message(''.$this->lang['lang_plugin_bargain_core_mobile_index_9'].','.$this->lang['lang_plugin_bargain_core_mobile_index_10'].'', mobileUrl('bargain/detail', array('id' => $goods_id)));
		}
		else if (strtotime($res['end_time']) < time()) 
		{
			$this->message(''.$this->lang['lang_plugin_bargain_core_mobile_index_11'].'', mobileUrl('bargain/detail', array('id' => $goods_id)));
		}
		else if (time() < strtotime($res['start_time'])) 
		{
			$this->message(''.$this->lang['lang_plugin_bargain_core_mobile_index_12'].'', mobileUrl('bargain/detail', array('id' => $goods_id)));
		}
		else if ($goods_detail['status'] != 1) 
		{
			$this->message(''.$this->lang['lang_plugin_bargain_core_mobile_index_13'].'', mobileUrl('bargain/detail', array('id' => $goods_id)));
		}
		...
		{
			exit(''.$this->lang['lang_plugin_bargain_core_mobile_index_14'].'');
		}
		if ($id) 
		{
		...
		echo ''.$this->lang['lang_plugin_bargain_core_mobile_index_15'].'';
	}
	public function cut($actor_id, $time3, $min_price, $each_time, $total_time, $max_price, $probability_json) 
	{
		...
		if (empty($actor_id)) 
		{
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_16'].'';
		}
		if ($time3 <= 0) 
		{
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_17'].'';
		}
		if (($each_time <= count($record_res)) || ($total_time <= count($all_record))) 
		{
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_18'].'';
		}
		...
		{
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_19'].'';
		}
		$now_price['now_price'] = round($now_price['now_price'], 2);
		$min_price = round($min_price, 2);
		if ($now_price['now_price'] <= $min_price) 
		{
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_20'].','.$this->lang['lang_plugin_bargain_core_mobile_index_21'].'TA<br>'.$this->lang['lang_plugin_bargain_core_mobile_index_22'].'';
		}
		$temp_price = 2000000;
		$lastbargain = 0;
		...
		if ($cut_price <= 0) 
		{
			...
			$cut_price = -1 * $cut_price;
			$this->sendBargainResult($now_price['openid'], $cut_price, $now_price['now_price'], $info['nickname'], ''.$this->lang['lang_plugin_bargain_core_mobile_index_23'].'', ''.$this->lang['lang_plugin_bargain_core_mobile_index_24'].'', $lastbargain);
			pdo_query('UPDATE ' . tablename('ewei_shop_bargain_actor') . ' SET bargain_times = bargain_times + 1 WHERE id = :id', array(':id' => $actor_id));
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_25'].'' . $cut_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_26'].'';
		}
		if (0 < $cut_price) 
		{
			$now_price['now_price'] += $cut_price;
			$this->sendBargainResult($now_price['openid'], $cut_price, $now_price['now_price'], $info['nickname'], ''.$this->lang['lang_plugin_bargain_core_mobile_index_27'].'', ''.$this->lang['lang_plugin_bargain_core_mobile_index_28'].'');
			pdo_query('UPDATE ' . tablename('ewei_shop_bargain_actor') . ' SET bargain_times = bargain_times + 1 WHERE id = :id', array(':id' => $actor_id));
			return ''.$this->lang['lang_plugin_bargain_core_mobile_index_29'].'' . $cut_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_30'].'';
		}
	}
	...
	private function sendBargainResult($openid, $cut_price, $now_price, $nickname, $iORr, $sORf, $last = 0) 
	{
		...
		$datas[] = array('name' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_31'].'', 'value' => $cut_price);
		$datas[] = array('name' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_32'].'', 'value' => $now_price);
		$datas[] = array('name' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_33'].'', 'value' => $time);
		$datas[] = array('name' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_34'].'', 'value' => $nickname);
		$datas[] = array('name' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_35'].'', 'value' => $iORr);
		$datas[] = array('name' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_36'].'', 'value' => $sORf);
		$url = mobileUrl('bargain/bargain', array('id' => $_GPC['id']), 1);
		$remark = "\n" . '<a href=\'' . $url . '\'>'.$this->lang['lang_plugin_bargain_core_mobile_index_37'].'</a>';
		if ($last == 1) 
		{
			$tag = 'bargain_fprice';
			$text = ''.$this->lang['lang_plugin_bargain_core_mobile_index_38'].'' . "\n\n" . '['.$this->lang['lang_plugin_bargain_core_mobile_index_39'].']'.$this->lang['lang_plugin_bargain_core_mobile_index_40'].'' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_41'].'['.$this->lang['lang_plugin_bargain_core_mobile_index_42'].']'.$this->lang['lang_plugin_bargain_core_mobile_index_43'].'['.$this->lang['lang_plugin_bargain_core_mobile_index_44'].']'.$this->lang['lang_plugin_bargain_core_mobile_index_45'].'' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_46'].'['.$this->lang['lang_plugin_bargain_core_mobile_index_47'].']' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_48'].'['.$this->lang['lang_plugin_bargain_core_mobile_index_49'].']'.$this->lang['lang_plugin_bargain_core_mobile_index_50'].'' . "\n\n" . '<a href=\'' . $url . '\'>'.$this->lang['lang_plugin_bargain_core_mobile_index_51'].'</a>';
			$message = array( 'first' => array('value' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_52'].'' . "\n", 'color' => '#000000'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_53'].'', 'value' => $nickname . ''.$this->lang['lang_plugin_bargain_core_mobile_index_54'].'', 'color' => '#000000'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_55'].'', 'value' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_56'].'', 'color' => '#000000'), 'remark' => array('value' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_57'].'' . $iORr . ''.$this->lang['lang_plugin_bargain_core_mobile_index_58'].'' . $cut_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_59'].'' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_60'].'' . $time . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_61'].'' . $now_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_62'].'' . "\n\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_63'].'', 'color' => '#000000') );
		}
		else 
		{
			$tag = 'bargain_message';
			$text = ''.$this->lang['lang_plugin_bargain_core_mobile_index_64'].'' . "\n\n" . $nickname . ''.$this->lang['lang_plugin_bargain_core_mobile_index_65'].'' . $sORf . ''.$this->lang['lang_plugin_bargain_core_mobile_index_66'].'' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_67'].'' . $iORr . ''.$this->lang['lang_plugin_bargain_core_mobile_index_68'].'' . $cut_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_69'].'' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_70'].'' . $time . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_71'].'' . $now_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_72'].'' . "\n" . $remark;
			$message = array( 'first' => array('value' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_73'].'' . $sORf . ''.$this->lang['lang_plugin_bargain_core_mobile_index_74'].'' . "\n", 'color' => '#000000'), 'keyword1' => array('title' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_75'].'', 'value' => $nickname . ''.$this->lang['lang_plugin_bargain_core_mobile_index_76'].'' . $sORf, 'color' => '#000000'), 'keyword2' => array('title' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_77'].'', 'value' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_78'].'' . $sORf . ''.$this->lang['lang_plugin_bargain_core_mobile_index_79'].'', 'color' => '#000000'), 'remark' => array('value' => ''.$this->lang['lang_plugin_bargain_core_mobile_index_80'].'' . $iORr . ''.$this->lang['lang_plugin_bargain_core_mobile_index_81'].'' . $sORf . ''.$this->lang['lang_plugin_bargain_core_mobile_index_82'].'' . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_83'].'' . $time . "\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_84'].'' . $now_price . ''.$this->lang['lang_plugin_bargain_core_mobile_index_85'].'' . "\n\n" . ''.$this->lang['lang_plugin_bargain_core_mobile_index_86'].'', 'color' => '#000000') );
		}
