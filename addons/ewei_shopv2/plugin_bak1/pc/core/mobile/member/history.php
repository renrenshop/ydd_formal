...
class History_EweiShopV2Page extends PcMobileLoginPage 
{
	public function main() 
	{
		...
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_history_0'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_history_1'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_history_2'].'') );
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_member_history_3'].'', 'menu_url' => mobileUrl('pc.member.history')) );
	...
	public function remove() 
	{
		...
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_member_history_4'].'');
		}
