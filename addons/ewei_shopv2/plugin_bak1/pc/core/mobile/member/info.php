...
class Info_EweiShopV2Page extends PcMobileLoginPage 
{
	...
	public function main() 
	{
		...
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_member_info_0'].'', 'menu_url' => mobileUrl('pc.member.info')) );
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_info_1'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_info_2'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_info_3'].'') );
