...
class Log_EweiShopV2Page extends PcMobileLoginPage 
{
	public function main() 
	{
		...
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_log_0'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_log_1'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_log_2'].'') );
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_member_log_3'].'', 'menu_url' => mobileUrl('pc.member.history')) );
