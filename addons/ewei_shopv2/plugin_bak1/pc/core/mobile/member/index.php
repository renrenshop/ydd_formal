...
class Index_EweiShopV2Page extends MobileLoginPage 
{
	public function main() 
	{
		...
		if ($com_sign) 
		{
			...
			{
				$hassign = ((empty($_W['shopset']['trade']['credittext']) ? ''.$this->lang['lang_plugin_pc_core_mobile_member_index_0'].'' : $_W['shopset']['trade']['credittext']));
				$hassign .= ((empty($com_sign_set['textsign']) ? ''.$this->lang['lang_plugin_pc_core_mobile_member_index_1'].'' : $com_sign_set['textsign']));
			}
		}
		$wapset = m('common')->getSysset('wap');
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_member_index_2'].'', 'menu_url' => mobileUrl('pc.member')) );
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_index_3'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_member_index_4'].'') );
