...
class Qa_EweiShopV2Page extends PcMobilePage 
{
	...
	public function main() 
	{
		...
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_0'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_1'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_2'].'') );
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_3'].'', 'menu_url' => mobileUrl('pc.qa.qa')) );
	...
	public function detail() 
	{
		...
		if (!(empty($id))) 
		{
			...
			if (empty($item)) 
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_4'].'!');
			}
			$item['content'] = iunserializer($item['content']);
			$item['content'] = htmlspecialchars_decode($item['content']);
		}
		...
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_5'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_6'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_7'].'') );
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_8'].'', 'menu_url' => mobileUrl('pc.qa.qa')), array('menu_key' => 'detail', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_qa_qa_9'].'', 'menu_url' => mobileUrl('pc.qa.qa.detail', array('id' => $id, 'mk' => 'detail'))) );
		include $this->template();
	}
}
?>