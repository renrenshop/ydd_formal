...
class Detail_EweiShopV2Page extends PcMobilePage 
{
	public function main() 
	{
		...
		if (!($id)) 
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_0'].'!', mobileUrl('creditshop'), 'error');
		}
		...
		if (empty($showgoods)) 
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_1'].'!', mobileUrl('creditshop'), 'error');
		}
		...
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_2'].'!', mobileUrl('creditshop'), 'error');
		}
		$log = array();
	...
	public function option() 
	{
		...
		if (!($options)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_3'].'');
		}
	...
	public function pay($a = array(), $b = array()) 
	{
		...
		if ($needpay) 
		{
			...
			if ($paytype == 'balance') 
			{
				...
				{
					show_json(0, "'.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_4'].'!");
				}
			...
			else if ($paytype == 'wechat') 
			{
				...
				if (!(is_weixin())) 
				{
					show_json(0, "'.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_5'].'!");
				}
				if (empty($set['pay']['weixin']) && empty($set['pay']['weixin_jie'])) 
				{
					show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_6'].'!');
				}
				...
				$params['title'] = $set['shop']['name'] . ((empty($goods['type']) ? ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_7'].'' : ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_8'].'')) . ' '.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_9'].':' . $log['logno'];
				...
				if (!($wechat['success'])) 
				{
					show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_10'].'!');
				}
			...
			else if ($paytype == 'alipay') 
			{
				...
				$params['user'] = $openid;
				$params['fee'] = $goods['money'] + $goods['dispatch'];
				$params['title'] = $set['shop']['name'] . ((empty($goods['type']) ? ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_11'].'' : ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_12'].'')) . ' '.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_13'].':' . $log['logno'];
				...
				if (!($alipay['success'])) 
				{
					show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_14'].'!');
				}
	...
	public function creditshop_complete() 
	{
		...
		if (is_h5app()) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_15'].'(1)!', mobileUrl('order'));
			}
			...
			if ($alisign == 0) 
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_16'].'(2)!', mobileUrl('order'));
			}
		}
		else 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_17'].'!', mobileUrl('order'));
			}
			if (!(m("finance")->isAlipayNotify($_GET))) 
			{
				...
				if (($lastlog['status'] == 1) && (0 < $lastlog['paystatus'])) 
				{
					if ($fromwechat) 
					{
						$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_18'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_19'].'!', 'buttondisplay' => false), NULL, 'success');
					}
					else 
					{
						$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_20'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_21'].'!'), mobileUrl('creditshop/log'), 'success');
					}
				}
				$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_22'].'('.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_23'].')!', 'buttondisplay' => ($fromwechat ? false : true)), ($fromwechat ? NULL : mobileUrl('order')));
			}
		}
		$lastlog = pdo_fetch('select * from ' . tablename('ewei_shop_creditshop_log') . "\n" . '                    where logno=:logno and uniacid=:uniacid limit 1', array(':logno' => $tid, ':uniacid' => $_W['uniacid']));
		if (empty($lastlog)) 
		{
			$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_24'].'('.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_25'].'2)!', 'buttondisplay' => ($fromwechat ? false : true)), ($fromwechat ? NULL : mobileUrl('order')));
		}
		if (is_h5app()) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_26'].'(4)!', mobileUrl('creditshop/log'));
			}
		}
		if ($lastlog['status'] < 1) 
		{
		...
		if ($fromwechat) 
		{
			$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_27'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_28'].'!', 'buttondisplay' => false), NULL, 'success');
			return;
		}
		$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_29'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_30'].'!'), mobileUrl('creditshop/detail/lottery', array('id' => $creditlog['id'])), 'success');
	}
	public function lottery() 
	{
		...
		if ($open_redis) 
		{
			...
			if (!(is_error($redis))) 
			{
				...
				{
					show_json(0, array("status" => "-1", "message" => "'.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_31'].'!"));
				}
			}
		}
		$id = intval($_GPC['id']);
		...
		if (empty($log)) 
		{
			show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_32'].'!'));
		}
		if (1 <= $log['status']) 
		{
			show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_33'].'!'));
		}
		if (empty($goods['canbuy'])) 
		{
		...
		if (empty($log['paystatus'])) 
		{
			...
			{
				show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_34'].'!'));
			}
			if ((0 < $goods['money']) && ($money < $goods['money']) && ($log['paytype'] == 0)) 
			{
				show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_35'].'!'));
			}
		}
		if ((0 < $goods['money']) && empty($log['paystatus'])) 
		{
			if ($log['paytype'] == 0) 
			{
				m('member')->setCredit($openid, 'credit2', -$goods['money'], ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_36'].' ' . $goods['money']);
				$update['paystatus'] = 1;
			}
			if ($log['paytype'] == 1) 
			{
				if (empty($log['paystatus'])) 
				{
					show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_37'].'!'));
				}
			}
			if ($log['paytype'] == 2) 
			{
				if (empty($log['paystatus'])) 
				{
					show_json(0, array('status' => '-1', 'message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_38'].'!'));
				}
			}
		}
		if ((0 < $goods['credit']) && empty($log['creditpay'])) 
		{
			m('member')->setCredit($openid, 'credit1', -$goods['credit'], ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_39'].' ' . $goods['credit']);
			$update['creditpay'] = 1;
		...
		if ($status == 2) 
		{
			...
			{
				$credittype = 'credit2';
				$creditstr = ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_40'].'';
				...
				$data = array('openid' => $openid, 'logno' => $logno, 'uniacid' => $_W['uniacid'], 'type' => '0', 'createtime' => TIMESTAMP, 'status' => '1', 'title' => $set['name'] . ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_41'].'', 'money' => $num, 'remark' => $creditstr, 'rechargetype' => 'creditshop');
				pdo_insert("ewei_shop_member_log", $data);
				$mlogid = pdo_insertid();
				m("notice")->sendMemberLogMessage($mlogid);
				plog("finance.recharge." . $credittype, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_42'].'' . $creditstr . ': ' . $num . ' <br/>'.$this->lang['lang_plugin_pc_core_mobile_creditshop_detail_43'].': ID: ' . $member['id'] . ' /  ' . $member['openid'] . '/' . $member['nickname'] . '/' . $member['realname'] . '/' . $member['mobile']);
				$status = 3;
				$update['time_finish'] = time();
			}
