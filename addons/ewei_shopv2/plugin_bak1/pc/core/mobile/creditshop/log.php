...
class Log_EweiShopV2Page extends PcMobileLoginPage 
{
	...
	public function detail() 
	{
		...
		if (empty($log)) 
		{
			show_json(-1, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_0'].'!');
		}
		$goods = $this->model->getGoods($log['goodsid'], $member, $log['optionid']);
		if (empty($goods['id'])) 
		{
			show_json(-1, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_1'].'!');
		}
		$address = false;
	...
	public function Receivepacket() 
	{
		...
		if (!($log)) 
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_2'].''));
		}
		if ((2 < $log['status']) && (0 < $log['time_finish'])) 
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_3'].''));
		}
		if ($log['status'] < 2) 
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_4'].''));
		}
		...
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_5'].''));
		}
		$sec = m('common')->getSec();
		...
		$params = array('openid' => $openid, 'tid' => $log['logno'], 'send_name' => ($set['sendname'] ? $set['sendname'] : $_W['shopset']['shop']['name']), 'money' => $money, 'wishing' => ($set['sendname'] ? $set['wishing'] : ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_6'].'!'), 'act_name' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_7'].'', 'remark' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_8'].'');
		...
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_9'].'!'));
		}
		$err = m('common')->sendredpack($params, $wechat);
		if (is_error($err)) 
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_10'].'!'));
		}
		else 
		{
	...
	public function express() 
	{
		...
		if (empty($log['addressid'])) 
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_11'].'!');
		}
		if (($log['status'] < 3) && empty($log['expresssn'])) 
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_12'].'!');
		}
	...
	public function finish() 
	{
		...
		if (empty($log)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_13'].'');
		}
		if (($log['status'] != 3) && empty($log['expresssn'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_14'].'');
		}
	...
	public function paydispatch() 
	{
		...
		if (empty($log)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_15'].'!');
		}
		$goods = $this->model->getGoods($log['goodsid'], $member);
		if (empty($goods['id'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_16'].'!');
		}
		if (!(empty($goods['isendtime']))) 
		{
			if ($goods['endtime'] < time()) 
			{
				show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_17'].'!');
			}
		}
		if ($goods['dispatch'] <= 0) 
		{
		...
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_18'].'!');
		}
		...
		if ($paytype == 'wechat') 
		{
			...
			if (!(is_weixin())) 
			{
				show_json(0, "'.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_19'].'!");
			}
			if (empty($set['pay']['weixin']) && empty($set['pay']['weixin_jie'])) 
			{
				show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_20'].'!');
			}
			...
			$params['title'] = $set['shop']['name'] . ((empty($goods['type']) ? ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_21'].'' : ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_22'].'')) . ' '.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_23'].':' . $dispatchno;
			...
			if (!($wechat['success'])) 
			{
				show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_24'].'!');
			}
		}
		else if ($paytype == 'alipay') 
		{
			...
			$params['user'] = $openid;
			$params['fee'] = $goods['dispatch'];
			$params['title'] = $set['shop']['name'] . ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_25'].'' . ' '.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_26'].':' . $log['logno'];
			...
			if (!($alipay['success'])) 
			{
				show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_27'].'!');
			}
		}
	...
	public function dispatch_complete() 
	{
		...
		if (is_h5app()) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_28'].'(1)!', mobileUrl('order'));
			}
			...
			if ($alisign == 0) 
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_29'].'(2)!', mobileUrl('order'));
			}
		}
		else 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_30'].'!', mobileUrl('order'));
			}
			if (!(m("finance")->isAlipayNotify($_GET))) 
			{
				...
				if (0 < $lastlog['dispatchstatus']) 
				{
					if ($fromwechat) 
					{
						$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_31'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_32'].'!', 'buttondisplay' => false), NULL, 'success');
					}
					else 
					{
						$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_33'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_34'].'!'), mobileUrl('order'), 'success');
					}
				}
				$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_35'].'('.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_36'].')!', 'buttondisplay' => ($fromwechat ? false : true)), ($fromwechat ? NULL : mobileUrl('order')));
			}
		}
		$lastlog = pdo_fetch('select * from ' . tablename('ewei_shop_creditshop_log') . "\n" . '                    where dispatchno=:dispatchno and uniacid=:uniacid limit 1', array(':dispatchno' => $tid, ':uniacid' => $_W['uniacid']));
		if (empty($lastlog)) 
		{
			$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_37'].'('.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_38'].'2)!', 'buttondisplay' => ($fromwechat ? false : true)), ($fromwechat ? NULL : mobileUrl('order')));
		}
		if (is_h5app()) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_39'].'(4)!', mobileUrl('order'));
			}
		}
		...
		if ($fromwechat) 
		{
			$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_40'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_41'].'!', 'buttondisplay' => false), NULL, 'success');
			return;
		}
		$this->message(array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_42'].'', 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_43'].'!'), mobileUrl('creditshop/log/detail', array('id' => $creditlog['id'])), 'success');
	}
	public function payresult($a = array()) 
	{
		...
		if (empty($log)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_44'].'!');
		}
		if ($log['dispatchstatus'] < 1) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_45'].'!');
		}
		$goods = $this->model->getGoods($log['goodsid'], $member);
		if (empty($goods['id'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_46'].'!');
		}
	...
	public function setstore() 
	{
		...
		if (empty($storeid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_47'].'!');
		}
		$log = pdo_fetch('select * from ' . tablename('ewei_shop_creditshop_log') . ' where id=:id and openid=:openid and uniacid=:uniacid limit 1', array(':id' => $id, ':openid' => $openid, ':uniacid' => $uniacid));
		if (empty($log)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_48'].'!');
		}
		$goods = $this->model->getGoods($log['goodsid'], $member);
		if (empty($goods['id'])) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_creditshop_log_49'].'!');
		}
		$upgrade = array();
		$upgradem = array();
		if (empty($log['storeid'])) 
