...
class Index_EweiShopV2Page extends PcMobileLoginPage 
{
	...
	public function main() 
	{
		...
		extract($merchdata);
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_0'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_1'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_2'].'') );
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_3'].'', 'menu_url' => mobileUrl('pc.order')), array('menu_key' => 'recycle', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_4'].'', 'menu_url' => mobileUrl('pc.order', array('mk' => 'recycle'))) );
	...
	public function get_list() 
	{
		...
		$r_type = array(''.$this->lang['lang_plugin_pc_core_mobile_order_index_5'].'', ''.$this->lang['lang_plugin_pc_core_mobile_order_index_6'].'', ''.$this->lang['lang_plugin_pc_core_mobile_order_index_7'].'');
		...
		switch ($show_status) 
		{
			...
			foreach ($list as &$row ) 
			{
				...
				switch ($row['status']) 
				{
					case '-1': $status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_8'].'';
					break;
					case '0': if ($row['paytype'] == 3) 
					{
						$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_9'].'';
					}
					else 
					{
						$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_10'].'';
					}
					$statuscss = 'text-cancel';
					break;
					case '1': if ($row['isverify'] == 1) 
					{
						$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_11'].'';
					}
					else if (empty($row['addressid'])) 
					{
						$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_12'].'';
					}
					else 
					{
						$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_13'].'';
					}
					$statuscss = 'text-warning';
					break;
					case '2': $status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_14'].'';
					...
					case '3': if (empty($row['iscomment'])) 
					{
						if ($show_status == 5) 
						{
							$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_15'].'';
						}
						else 
						{
							$status = ((empty($_W['shopset']['trade']['closecomment']) ? ''.$this->lang['lang_plugin_pc_core_mobile_order_index_16'].'' : ''.$this->lang['lang_plugin_pc_core_mobile_order_index_17'].''));
						}
					}
					else 
					{
						$status = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_18'].'';
					}
				...
				if ((0 < $row['refundstate']) && !(empty($row['refundid']))) 
				{
					...
					if (!(empty($refund))) 
					{
						$row['statusstr'] = ''.$this->lang['lang_plugin_pc_core_mobile_order_index_19'].'' . $r_type[$refund['rtype']];
					}
				}
				$canrefund = false;
	...
	public function detail() 
	{
		...
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_20'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_21'].''), array('link' => mobileUrl('pc.order'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_22'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_23'].'') );
		$ice_menu_array = array( array('menu_key' => 'order', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_24'].'', 'menu_url' => mobileUrl('pc.order')), array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_order_index_25'].'', 'menu_url' => mobileUrl('pc.order', array('id' => $orderid))) );
		...
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_order_index_26'].'!', '', 'error');
		}
		$merchdata = $this->merchData();
		extract($merchdata);
	...
	public function express() 
	{
		...
		if (empty($order['addressid'])) 
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_order_index_27'].'!');
		}
		if ($order['status'] < 2) 
		{
			$this->message(''.$this->lang['lang_plugin_pc_core_mobile_order_index_28'].'!');
		}
