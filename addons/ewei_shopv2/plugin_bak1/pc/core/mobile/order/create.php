...
class Create_EweiShopV2Page extends PcMobileLoginPage 
{
	...
	public function main() 
	{
		...
		else 
		{
			...
			{
				$followtip = ((empty($goods['followtip']) ? ''.$this->lang['lang_plugin_pc_core_mobile_order_create_0'].'~' : $goods['followtip']));
		...
		$nav_link_list = array( array('link' => mobileUrl('pc'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_create_1'].''), array('link' => mobileUrl('pc.member'), 'title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_create_2'].''), array('title' => ''.$this->lang['lang_plugin_pc_core_mobile_order_create_3'].'') );
		$ice_menu_array = array( array('menu_key' => 'index', 'menu_name' => ''.$this->lang['lang_plugin_pc_core_mobile_order_create_4'].'', 'menu_url' => mobileUrl('pc.order.create')) );
		include $this->template();
	}
	...
	public function submit() 
	{
		...
		{
			show_json(-1, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_5'].'!');
		}
		...
		if (!(empty($_W['shopset']['wap']['open'])) && !(empty($_W['shopset']['wap']['mustbind'])) && empty($member['mobileverify'])) 
		{
			show_json(0, array('message' => ''.$this->lang['lang_plugin_pc_core_mobile_order_create_6'].'', 'url' => mobileUrl('member/bind', NULL, true)));
		}
		...
		if (!(empty($addressid)) && ($dispatchtype == 0)) 
		{
			...
			if (empty($address)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_7'].'');
			}
		}
		...
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_8'].'');
		}
		$allgoods = array();
		$totalprice = 0;
		$goodsprice = 0;
		...
		foreach ($goods as $g ) 
		{
			...
			if (empty($goodsid)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_9'].'');
			}
			...
			{
				show_json(0, $data['title'] . '<br/> '.$this->lang['lang_plugin_pc_core_mobile_order_create_10'].'!');
			}
			$merchid = $data['merchid'];
			$merch_array[$merchid]['goods'][] = $data['goodsid'];
			if (0 < $merchid) 
			...
			$unit = ((empty($data['unit']) ? ''.$this->lang['lang_plugin_pc_core_mobile_order_create_11'].'' : $data['unit']));
			if (0 < $data['minbuy']) 
			{
				if ($goodstotal < $data['minbuy']) 
				{
					show_json(0, $data['title'] . '<br/> ' . $data['minbuy'] . $unit . ''.$this->lang['lang_plugin_pc_core_mobile_order_create_12'].'!');
				}
			}
			if (0 < $data['maxbuy']) 
			{
				...
				{
					show_json(0, $data['title'] . '<br/> '.$this->lang['lang_plugin_pc_core_mobile_order_create_13'].' ' . $data['maxbuy'] . $unit . '!');
				}
			}
			if (0 < $data['usermaxbuy']) 
			{
				...
				{
					show_json(0, $data['title'] . '<br/> '.$this->lang['lang_plugin_pc_core_mobile_order_create_14'].' ' . $data['usermaxbuy'] . $unit . '!');
				}
			}
			if ($data['istime'] == 1) 
			{
				...
				{
					show_json(0, $data['title'] . '<br/> '.$this->lang['lang_plugin_pc_core_mobile_order_create_15'].'!');
				}
				if ($data['timeend'] < time()) 
				{
					show_json(0, $data['title'] . '<br/> '.$this->lang['lang_plugin_pc_core_mobile_order_create_16'].'!');
				}
			}
			...
			if ($data['buylevels'] != '') 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_17'].'<br/>' . $data['title'] . '!');
				}
			}
			if ($data['buygroups'] != '') 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_18'].'<br/>' . $data['title'] . '!');
				}
			}
			if (!(empty($optionid))) 
			{
				...
				if (!(empty($option))) 
				{
					if ($option['stock'] != -1) 
					{
						...
						{
							show_json(-1, $data['title'] . '<br/>' . $option['title'] . ' '.$this->lang['lang_plugin_pc_core_mobile_order_create_19'].'!');
						}
					}
					$data['optionid'] = $optionid;
					$data['optiontitle'] = $option['title'];
			...
			else if ($data['stock'] != -1) 
			{
				if (empty($data['stock'])) 
				{
					show_json(0, $data['title'] . '<br/>'.$this->lang['lang_plugin_pc_core_mobile_order_create_20'].'!');
				}
			}
		...
		if (empty($allgoods)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_pc_core_mobile_order_create_21'].'');
		}
		if ($is_openmerch == 1) 
		{
			foreach ($merch_array as $key => $value ) 
		...
		if (0 < $deductcredit) 
		{
			m('member')->setCredit($openid, 'credit1', -$deductcredit, array('0', $_W['shopset']['shop']['name'] . ''.$this->lang['lang_plugin_pc_core_mobile_order_create_22'].' '.$this->lang['lang_plugin_pc_core_mobile_order_create_23'].': ' . $deductcredit . ' '.$this->lang['lang_plugin_pc_core_mobile_order_create_24'].': ' . $deductmoney . ' '.$this->lang['lang_plugin_pc_core_mobile_order_create_25'].': ' . $ordersn));
		}
		if (empty($virtualid)) 
		{
