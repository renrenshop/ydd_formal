...
class Detail_EweiShopV2Page extends PcMobilePage 
{
	public function main() 
	{
		...
		$goods['unit'] = ((empty($goods['unit']) ? ''.$this->lang['lang_plugin_pc_core_mobile_goods_detail_0'].'' : $goods['unit']));
		...
		$spec_titles = implode(''.$this->lang['lang_plugin_pc_core_mobile_goods_detail_1'].'', $spec_titles);
