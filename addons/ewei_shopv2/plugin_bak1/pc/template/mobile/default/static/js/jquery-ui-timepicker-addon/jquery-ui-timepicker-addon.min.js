(function($) {
	...
	$.extend(Timepicker.prototype, {
		...
		_injectTimePicker: function() {
			...
			if (e.find("div.ui-timepicker-div").length === 0 && t.showTimepicker) {
				...
				for (c = 0, u = this.units.length; c < u; c++) {
					...
					n = t["show" + a] !== null ? t["show" + a] : this.support[s];
				...
				var _ = t.showTimezone !== null ? t.showTimezone : this.support.timezone;
					...
					if (n && t[s + "Grid"] > 0) {
						...
						g.find(".ui_tpicker_" + s + " table").css({
							...
							var t = $(this),
								...
								l = t.data("for");
							if (l === "hour") {
								if (r.indexOf("p") !== -1 && n < 12) {
									n += 12
								} else {
									if (r.indexOf("a") !== -1 && n === 12) {
										n = 0
									}
								}
							}
							i.control.value(i, i[l + "_slider"], s, n);
							i._onTimeChange();
							i._onSelectHandler()
						}).css({
							cursor: "pointer",
		...
		_limitMinMaxDateTime: function(e, t) {
			...
			if ($.datepicker._get(e, "minDateTime") !== null && $.datepicker._get(e, "minDateTime") !== undefined && s) {
				...
				if (e.settings.timeOnly || n.getTime() === s.getTime()) {
						...
						if (this.minute <= this._defaults.minuteMin) {
							...
							if (this.second <= this._defaults.secondMin) {
								...
								if (this.millisec <= this._defaults.millisecMin) {
									...
									this._defaults.microsecMin = a.getMicroseconds()
								} else {
			...
			if ($.datepicker._get(e, "maxDateTime") !== null && $.datepicker._get(e, "maxDateTime") !== undefined && s) {
				...
				if (e.settings.timeOnly || l.getTime() === s.getTime()) {
		...
		_onTimeChange: function() {
			...
			var e = this.hour_slider ? this.control.value(this, this.hour_slider, "hour") : false,
				...
				i = this.second_slider ? this.control.value(this, this.second_slider, "second") : false,
				s = this.millisec_slider ? this.control.value(this, this.millisec_slider, "millisec") : false,
				a = this.microsec_slider ? this.control.value(this, this.microsec_slider, "microsec") : false,
			...
			var u = e !== this.hour || t !== this.minute || i !== this.second || s !== this.millisec || a !== this.microsec || this.ampm.length > 0 && e < 12 !== ($.inArray(this.ampm.toUpperCase(), this.amNames) !== -1) || this.timezone !== null && n !== this.timezone;
			if (u) {
				if (e !== false) {
					this.hour = e
				}
		...
		_updateDateTime: function(e) {
			...
			var t = e.currentYear > 0 ? new Date(e.currentYear, e.currentMonth, e.currentDay) : new Date(e.selectedYear, e.selectedMonth, e.selectedDay),
				...
				n = i !== null && this.timeDefined;
			this.formattedDate = $.datepicker.formatDate(s, i === null ? new Date : i, a);
			...
			} else if (this._defaults.timeOnly !== true && (this._defaults.alwaysSetTime || n)) {
			...
			if (!this._defaults.showTimepicker) {
				...
				if (!this._defaults.timeOnly) {
					if (this._defaults.altFormat) {
						l = $.datepicker.formatDate(this._defaults.altFormat, i === null ? new Date : i, a)
					} else {
				...
				if (this._defaults.altTimeFormat) {
					l += $.datepicker.formatTime(this._defaults.altTimeFormat, this, this._defaults) + c
				} else {
		...
		_controls: {
			slider: {
				...
				options: function(e, t, i, s, a) {
					...
					if (typeof s === "string" && a !== undefined) {
						return t.slider(s, a)
					}
					return t.slider(s)
				},
			...
			select: {
				create: function(e, t, i, s, a, n, r) {
					var l = '<select class="ui-timepicker-select" data-unit="' + i + '" data-min="' + a + '" data-max="' + n + '" data-step="' + r + '">',
						o = e._defaults.pickerTimeFormat || e._defaults.timeFormat;
					for (var c = a; c <= n; c += r) {
						l += '<option value="' + c + '"' + (c === s ? " selected" : "") + ">";
						if (i === "hour") {
							l += $.datepicker.formatTime($.trim(o.replace(/[^ht ]/gi, "")), {
								hour: c
							}, e._defaults)
						} else if (i === "millisec" || i === "microsec" || c >= 10) {
							l += c
						} else {
							l += "0" + c.toString()
						}
	...
	$.datepicker.parseTime = function(e, t, i) {
		...
		var n = function(e, t, i) {
				...
				var n = "^" + e.toString().replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(e) {
					var t = e.length;
				...
				if (o) {
					if (r.t !== -1) {
						if (o[r.t] === undefined || o[r.t].length === 0) {
							...
							l = $.inArray(o[r.t].toUpperCase(), i.amNames) !== -1 ? "AM" : "PM";
	...
	$.datepicker.formatTime = function(e, t, i) {
		...
		s = s.replace(/(?:HH?|hh?|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(e) {
			...
			case "z":
				return $.timepicker.timezoneOffsetString(t.timezone === null ? i.timezone : t.timezone, false);
			case "Z":
				return $.timepicker.timezoneOffsetString(t.timezone === null ? i.timezone : t.timezone, true);
			case "T":
		...
		if (i) {
			if ($.datepicker._get(t, "constrainInput")) {
				var s = i.support.ampm,
					a = i._defaults.showTimezone !== null ? i._defaults.showTimezone : i.support.timezone,
					n = $.datepicker._possibleChars($.datepicker._get(t, "dateFormat")),
					r = i._defaults.timeFormat.toString().replace(/[hms]/g, "").replace(/TT/g, s ? "APM" : "").replace(/Tt/g, s ? "AaPpMm" : "").replace(/tT/g, s ? "AaPpMm" : "").replace(/T/g, s ? "AP" : "").replace(/tt/g, s ? "apm" : "").replace(/t/g, s ? "ap" : "") + " " + i._defaults.separator + i._defaults.timeSuffix + (a ? i._defaults.timezoneList.join("") : "") + i._defaults.amNames.join("") + i._defaults.pmNames.join("") + n,
					l = String.fromCharCode(e.charCode === undefined ? e.keyCode : e.charCode);
		...
		if (t) {
			...
			if (i) {
				var s = t._defaults.altFormat || t._defaults.dateFormat,
					...
					c = t._defaults.altTimeFormat !== null ? t._defaults.altTimeFormat : t._defaults.timeFormat;
				r += $.datepicker.formatTime(c, t, t._defaults) + o;
				if (!t._defaults.timeOnly && !t._defaults.altFieldTimeOnly && a !== null) {
					if (t._defaults.altFormat) {
						r = $.datepicker.formatDate(t._defaults.altFormat, a, n) + l + r
					} else {
	...
	$.timepicker.timezoneOffsetNumber = function(e) {
		...
		return (t.substr(0, 1) === "-" ? -1 : 1) * (parseInt(t.substr(1, 2), 10) * 60 + parseInt(t.substr(3, 2), 10))
	};
