...
class ExhelperModel extends PluginModel 
{
	...
	public function setDefault($id, $type) 
	{
		...
		if (!empty($item)) 
		{
			...
			if ($type == 1) 
			{
				plog('exhelper.temp.express.setdefault', ''.$this->lang['lang_plugin_exhelper_core_model_0'].' ID: ' . $item['id'] . ''.$this->lang['lang_plugin_exhelper_core_model_1'].' '.$this->lang['lang_plugin_exhelper_core_model_2'].': ' . $item['expressname'] . ' ');
				return NULL;
			}
			if ($type == 2) 
			{
				plog('exhelper.temp.invoice.setdefault', ''.$this->lang['lang_plugin_exhelper_core_model_3'].' ID: ' . $item['id'] . ''.$this->lang['lang_plugin_exhelper_core_model_4'].' '.$this->lang['lang_plugin_exhelper_core_model_5'].': ' . $item['expressname'] . ' ');
			}
		}
	}
	public function tempDelete($id, $type) 
	{
		...
		foreach ($items as $item ) 
		{
			...
			if ($type == 1) 
			{
				plog('exhelper.temp.express.delete', ''.$this->lang['lang_plugin_exhelper_core_model_6'].' '.$this->lang['lang_plugin_exhelper_core_model_7'].' '.$this->lang['lang_plugin_exhelper_core_model_8'].' ID: ' . $item['id'] . ''.$this->lang['lang_plugin_exhelper_core_model_9'].' '.$this->lang['lang_plugin_exhelper_core_model_10'].': ' . $item['expressname'] . ' ');
			}
			else if ($type == 2) 
			{
				plog('exhelper.temp.invoice.delete', ''.$this->lang['lang_plugin_exhelper_core_model_11'].' '.$this->lang['lang_plugin_exhelper_core_model_12'].' '.$this->lang['lang_plugin_exhelper_core_model_13'].' ID: ' . $item['id'] . ''.$this->lang['lang_plugin_exhelper_core_model_14'].' '.$this->lang['lang_plugin_exhelper_core_model_15'].': ' . $item['expressname'] . ' ');
			}
		}
	}
