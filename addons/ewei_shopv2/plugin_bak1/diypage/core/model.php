...
class DiypageModel extends PluginModel 
{
				...
				foreach ($page['data']['items'] as $itemid => &$item ) 
				{
					...
					else if ($item['id'] == 'diymod') 
					{
						if (!(empty($item['params']['modid']))) 
						{
							...
							{
								$item['params']['modname'] = ''.$this->lang['lang_plugin_diypage_core_model_0'].'';
							}
						}
					}
					...
					else 
					{
						...
						else if ($item['id'] == 'detail_tab') 
						{
							...
							{
								$item['params']['goodstext'] = ''.$this->lang['lang_plugin_diypage_core_model_1'].'';
							}
							if (empty($item['params']['detailtext'])) 
							{
								$item['params']['detailtext'] = ''.$this->lang['lang_plugin_diypage_core_model_2'].'';
							}
						}
						else if ($item['id'] == 'detail_sale') 
						{
							if (!(empty($item['data'])) && is_array($item['data'])) 
							{
								...
								if (!($hasyushou)) 
								{
									...
									$item['data'][$childid] = array('name' => ''.$this->lang['lang_plugin_diypage_core_model_3'].'', 'type' => 'yushou');
									unset($childid);
								}
								if (!($hascoupon)) 
								{
									$childid = 'C' . time() . rand(100, 999);
									$item['data'][$childid] = array('name' => ''.$this->lang['lang_plugin_diypage_core_model_4'].'', 'type' => 'coupon');
									unset($childid);
								}
								if (!($haszengpin)) 
								{
									$childid = 'C' . time() . rand(100, 999);
									$item['data'][$childid] = array('name' => ''.$this->lang['lang_plugin_diypage_core_model_5'].'', 'type' => 'zengpin');
									unset($childid);
								}
								if (!($hasfullback)) 
								{
									$childid = 'C' . time() . rand(100, 999);
									$item['data'][$childid] = array('name' => ''.$this->lang['lang_plugin_diypage_core_model_6'].'', 'type' => 'fullback');
									unset($childid);
								}
							}
						}
									...
									foreach ($item['data'] as $childid => &$child ) 
									{
										...
										else 
										{
											...
											if ($coupon['coupontype'] == 0) 
											{
												if (0 < $coupon['enough']) 
												{
													$child['desc'] = ''.$this->lang['lang_plugin_diypage_core_model_7'].'' . (double) $coupon['enough'] . ''.$this->lang['lang_plugin_diypage_core_model_8'].'';
												}
												else 
												{
													$child['desc'] = ''.$this->lang['lang_plugin_diypage_core_model_9'].'';
												}
											}
											else if ($coupon['coupontype'] == 1) 
											{
												if (0 < $coupon['enough']) 
												{
													$child['desc'] = ''.$this->lang['lang_plugin_diypage_core_model_10'].'' . (double) $coupon['enough'] . ''.$this->lang['lang_plugin_diypage_core_model_11'].'';
												}
												else 
												{
													$child['desc'] = ''.$this->lang['lang_plugin_diypage_core_model_12'].'';
												}
											}
											if ($coupon['backtype'] == 0) 
											{
												$child['price'] = ''.$this->lang['lang_plugin_diypage_core_model_13'].'' . (double) $coupon['deduct'];
											}
											else if ($coupon['backtype'] == 1) 
											{
												$d['price'] = (double) $coupon['discount'] . ''.$this->lang['lang_plugin_diypage_core_model_14'].' ';
											}
											else if ($coupon['backtype'] == 2) 
											{
												...
												$child['price'] = ''.$this->lang['lang_plugin_diypage_core_model_15'].'' . $values;
											}
										}
									}
									unset($child);
			...
			if ($mobile && !(empty($page['data']['items'])) && is_array($page['data']['items'])) 
			{
				foreach ($page['data']['items'] as $itemid => &$item ) 
				{
					...
					else if ($item['id'] == 'memberc') 
					{
						...
						$item['params']['upmember'] = ((empty($member['up']) ? ''.$this->lang['lang_plugin_diypage_core_model_16'].'' : $member['up']['nickname']));
					}
	...
	public function savePage($id, $data, $update = true) 
	{
		...
		if (!(empty($keyword)) && $update) 
		{
			...
			if (!(empty($result))) 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_diypage_core_model_17'].'');
				}
			}
			else if (!(empty($result))) 
			{
				show_json(0, ''.$this->lang['lang_plugin_diypage_core_model_18'].'');
			}
		}
		...
		if ($update) 
		{
			...
			if ($savetype == 'update') 
			{
				if ($item['type'] == 1) 
				{
					plog('diypage.page.diy.edit', ''.$this->lang['lang_plugin_diypage_core_model_19'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_20'].':' . $item['name'] . '  '.$this->lang['lang_plugin_diypage_core_model_21'].': ' . $item['keyword']);
				}
				else if ((1 < $item['type']) && ($item['type'] < 99)) 
				{
					plog('diypage.page.sys.edit', ''.$this->lang['lang_plugin_diypage_core_model_22'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_23'].':' . $item['name'] . '  '.$this->lang['lang_plugin_diypage_core_model_24'].': ' . $item['keyword']);
				}
				else if ($item['type'] == 99) 
				{
					plog('diypage.page.mod.edit', ''.$this->lang['lang_plugin_diypage_core_model_25'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_26'].':' . $item['name'] . '  '.$this->lang['lang_plugin_diypage_core_model_27'].': ' . $item['keyword']);
				}
			}
			else if ($savetype == 'insert') 
			{
				if ($item['type'] == 1) 
				{
					plog('diypage.page.diy.add', ''.$this->lang['lang_plugin_diypage_core_model_28'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_29'].':' . $item['name'] . '  '.$this->lang['lang_plugin_diypage_core_model_30'].': ' . $item['keyword']);
				}
				else if ((1 < $item['type']) && ($item['type'] < 99)) 
				{
					plog('diypage.page.sys.add', ''.$this->lang['lang_plugin_diypage_core_model_31'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_32'].':' . $item['name'] . '  '.$this->lang['lang_plugin_diypage_core_model_33'].': ' . $item['keyword']);
				}
				else if ($item['type'] == 99) 
				{
					plog('diypage.page.mod.add', ''.$this->lang['lang_plugin_diypage_core_model_34'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_35'].':' . $item['name'] . '  '.$this->lang['lang_plugin_diypage_core_model_36'].': ' . $item['keyword']);
				}
			}
			$result = array('id' => $id);
			if ($savetype == 'insert') 
	...
	public function delPage($id) 
	{
		...
		foreach ($items as $item ) 
		{
			...
			if ($item['type'] == 1) 
			{
				plog('diypage.page.diy.delete', ''.$this->lang['lang_plugin_diypage_core_model_37'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_38'].':' . $item['name']);
			}
			else if ((1 < $item['type']) && ($item['type'] < 99)) 
			{
				plog('diypage.page.sys.delete', ''.$this->lang['lang_plugin_diypage_core_model_39'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_40'].':' . $item['name']);
			}
			if ($item['type'] == 99) 
			{
				plog('diypage.page.mod.delete', ''.$this->lang['lang_plugin_diypage_core_model_41'].' id: ' . $item['id'] . '  '.$this->lang['lang_plugin_diypage_core_model_42'].':' . $item['name']);
			}
	...
	public function saveTemp($temp) 
	{
		...
		{
			show_json(0, ''.$this->lang['lang_plugin_diypage_core_model_43'].'');
		}
		...
		if ($temp['type'] == 1) 
		{
			plog('diypage.page.diy.savetemp', ''.$this->lang['lang_plugin_diypage_core_model_44'].' '.$this->lang['lang_plugin_diypage_core_model_45'].':' . $temp['name']);
		}
		else if ((1 < $temp['type']) && ($temp['type'] < 99)) 
		{
			plog('diypage.page.sys.savetemp', ''.$this->lang['lang_plugin_diypage_core_model_46'].' '.$this->lang['lang_plugin_diypage_core_model_47'].':' . $temp['name']);
		}
		show_json(1);
	}
	...
	{
		$pagetype = array( 1 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_48'].'', 'pagetype' => 'diy', 'class' => ''), 2 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_49'].'', 'pagetype' => 'sys', 'class' => 'success'), 3 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_50'].'', 'pagetype' => 'sys', 'class' => 'primary'), 4 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_51'].'', 'pagetype' => 'plu', 'class' => 'warning'), 5 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_52'].'', 'pagetype' => 'sys', 'class' => 'danger'), 6 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_53'].'', 'pagetype' => 'plu', 'class' => 'info'), 7 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_54'].'', 'pagetype' => 'plu', 'class' => 'danger'), 8 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_55'].'', 'pagetype' => 'plu', 'class' => 'success'), 9 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_56'].'', 'pagetype' => 'sys', 'class' => 'warning'), 99 => array('name' => ''.$this->lang['lang_plugin_diypage_core_model_57'].'', 'pagetype' => 'mod', 'class' => '') );
		if (!(empty($type))) 
		{
	...
	public function calculate($str = NULL, $member = false) 
	{
		...
		if (strexists($str, 'memberc') && p('commission')) 
		{
			...
			if (!(empty($member))) 
			{
				...
				$member['commissionlevelname'] = ((empty($member['commissionlevel']) ? ((empty($commissionset['levelname']) ? ''.$this->lang['lang_plugin_diypage_core_model_58'].'' : $commissionset['levelname'])) : $member['commissionlevel']['levelname']));
			}
		}
		else 
		{
	...
	public function judge($type = NULL, $str = NULL) 
	{
		...
		if ($type == 'tiptext') 
		{
			...
			{
				return ''.$this->lang['lang_plugin_diypage_core_model_59'].'';
			}
			if (strexists($str, 'r=commission.down')) 
			{
				return ''.$this->lang['lang_plugin_diypage_core_model_60'].'';
			}
		}
	}
	...
	public function getDanmuTime($item) 
	{
		...
		{
			return ''.$this->lang['lang_plugin_diypage_core_model_61'].'';
		}
		if (is_numeric($item)) 
		{
			if ($item < 60) 
			{
				return $item . ''.$this->lang['lang_plugin_diypage_core_model_62'].'';
			}
			$item = round($item / 60);
			if ($item < 60) 
			{
				return $item . ''.$this->lang['lang_plugin_diypage_core_model_63'].'';
			}
			$item = round($item / 60);
			if ($item < 24) 
			{
				return $item . ''.$this->lang['lang_plugin_diypage_core_model_64'].'';
			}
			$item = round($item / 24);
			return $item . ''.$this->lang['lang_plugin_diypage_core_model_65'].'';
		}
		if (strexists($item, ''.$this->lang['lang_plugin_diypage_core_model_66'].'') || strexists($item, ''.$this->lang['lang_plugin_diypage_core_model_67'].'') || strexists($item, ''.$this->lang['lang_plugin_diypage_core_model_68'].'')) 
		{
			return $item;
		}
		$item = intval($item);
		if ($item < 60) 
		{
			return $item . ''.$this->lang['lang_plugin_diypage_core_model_69'].'';
		}
		return round($item / 60) . ''.$this->lang['lang_plugin_diypage_core_model_70'].'';
	}
	public function detailPage($pageid = 0) 
	{
		...
		{
			$btnlike = array('iconclass' => 'icon-like', 'icontext' => ''.$this->lang['lang_plugin_diypage_core_model_71'].'', 'type' => 'like');
			$btnshop = array('iconclass' => 'icon-shop', 'icontext' => ''.$this->lang['lang_plugin_diypage_core_model_72'].'', 'type' => 'shop');
			$btncart = array('iconclass' => 'icon-cart', 'icontext' => ''.$this->lang['lang_plugin_diypage_core_model_73'].'', 'linkurl' => mobileUrl('member/cart'), 'type' => 'cart');
			if (intval($detail_navbar['params']['hidelike']) < 1) 
			{
				...
				{
					$navbar[] = array('iconclass' => (empty($detail_navbar['params']['likeiconclass']) ? 'icon-like' : $detail_navbar['params']['likeiconclass']), 'icontext' => (empty($detail_navbar['params']['liketext']) ? ''.$this->lang['lang_plugin_diypage_core_model_74'].'' : $detail_navbar['params']['liketext']), 'linkurl' => $detail_navbar['params']['likelink']);
				}
			}
			if (intval($detail_navbar['params']['hideshop']) < 1) 
			{
				...
				{
					$navbar[] = array('iconclass' => (empty($detail_navbar['params']['shopiconclass']) ? 'icon-shop' : $detail_navbar['params']['shopiconclass']), 'icontext' => (empty($detail_navbar['params']['shoptext']) ? ''.$this->lang['lang_plugin_diypage_core_model_75'].'' : $detail_navbar['params']['shoptext']), 'linkurl' => $detail_navbar['params']['shoplink']);
				}
			}
			if (intval($detail_navbar['params']['hidecart']) < 1) 
			{
				...
				{
					$navbar[] = array('iconclass' => (empty($detail_navbar['params']['carticonclass']) ? 'icon-cart' : $detail_navbar['params']['carticonclass']), 'icontext' => (empty($detail_navbar['params']['carttext']) ? ''.$this->lang['lang_plugin_diypage_core_model_76'].'' : $detail_navbar['params']['carttext']), 'linkurl' => $detail_navbar['params']['cartlink']);
				}
			}
		}
