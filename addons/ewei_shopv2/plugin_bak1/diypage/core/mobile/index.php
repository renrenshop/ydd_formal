...
class Index_EweiShopV2Page extends PluginMobilePage 
{
	public function main() 
	{
		...
		if (empty($id)) 
		{
			$this->message(''.$this->lang['lang_plugin_diypage_core_mobile_index_0'].'', mobileUrl());
		}
		$page = $this->model->getPage($id, true);
		if (empty($page)) 
		{
			$this->message(''.$this->lang['lang_plugin_diypage_core_mobile_index_1'].'', mobileUrl());
		}
		...
		if ($page['type'] == 4) 
		{
			...
			{
				$this->message(''.$this->lang['lang_plugin_diypage_core_mobile_index_2'].'', mobileUrl());
			}
		...
		if (!(empty($page['data']['page']['visit'])) && ($page['data']['page']['type'] == 1)) 
		{
			...
			$title = ((!(empty($page['data']['page']['novisit']['title'])) ? $page['data']['page']['novisit']['title'] : ''.$this->lang['lang_plugin_diypage_core_mobile_index_3'].'!'));
	...
	public function getmerch() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			{
				show_json(0, ''.$this->lang['lang_plugin_diypage_core_mobile_index_4'].'');
			}
			...
			if ($item['params']['merchdata'] == 0) 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_diypage_core_mobile_index_5'].'');
				}
			...
			else if ($item['params']['merchdata'] == 1) 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_diypage_core_mobile_index_6'].'cateid'.$this->lang['lang_plugin_diypage_core_mobile_index_7'].'');
				}
			...
			else if ($item['params']['merchdata'] == 2) 
			{
				...
				{
					show_json(0, ''.$this->lang['lang_plugin_diypage_core_mobile_index_8'].'groupid'.$this->lang['lang_plugin_diypage_core_mobile_index_9'].'');
				}
			...
			if (empty($merchs)) 
			{
				show_json(0, ''.$this->lang['lang_plugin_diypage_core_mobile_index_10'].'');
			}
		...
		show_json(0, ''.$this->lang['lang_plugin_diypage_core_mobile_index_11'].'');
	}
