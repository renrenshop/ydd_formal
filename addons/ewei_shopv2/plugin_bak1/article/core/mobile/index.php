...
class Index_EweiShopV2Page extends PluginMobilePage 
{
	public function main() 
	{
		...
		if (empty($aid)) 
		{
			exit('url'.$this->lang['lang_plugin_article_core_mobile_index_0'].'');
		}
		...
		if (empty($article)) 
		{
			$this->message(''.$this->lang['lang_plugin_article_core_mobile_index_1'].'!', mobileUrl('article/list'), 'error');
		}
		...
		if (!(empty($article['article_visit']))) 
		{
			...
			$visit_text = ((!(empty($article['article_visit_tip']['text'])) ? $article['article_visit_tip']['text'] : ''.$this->lang['lang_plugin_article_core_mobile_index_2'].'!'));
	...
	public function getcontent() 
	{
		...
		if (empty($aid)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_article_core_mobile_index_3'].'');
		}
		...
		if (empty($article)) 
		{
			show_json(0, ''.$this->lang['lang_plugin_article_core_mobile_index_4'].'');
		}
