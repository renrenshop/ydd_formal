...
if (!(class_exists('CommissionModel'))) 
{
	class CommissionModel extends PluginModel 
	{
		public function getSet($uniacid = 0) 
		{
			...
			$set = array();
			$set['texts'] = array(
			    'agent' => (empty($set['texts']['agent']) ? ''.$this->lang['lang_plugin_commission_core_model_0'].'' : $set['texts']['agent']),
                'shop' => (empty($set['texts']['shop']) ? ''.$this->lang['lang_plugin_commission_core_model_1'].'' : $set['texts']['shop']),
                'myshop' => (empty($set['texts']['myshop']) ? ''.$this->lang['lang_plugin_commission_core_model_2'].'' : $set['texts']['myshop']),
                'center' => (empty($set['texts']['center']) ? ''.$this->lang['lang_plugin_commission_core_model_3'].'' : $set['texts']['center']),
                'become' => (empty($set['texts']['become']) ? ''.$this->lang['lang_plugin_commission_core_model_4'].'' : $set['texts']['become']), 'withdraw' => (empty($set['texts']['withdraw']) ? ''.$this->lang['lang_plugin_commission_core_model_5'].'' : $set['texts']['withdraw']), 'commission' => (empty($set['texts']['commission']) ? ''.$this->lang['lang_plugin_commission_core_model_6'].'' : $set['texts']['commission']), 'commission1' => (empty($set['texts']['commission1']) ? ''.$this->lang['lang_plugin_commission_core_model_7'].'' : $set['texts']['commission1']), 'commission_total' => (empty($set['texts']['commission_total']) ? ''.$this->lang['lang_plugin_commission_core_model_8'].'' : $set['texts']['commission_total']), 'commission_ok' => (empty($set['texts']['commission_ok']) ? ''.$this->lang['lang_plugin_commission_core_model_9'].'' : $set['texts']['commission_ok']), 'commission_apply' => (empty($set['texts']['commission_apply']) ? ''.$this->lang['lang_plugin_commission_core_model_10'].'' : $set['texts']['commission_apply']), 'commission_check' => (empty($set['texts']['commission_check']) ? ''.$this->lang['lang_plugin_commission_core_model_11'].'' : $set['texts']['commission_check']), 'commission_lock' => (empty($set['texts']['commission_lock']) ? ''.$this->lang['lang_plugin_commission_core_model_12'].'' : $set['texts']['commission_lock']), 'commission_detail' => (empty($set['texts']['commission_detail']) ? ''.$this->lang['lang_plugin_commission_core_model_13'].'' : (($set['texts']['commission_detail'] == ''.$this->lang['lang_plugin_commission_core_model_14'].'' ? ''.$this->lang['lang_plugin_commission_core_model_15'].'' : $set['texts']['commission_detail']))), 'commission_pay' => (empty($set['texts']['commission_pay']) ? ''.$this->lang['lang_plugin_commission_core_model_16'].'' : $set['texts']['commission_pay']), 'commission_wait' => (empty($set['texts']['commission_wait']) ? ''.$this->lang['lang_plugin_commission_core_model_17'].'' : $set['texts']['commission_wait']), 'commission_fail' => (empty($set['texts']['commission_fail']) ? ''.$this->lang['lang_plugin_commission_core_model_18'].'' : $set['texts']['commission_fail']), 'commission_charge' => (empty($set['texts']['commission_charge']) ? ''.$this->lang['lang_plugin_commission_core_model_19'].'' : $set['texts']['commission_charge']), 'order' => (empty($set['texts']['order']) ? ''.$this->lang['lang_plugin_commission_core_model_20'].'' : $set['texts']['order']), 'c1' => (empty($set['texts']['c1']) ? ''.$this->lang['lang_plugin_commission_core_model_21'].'' : $set['texts']['c1']), 'c2' => (empty($set['texts']['c2']) ? ''.$this->lang['lang_plugin_commission_core_model_22'].'' : $set['texts']['c2']), 'c3' => (empty($set['texts']['c3']) ? ''.$this->lang['lang_plugin_commission_core_model_23'].'' : $set['texts']['c3']), 'mydown' => (empty($set['texts']['mydown']) ? ''.$this->lang['lang_plugin_commission_core_model_24'].'' : $set['texts']['mydown']), 'down' => (empty($set['texts']['down']) ? ''.$this->lang['lang_plugin_commission_core_model_25'].'' : $set['texts']['down']), 'up' => (empty($set['texts']['up']) ? ''.$this->lang['lang_plugin_commission_core_model_26'].'' : $set['texts']['up']), 'yuan' => (empty($set['texts']['yuan']) ? ''.$this->lang['lang_plugin_commission_core_model_27'].'' : $set['texts']['yuan']));
			return $set;
		}
		...
		public function createGoodsImage($goods) 
		{
			...
			if (!(is_file($path . $file))) 
			{
				...
				$str1 = ''.$this->lang['lang_plugin_commission_core_model_28'].'';
				imagettftext($target, 20, 0, 150, 70, $bc, $font, $str1);
				imagettftext($target, 20, 0, 210, 70, $cc, $font, $userinfo['nickname']);
				$str2 = ''.$this->lang['lang_plugin_commission_core_model_29'].'';
				...
				$width = $box[4] - $box[6];
				$str4 = ''.$this->lang['lang_plugin_commission_core_model_30'].'';
				...
				$str6 = ''.$this->lang['lang_plugin_commission_core_model_31'].'' . number_format($goods['marketprice'], 2);
				imagettftext($target, 25, 0, 25, 780, $yc, $font, $str6);
				$box = imagettfbbox(26, 0, $font, $str6);
				$width = $box[4] - $box[6];
				if (0 < $goods['productprice']) 
				{
					$str7 = ''.$this->lang['lang_plugin_commission_core_model_32'].'' . number_format($goods['productprice'], 2);
		...
		public function createShopImage() 
		{
			...
			if (!(is_file($path . $file))) 
			{
				...
				imagecopyresized($target, $qrcode, 50, 835, 0, 0, 250, 250, $w, $h);
				imagedestroy($qrcode);
				$str1 = ''.$this->lang['lang_plugin_commission_core_model_33'].'';
				imagettftext($target, 20, 0, 150, 70, $bc, $font, $str1);
				imagettftext($target, 20, 0, 210, 70, $cc, $font, $userinfo['nickname']);
				$str2 = ''.$this->lang['lang_plugin_commission_core_model_34'].'';
				imagettftext($target, 20, 0, 150, 105, $bc, $font, $str2);
				$str3 = $shop_set['name'];
				imagettftext($target, 20, 0, 240, 105, $cc, $font, $str3);
				$box = imagettfbbox(20, 0, $font, $str3);
				$width = $box[4] - $box[6];
				$str4 = ''.$this->lang['lang_plugin_commission_core_model_35'].'';
				imagettftext($target, 20, 0, 240 + $width + 10, 105, $bc, $font, $str4);
				imagejpeg($target, $path . $file);
				imagedestroy($target);
			}
			...
			if (!(empty($member['agentid']))) 
			{
				...
				if (!(empty($parent)) && ($parent['isagent'] == 1) && ($parent['status'] == 1)) 
				{
					...
					foreach ($order_goods as $og ) 
					{
						...
						{
							$goods .= ' '.$this->lang['lang_plugin_commission_core_model_36'].': ' . $og['optiontitle'];
						}
						$goods .= ' '.$this->lang['lang_plugin_commission_core_model_37'].': ' . ($og['realprice'] / $og['total']) . ' '.$this->lang['lang_plugin_commission_core_model_38'].': ' . $og['total'] . ' '.$this->lang['lang_plugin_commission_core_model_39'].': ' . $og['realprice'] . '); ';
			...
			if (!(empty($member['agentid']))) 
			{
				...
				if (!(empty($parent)) && ($parent['isagent'] == 1) && ($parent['status'] == 1)) 
				{
					...
					foreach ($order_goods as $og ) 
					{
						...
						if (!(empty($og['optiontitle']))) 
						{
							$goods .= ' '.$this->lang['lang_plugin_commission_core_model_40'].': ' . $og['optiontitle'];
						}
						$goods .= ' '.$this->lang['lang_plugin_commission_core_model_41'].': ' . ($og['realprice'] / $og['total']) . ' '.$this->lang['lang_plugin_commission_core_model_42'].': ' . $og['total'] . ' '.$this->lang['lang_plugin_commission_core_model_43'].': ' . $og['realprice'] . '); ';
						$commissions = iunserializer($og['commissions']);
						$commission_total1 += ((isset($commissions['level1']) ? floatval($commissions['level1']) : 0));
						$commission_total2 += ((isset($commissions['level2']) ? floatval($commissions['level2']) : 0));
						$commission_total3 += ((isset($commissions['level3']) ? floatval($commissions['level3']) : 0));
		...
		public function getShop($m) 
		{
			...
			if (empty($shop)) 
			{
				$shop = array('name' => $member['nickname'] . ''.$this->lang['lang_plugin_commission_core_model_44'].'' . $thisset['texts']['shop'], 'logo' => $member['avatar'], 'desc' => $desc, 'img' => tomedia($set['img']));
			}
			else 
			{
				if (empty($shop['name'])) 
				{
					$shop['name'] = $member['nickname'] . ''.$this->lang['lang_plugin_commission_core_model_45'].'' . $thisset['texts']['shop'];
				}
				if (empty($shop['logo'])) 
				{
		...
		public function getLevels($all = true, $default = false) 
		{
			...
			if ($default) 
			{
				$default = array('id' => '0', 'levelname' => (empty($_S['commission']['levelname']) ? ''.$this->lang['lang_plugin_commission_core_model_46'].'' : $_S['commission']['levelname']), 'commission1' => $_S['commission']['commission1'], 'commission2' => $_S['commission']['commission2'], 'commission3' => $_S['commission']['commission3'], 'withdraw' => (double) $_S['commission']['withdraw_default'], 'repurchase' => (double) $_S['commission']['repurchase_default']);
		...
		public function upgradeLevelByOrder($openid) 
		{
			...
			if (($leveltype == 4) || ($leveltype == 5)) 
			{
				...
				{
					$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_commission_core_model_47'].'' : $set['levelname']), 'commission1' => $set['commission1'], 'commission2' => $set['commission2'], 'commission3' => $set['commission3']);
				}
			...
			if ((0 <= $leveltype) && ($leveltype <= 3)) 
			{
				...
				foreach ($agents as $agent ) 
				{
					...
					if (empty($oldlevel['id'])) 
					{
						$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_commission_core_model_48'].'' : $set['levelname']), 'commission1' => $set['commission1'], 'commission2' => $set['commission2'], 'commission3' => $set['commission3']);
					}
					if ($leveltype == 0) 
					{
		...
		public function upgradeLevelByAgent($openid) 
		{
			...
			if (($leveltype == 6) || ($leveltype == 8)) 
			{
				...
				foreach ($agents as $agent ) 
				{
					...
					if (empty($oldlevel['id'])) 
					{
						$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_commission_core_model_49'].'' : $set['levelname']), 'commission1' => $set['commission1'], 'commission2' => $set['commission2'], 'commission3' => $set['commission3']);
					}
					if ($leveltype == 6) 
					{
			...
			if (empty($oldlevel['id'])) 
			{
				$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_commission_core_model_50'].'' : $set['levelname']), 'commission1' => $set['commission1'], 'commission2' => $set['commission2'], 'commission3' => $set['commission3']);
			}
			if ($leveltype == 7) 
			{
		...
		public function upgradeLevelByCommissionOK($openid) 
		{
			...
			if (empty($oldlevel['id'])) 
			{
				$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_commission_core_model_51'].'' : $set['levelname']), 'commission1' => $set['commission1'], 'commission2' => $set['commission2'], 'commission3' => $set['commission3']);
			}
		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			if (($message_type == TM_COMMISSION_AGENT_NEW) && empty($usernotice['commission_agent_new'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_52'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_53'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_54'].']', date('Y-m-d H:i:s', $data['childtime']), $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_agent_newtitle'])) ? $tm['commission_agent_newtitle'] : ''.$this->lang['lang_plugin_commission_core_model_55'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
			...
			if (($message_type == TM_COMMISSION_ORDER_PAY) && empty($usernotice['commission_order_pay'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_56'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_57'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_58'].']', date('Y-m-d H:i:s', $data['paytime']), $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_59'].']', $data['ordersn'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_60'].']', $data['price'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_61'].']', $data['goods'], $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_order_paytitle'])) ? $tm['commission_order_paytitle'] : ''.$this->lang['lang_plugin_commission_core_model_62'].'')), 'keyword2' => array('value' => $message) );
			...
			if (($message_type == TM_COMMISSION_ORDER_FINISH) && empty($usernotice['commission_order_finish'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_63'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_64'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_65'].']', date('Y-m-d H:i:s', $data['finishtime']), $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_66'].']', $data['ordersn'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_67'].']', $data['price'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_68'].']', $data['goods'], $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_order_finishtitle'])) ? $tm['commission_order_finishtitle'] : ''.$this->lang['lang_plugin_commission_core_model_69'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
			...
			if (($message_type == TM_COMMISSION_APPLY) && empty($usernotice['commission_apply'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_70'].']', $member['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_71'].']', date('Y-m-d H:i:s', time()), $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_72'].']', $data['commission'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_73'].']', $data['type'], $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_applytitle'])) ? $tm['commission_applytitle'] : ''.$this->lang['lang_plugin_commission_core_model_74'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
			...
			if (($message_type == TM_COMMISSION_CHECK) && empty($usernotice['commission_check'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_75'].']', $member['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_76'].']', date('Y-m-d H:i:s', time()), $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_77'].']', $data['commission'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_78'].']', $data['type'], $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_checktitle'])) ? $tm['commission_checktitle'] : ''.$this->lang['lang_plugin_commission_core_model_79'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
			...
			if (($message_type == TM_COMMISSION_PAY) && empty($usernotice['commission_pay'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_80'].']', $member['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_81'].']', date('Y-m-d H:i:s', time()), $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_82'].']', $data['commission'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_83'].']', $data['type'], $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_paytitle'])) ? $tm['commission_paytitle'] : ''.$this->lang['lang_plugin_commission_core_model_84'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
			...
			if (($message_type == TM_COMMISSION_UPGRADE) && empty($usernotice['commission_upgrade'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_85'].']', $member['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_86'].']', date('Y-m-d H:i:s', time()), $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_87'].']', $data['oldlevel']['levelname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_88'].']', $data['oldlevel']['commission1'] . '%', $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_89'].']', $data['oldlevel']['commission2'] . '%', $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_90'].']', $data['oldlevel']['commission3'] . '%', $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_91'].']', $data['newlevel']['levelname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_92'].']', $data['newlevel']['commission1'] . '%', $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_93'].']', $data['newlevel']['commission2'] . '%', $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_94'].']', $data['newlevel']['commission3'] . '%', $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_upgradetitle'])) ? $tm['commission_upgradetitle'] : ''.$this->lang['lang_plugin_commission_core_model_95'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
			...
			if (($message_type == TM_COMMISSION_BECOME) && empty($usernotice['commission_become'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_96'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_commission_core_model_97'].']', date('Y-m-d H:i:s', $data['agenttime']), $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['commission_becometitle'])) ? $tm['commission_becometitle'] : ''.$this->lang['lang_plugin_commission_core_model_98'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
		...
		protected function sendMore($touser, $tm, $tag, $msg, $datas) 
		{
			...
			$set = $this->getSet();
			$msgbk = $msg;
			$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_99'].']', $set['texts']['c1'], $msgbk['keyword2']['value']);
			$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_100'].']', $set['texts']['down'], $msgbk['keyword2']['value']);
			if (($tag == 'commission_order_finish') || ($tag == 'commission_order_pay')) 
			{
				if ($datas['isagent']) 
				{
					$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_101'].']', $datas['commission2'], $msgbk['keyword2']['value']);
				}
				else 
				{
					$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_102'].']', $datas['commission1'], $msgbk['keyword2']['value']);
				}
			}
			...
			foreach ($res as $key => $value ) 
			{
				...
				if ($key == 0) 
				{
					$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_103'].']', $set['texts']['c2'], $msgbk['keyword2']['value']);
					$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_104'].']', $set['texts']['c2'] . $set['texts']['down'], $msgbk['keyword2']['value']);
					if (($tag == 'commission_order_finish') || ($tag == 'commission_order_pay')) 
					{
						if ($datas['isagent']) 
						{
							$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_105'].']', $datas['commission3'], $msgbk['keyword2']['value']);
						}
						else 
						{
							$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_106'].']', $datas['commission2'], $msgbk['keyword2']['value']);
						}
					}
				}
				if ($key == 1) 
				{
					$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_107'].']', $set['texts']['c3'], $msgbk['keyword2']['value']);
					$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_108'].']', $set['texts']['c3'] . $set['texts']['down'], $msgbk['keyword2']['value']);
					if (($tag == 'commission_order_finish') || ($tag == 'commission_order_pay')) 
					{
						if ($datas['isagent']) 
						{
							$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_109'].']', 0, $msgbk['keyword2']['value']);
						}
						else 
						{
							$msgbk['keyword2']['value'] = str_replace('['.$this->lang['lang_plugin_commission_core_model_110'].']', $datas['commission3'], $msgbk['keyword2']['value']);
						}
					}
				}
				if (!(empty($tm[$tag])) && !(empty($tm['templateid']))) 
		...
		protected function sendMoreAdvanced($touser, $tm, $tag, $msg, $url, $datas) 
		{
			...
			$msgbk = $this->replaceArray($msgbk, '['.$this->lang['lang_plugin_commission_core_model_111'].']', $set['texts']['c1']);
			if (($tag == 'commission_order_finish_advanced') || ($tag == 'commission_order_pay_advanced')) 
			{
				$msgbk = $this->replaceArray($msgbk, '['.$this->lang['lang_plugin_commission_core_model_112'].']', $datas['commission1']);
			}
			if (!(empty($tm[$tag])) && !(empty($tm['templateid']))) 
			{
			...
			foreach ($res as $key => $value ) 
			{
				if ($key == 0) 
				{
					...
					$msgbk = $this->replaceArray($msgbk, '['.$this->lang['lang_plugin_commission_core_model_113'].']', $set['texts']['c2']);
					if (($tag == 'commission_order_finish_advanced') || ($tag == 'commission_order_pay_advanced')) 
					{
						$msgbk = $this->replaceArray($msgbk, '['.$this->lang['lang_plugin_commission_core_model_114'].']', $datas['commission2']);
					}
				}
				if ($key == 1) 
				{
					...
					$msgbk = $this->replaceArray($msgbk, '['.$this->lang['lang_plugin_commission_core_model_115'].']', $set['texts']['c3']);
					if (($tag == 'commission_order_finish_advanced') || ($tag == 'commission_order_pay_advanced')) 
					{
						$msgbk = $this->replaceArray($msgbk, '['.$this->lang['lang_plugin_commission_core_model_116'].']', $datas['commission3']);
					}
				}
				if (!(empty($tm[$tag])) && !(empty($tm['templateid']))) 
				{
		...
		protected function replaceTemplate($str, $tag, $data, $member) 
		{
			...
			switch ($tag) 
			{
				case 'commission_become_advanced': $arr['['.$this->lang['lang_plugin_commission_core_model_117'].']'] = date('Y-m-d H:i:s', $data['agenttime']);
				$arr['['.$this->lang['lang_plugin_commission_core_model_118'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_commission_core_model_119'].']'] = $data['nickname'];
				break;
				case 'commission_agent_new_advanced': $arr['['.$this->lang['lang_plugin_commission_core_model_120'].']'] = date('Y-m-d H:i:s', $data['childtime']);
				$arr['['.$this->lang['lang_plugin_commission_core_model_121'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_commission_core_model_122'].']'] = $data['nickname'];
				break;
				case 'commission_order_pay_advanced': $arr['['.$this->lang['lang_plugin_commission_core_model_123'].']'] = date('Y-m-d H:i:s', $data['paytime']);
				$arr['['.$this->lang['lang_plugin_commission_core_model_124'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_commission_core_model_125'].']'] = $data['nickname'];
				break;
				case 'commission_order_finish_advanced': $arr['['.$this->lang['lang_plugin_commission_core_model_126'].']'] = date('Y-m-d H:i:s', $data['finishtime']);
				$arr['['.$this->lang['lang_plugin_commission_core_model_127'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_commission_core_model_128'].']'] = $data['nickname'];
			}
		...
		{
			$set = $this->getSet();
			return array('['.$this->lang['lang_plugin_commission_core_model_129'].']' => $member['nickname'], '['.$this->lang['lang_plugin_commission_core_model_130'].']' => date('Y-m-d H:i:s', time()), '['.$this->lang['lang_plugin_commission_core_model_131'].']' => (!(empty($data['commission'])) ? $data['commission'] : ''), '['.$this->lang['lang_plugin_commission_core_model_132'].']' => (!(empty($data['type'])) ? $data['type'] : ''), '['.$this->lang['lang_plugin_commission_core_model_133'].']' => (!(empty($data['ordersn'])) ? $data['ordersn'] : ''), '['.$this->lang['lang_plugin_commission_core_model_134'].']' => (!(empty($data['price'])) ? $data['price'] : ''), '['.$this->lang['lang_plugin_commission_core_model_135'].']' => (!(empty($data['goods'])) ? $data['goods'] : ''), '['.$this->lang['lang_plugin_commission_core_model_136'].']' => (!(empty($data['oldlevel']['levelname'])) ? $data['oldlevel']['levelname'] : ''), '['.$this->lang['lang_plugin_commission_core_model_137'].']' => (!(empty($data['oldlevel']['commission1'])) ? $data['oldlevel']['commission1'] . '%' : ''), '['.$this->lang['lang_plugin_commission_core_model_138'].']' => (!(empty($data['oldlevel']['commission2'])) ? $data['oldlevel']['commission2'] . '%' : ''), '['.$this->lang['lang_plugin_commission_core_model_139'].']' => (!(empty($data['oldlevel']['commission3'])) ? $data['oldlevel']['commission3'] . '%' : ''), '['.$this->lang['lang_plugin_commission_core_model_140'].']' => (!(empty($data['newlevel']['levelname'])) ? $data['newlevel']['levelname'] : ''), '['.$this->lang['lang_plugin_commission_core_model_141'].']' => (!(empty($data['newlevel']['commission1'])) ? $data['newlevel']['commission1'] . '%' : ''), '['.$this->lang['lang_plugin_commission_core_model_142'].']' => (!(empty($data['newlevel']['commission2'])) ? $data['newlevel']['commission2'] . '%' : ''), '['.$this->lang['lang_plugin_commission_core_model_143'].']' => (!(empty($data['newlevel']['commission3'])) ? $data['newlevel']['commission3'] . '%' : ''), '['.$this->lang['lang_plugin_commission_core_model_144'].']' => '[' . $set['texts']['down'] . ']');
		}
