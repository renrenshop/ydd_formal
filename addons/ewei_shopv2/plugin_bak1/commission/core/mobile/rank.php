...
class Rank_EweiShopV2Page extends CommissionMobileLoginPage 
{
	...
	public function main() 
	{
		...
		switch ($this->commission_rank['type']) 
		{
			...
			$commission_title = ''.$this->lang['lang_plugin_commission_core_mobile_rank_0'].'';
			break;
			...
			$user['paiming'] = ((empty($paiming) ? ''.$this->lang['lang_plugin_commission_core_mobile_rank_1'].'' : $paiming));
			$commission_title = ''.$this->lang['lang_plugin_commission_core_mobile_rank_2'].'';
			break;
