	...
	function get_list() {
		...
		if (!empty($orderids)) {
			...
			foreach ($list as &$row) {
				...
				if ($row['status'] == 0) {
					$row['status'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_0'].'';
				} else if ($row['status'] == 1) {
					$row['status'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_1'].'';
				} else if ($row['status'] == 2) {
					$row['status'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_2'].'';
				} else if ($row['status'] == 3) {
					$row['status'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_3'].'';
				}
				if ($orderids[$row['id']]['level'] == 1) {
					$row['level'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_4'].'';
				} else if ($orderids[$row['id']]['level'] == 2) {
					$row['level'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_5'].'';
				} else if ($orderids[$row['id']]['level'] == 3) {
					$row['level'] = ''.$this->lang['lang_plugin_commission_core_mobile_order_6'].'';
				}
