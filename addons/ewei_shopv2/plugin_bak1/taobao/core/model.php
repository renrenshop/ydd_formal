...
class TaobaoModel extends PluginModel 
{
	public function get_item_taobao($itemid = '', $taobaourl = '', $pcate = 0, $ccate = 0, $tcate = 0, $merchid = 0) 
	{
		...
		{
			return array('result' => '0', 'error' => ''.$this->lang['lang_plugin_taobao_core_model_0'].'!');
		}
		$content = $response['content'];
		if (strexists($response['content'], 'ERRCODE_QUERY_DETAIL_FAIL')) 
		{
			return array('result' => '0', 'error' => ''.$this->lang['lang_plugin_taobao_core_model_1'].'!');
		}
	...
	public function get_item_jingdong($itemid = '', $jingdongurl = '', $pcate = 0, $ccate = 0, $tcate = 0, $merchid = 0) 
	{
		...
		if ($length != NULL) 
		{
			return array('result' => '0', 'error' => ''.$this->lang['lang_plugin_taobao_core_model_2'].'!');
		}
		$content = $response['content'];
		$dom = new DOMDocument();
		...
		if ($prodectName == NULL) 
		{
			return array('result' => '0', 'error' => ''.$this->lang['lang_plugin_taobao_core_model_3'].'!');
		}
		$item = array();
		$item['id'] = $g['id'];
		$item['merchid'] = $merchid;
	...
	public function get_item_one688($itemid = '', $one688url = '', $pcate = 0, $ccate = 0, $tcate = 0, $merchid = 0) 
	{
		...
		if ($length != NULL) 
		{
			return array('result' => '0', 'error' => ''.$this->lang['lang_plugin_taobao_core_model_4'].'1688'.$this->lang['lang_plugin_taobao_core_model_5'].'!');
		}
		$content = $response['content'];
		$dom = new DOMDocument();
		...
		if ($prodectName == NULL) 
		{
			return array('result' => '0', 'error' => ''.$this->lang['lang_plugin_taobao_core_model_6'].'!');
		}
		$item = array();
		$item['id'] = $g['id'];
		$item['merchid'] = $merchid;
