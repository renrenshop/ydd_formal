...
class Register_EweiShopV2Page extends GlobonusMobileLoginPage 
{
	public function main() 
	{
		...
		{
			$apply_set['applytitle'] = ''.$this->lang['lang_plugin_globonus_core_mobile_register_0'].'';
		}
		else 
		{
		...
		if ($_W['ispost']) 
		{
			if ($set['become'] != '1') 
			{
				show_json(0, ''.$this->lang['lang_plugin_globonus_core_mobile_register_1'].'' . $set['texts']['partner'] . ''.$this->lang['lang_plugin_globonus_core_mobile_register_2'].'!');
			}
