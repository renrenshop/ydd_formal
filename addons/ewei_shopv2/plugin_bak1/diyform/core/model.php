...
class DiyformModel extends PluginModel 
{
    ...
    protected function resetClassInnerParam(){
        $this->_data_type_config = array(0 => ''.$this->lang['lang_plugin_diyform_core_model_0'].'', 1 => ''.$this->lang['lang_plugin_diyform_core_model_1'].'', 2 => ''.$this->lang['lang_plugin_diyform_core_model_2'].'', 3 => ''.$this->lang['lang_plugin_diyform_core_model_3'].'', 5 => ''.$this->lang['lang_plugin_diyform_core_model_4'].'', 6 => ''.$this->lang['lang_plugin_diyform_core_model_5'].'', 7 => ''.$this->lang['lang_plugin_diyform_core_model_6'].'', 8 => ''.$this->lang['lang_plugin_diyform_core_model_7'].'', 9 => ''.$this->lang['lang_plugin_diyform_core_model_8'].'', 10 => ''.$this->lang['lang_plugin_diyform_core_model_9'].'', 11 => ''.$this->lang['lang_plugin_diyform_core_model_10'].'', 12 => ''.$this->lang['lang_plugin_diyform_core_model_11'].'', 13 => ''.$this->lang['lang_plugin_diyform_core_model_12'].'');
        $this->_default_data_config = array('', ''.$this->lang['lang_plugin_diyform_core_model_13'].'', ''.$this->lang['lang_plugin_diyform_core_model_14'].'', ''.$this->lang['lang_plugin_diyform_core_model_15'].'', ''.$this->lang['lang_plugin_diyform_core_model_16'].'');
        $this->_default_date_config = array('', ''.$this->lang['lang_plugin_diyform_core_model_17'].'', ''.$this->lang['lang_plugin_diyform_core_model_18'].'');
    }
	...
	public function getDatas($fields, $data, $flag = 0) 
	{
		...
		foreach ($fields as $key => $value ) 
		{
			...
			else 
			{
				...
				{
					$tp_value = (($data[$key]['province'] != ''.$this->lang['lang_plugin_diyform_core_model_19'].'' ? $data[$key]['province'] : '')) . ' - ' . (($data[$key]['city'] != ''.$this->lang['lang_plugin_diyform_core_model_20'].'' ? $data[$key]['city'] : ''));
	...
	public function getPostDatas($fields, $field_data_name = 'field_data') 
	{
		...
		foreach ($fields as $field => $value ) 
		{
			...
			if (($value['data_type'] == 0) || ($value['data_type'] == 1) || ($value['data_type'] == 2) || ($value['data_type'] == 6) || ($value['data_type'] == 7) || ($value['data_type'] == 11)) 
			{
				...
				{
					return error(-1, ''.$this->lang['lang_plugin_diyform_core_model_21'].'' . $value['tp_name']);
				}
			}
			else if ($value['data_type'] == 3) 
			{
				...
				if (empty($tp_value) && $value['tp_must']) 
				{
					return error(-1, ''.$this->lang['lang_plugin_diyform_core_model_22'].'' . $value['tp_name']);
				}
			}
			else if ($value['data_type'] == 5) 
			{
				...
				if (empty($tp_value) && $value['tp_must']) 
				{
					return error(-1, ''.$this->lang['lang_plugin_diyform_core_model_23'].'' . $value['tp_name']);
				}
			}
			else 
			{
				if (($value['data_type'] == 8) || ($value['data_type'] == 12)) 
				{
					...
					if (empty($tp_value) && $value['tp_must']) 
					{
						return error(-1, ''.$this->lang['lang_plugin_diyform_core_model_24'].'' . $value['tp_name']);
					}
				}
				else if ($value['data_type'] == 9) 
				{
					$tp_value = array();
					if (($_GPC[$field_data_name . '_province' . $key] != ''.$this->lang['lang_plugin_diyform_core_model_25'].'') && !(empty($_GPC[$field_data_name . '_province' . $key]))) 
					{
						$tp_value['province'] = $_GPC[$field_data_name . '_province' . $key];
					}
					if (($_GPC[$field_data_name . '_city' . $key] != ''.$this->lang['lang_plugin_diyform_core_model_26'].'') && !(empty($_GPC[$field_data_name . '_city' . $key]))) 
					{
						$tp_value['city'] = $_GPC[$field_data_name . '_city' . $key];
					}
					if (($_GPC[$field_data_name . '_area' . $key] != ''.$this->lang['lang_plugin_diyform_core_model_27'].'') && !(empty($_GPC[$field_data_name . '_area' . $key]))) 
					{
						$tp_value['area'] = $_GPC[$field_data_name . '_area' . $key];
					}
					if ((!(isset($tp_value['province'])) || !(isset($tp_value['city']))) && $value['tp_must']) 
					{
						return error(-1, ''.$this->lang['lang_plugin_diyform_core_model_28'].'' . $value['tp_name']);
					}
				}
			}
	...
	public function wxApp($fields, $f_data, $member = array()) 
	{
		...
		if (!(empty($fields)) && is_array($fields)) 
		{
			foreach ($fields as $k => $v ) 
			{
				...
				{
					$v['placeholder'] = ''.$this->lang['lang_plugin_diyform_core_model_29'].'' . $v['tp_name'];
				}
				if ($v['data_type'] == 0) 
				{
