...
if (!(class_exists('AbonusModel'))) 
{
	class AbonusModel extends PluginModel 
	{
		public function getSet($uniacid = 0) 
		{
			...
			$set['texts'] = array('aagent' => (empty($set['texts']['aagent']) ? ''.$this->lang['lang_plugin_abonus_core_model_0'].'' : $set['texts']['aagent']), 'center' => (empty($set['texts']['center']) ? ''.$this->lang['lang_plugin_abonus_core_model_1'].'' : $set['texts']['center']), 'become' => (empty($set['texts']['become']) ? ''.$this->lang['lang_plugin_abonus_core_model_2'].'' : $set['texts']['become']), 'bonus' => (empty($set['texts']['bonus']) ? ''.$this->lang['lang_plugin_abonus_core_model_3'].'' : $set['texts']['bonus']), 'bonus_total' => (empty($set['texts']['bonus_total']) ? ''.$this->lang['lang_plugin_abonus_core_model_4'].'' : $set['texts']['bonus_total']), 'bonus_lock' => (empty($set['texts']['bonus_lock']) ? ''.$this->lang['lang_plugin_abonus_core_model_5'].'' : $set['texts']['bonus_lock']), 'bonus_pay' => (empty($set['texts']['bonus_lock']) ? ''.$this->lang['lang_plugin_abonus_core_model_6'].'' : $set['texts']['bonus_pay']), 'bonus_wait' => (empty($set['texts']['bonus_wait']) ? ''.$this->lang['lang_plugin_abonus_core_model_7'].'' : $set['texts']['bonus_wait']), 'bonus_detail' => (empty($set['texts']['bonus_detail']) ? ''.$this->lang['lang_plugin_abonus_core_model_8'].'' : $set['texts']['bonus_detail']), 'bonus_charge' => (empty($set['texts']['bonus_charge']) ? ''.$this->lang['lang_plugin_abonus_core_model_9'].'' : $set['texts']['bonus_charge']));
			return $set;
		}
		public function getLevels($all = true, $default = false) 
		{
			...
			if ($default) 
			{
				$default = array('id' => '0', 'levelname' => (empty($_S['abonus']['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_10'].'' : $_S['abonus']['levelname']), 'bonus1' => $_W['shopset']['abonus']['bonus1'], 'bonus2' => $_W['shopset']['abonus']['bonus2'], 'bonus3' => $_W['shopset']['abonus']['bonus3']);
		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			if (($message_type == TM_ABONUS_PAY) && empty($usernotice['abonus_pay'])) 
			{
				...
				{
					$message = $tm['pay1'];
					$paytitle = ((empty($tm['paytitle1']) ? ''.$this->lang['lang_plugin_abonus_core_model_11'].'' : $tm['paytitle1']));
				}
				else if ($data['aagenttype'] == 2) 
				{
					$message = $tm['pay2'];
					$paytitle = ((empty($tm['paytitle2']) ? ''.$this->lang['lang_plugin_abonus_core_model_12'].'' : $tm['paytitle2']));
				}
				else if ($data['aagenttype'] == 3) 
				{
					$message = $tm['pay3'];
					$paytitle = ((empty($tm['paytitle3']) ? ''.$this->lang['lang_plugin_abonus_core_model_13'].'' : $tm['paytitle3']));
				}
				if (empty($message)) 
				{
					return false;
				}
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_14'].']', $member['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_15'].']', date('Y-m-d H:i:s', time()), $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_16'].']', $data['type'], $message);
				if ($data['aagenttype'] == 1) 
				{
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_17'].']', $data['paymoney1'], $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_18'].']', $data['paymoney2'], $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_19'].']', $data['paymoney3'], $message);
					$advanced = 'pay1_advanced';
				}
				else if ($data['aagenttype'] == 2) 
				{
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_20'].']', $data['paymoney2'], $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_21'].']', $data['paymoney3'], $message);
					$advanced = 'pay2_advanced';
				}
				else if ($data['aagenttype'] == 3) 
				{
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_22'].']', $data['paymoney3'], $message);
			...
			if (($message_type == TM_ABONUS_UPGRADE) && empty($usernotice['abonus_upgrade'])) 
			{
				...
				{
					$message = $tm['upgrade1'];
					$upgradetitle = ((empty($tm['upgradetitle1']) ? ''.$this->lang['lang_plugin_abonus_core_model_23'].'' : $tm['upgradetitle1']));
				}
				else if ($data['aagenttype'] == 2) 
				{
					$message = $tm['upgrade2'];
					$upgradetitle = ((empty($tm['upgradetitle2']) ? ''.$this->lang['lang_plugin_abonus_core_model_24'].'' : $tm['upgradetitle2']));
				}
				else if ($data['aagenttype'] == 3) 
				{
					$message = $tm['upgrade3'];
					$upgradetitle = ((empty($tm['upgradetitle3']) ? ''.$this->lang['lang_plugin_abonus_core_model_25'].'' : $tm['upgradetitle3']));
				}
				if (empty($message)) 
				{
					return false;
				}
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_26'].']', $member['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_27'].']', date('Y-m-d H:i:s', time()), $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_28'].']', $data['oldlevel']['levelname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_29'].']', $data['newlevel']['levelname'], $message);
				$advanced = '';
				if ($member['aagenttype'] == 1) 
				{
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_30'].']', $data['oldlevel']['bonus1'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_31'].']', $data['oldlevel']['bonus2'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_32'].']', $data['oldlevel']['bonus3'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_33'].']', $data['newlevel']['bonus1'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_34'].']', $data['newlevel']['bonus2'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_35'].']', $data['newlevel']['bonus3'] . '%', $message);
					$advanced = 'upgrade1_advanced';
				}
				else if ($member['aagenttype'] == 2) 
				{
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_36'].']', $data['oldlevel']['bonus2'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_37'].']', $data['oldlevel']['bonus3'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_38'].']', $data['newlevel']['bonus2'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_39'].']', $data['newlevel']['bonus3'] . '%', $message);
					$advanced = 'upgrade2_advanced';
				}
				else if ($member['aagenttype'] == 3) 
				{
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_40'].']', $data['oldlevel']['bonus3'] . '%', $message);
					$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_41'].']', $data['newlevel']['bonus3'] . '%', $message);
			...
			if (($message_type == TM_ABONUS_BECOME) && empty($usernotice['abonus_become'])) 
			{
				...
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_42'].']', $data['nickname'], $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_43'].']', date('Y-m-d H:i:s', $data['aagenttime']), $message);
				if ($data['aagenttype'] == 1) 
				{
					$aagenttype = ''.$this->lang['lang_plugin_abonus_core_model_44'].'';
				}
				else if ($data['aagenttype'] == 2) 
				{
					$aagenttype = ''.$this->lang['lang_plugin_abonus_core_model_45'].'';
				}
				else if ($data['aagenttype'] == 3) 
				{
					$aagenttype = ''.$this->lang['lang_plugin_abonus_core_model_46'].'';
				}
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_47'].']', $aagenttype, $message);
				$message = str_replace('['.$this->lang['lang_plugin_abonus_core_model_48'].']', $data['aagentareas'], $message);
				$msg = array( 'keyword1' => array('value' => (!(empty($tm['becometitle'])) ? $tm['becometitle'] : ''.$this->lang['lang_plugin_abonus_core_model_49'].''), 'color' => '#73a68d'), 'keyword2' => array('value' => $message, 'color' => '#73a68d') );
		...
		{
			$arr = array('['.$this->lang['lang_plugin_abonus_core_model_50'].']' => $member['nickname'], '['.$this->lang['lang_plugin_abonus_core_model_51'].']' => date('Y-m-d H:i:s', time()), '['.$this->lang['lang_plugin_abonus_core_model_52'].']' => (!(empty($data['type'])) ? $data['type'] : ''), '['.$this->lang['lang_plugin_abonus_core_model_53'].']' => (!(empty($data['oldlevel']['levelname'])) ? $data['oldlevel']['levelname'] : ''), '['.$this->lang['lang_plugin_abonus_core_model_54'].']' => (!(empty($data['newlevel']['levelname'])) ? $data['newlevel']['levelname'] : ''));
			switch ($tag) 
			{
				case 'become_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_55'].']'] = date('Y-m-d H:i:s', $data['aagenttime']);
				$arr['['.$this->lang['lang_plugin_abonus_core_model_56'].']'] = $data['nickname'];
				case 'pay1_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_57'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_abonus_core_model_58'].']'] = date('Y-m-d H:i:s', $data['paytime']);
				$arr['['.$this->lang['lang_plugin_abonus_core_model_59'].']'] = $data['paymoney1'];
				$arr['['.$this->lang['lang_plugin_abonus_core_model_60'].']'] = $data['paymoney2'];
				$arr['['.$this->lang['lang_plugin_abonus_core_model_61'].']'] = $data['paymoney3'];
				case 'pay2_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_62'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_abonus_core_model_63'].']'] = date('Y-m-d H:i:s', $data['paytime']);
				$arr['['.$this->lang['lang_plugin_abonus_core_model_64'].']'] = $data['paymoney2'];
				$arr['['.$this->lang['lang_plugin_abonus_core_model_65'].']'] = $data['paymoney3'];
				case 'pay3_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_66'].']'] = $data['nickname'];
				$arr['['.$this->lang['lang_plugin_abonus_core_model_67'].']'] = date('Y-m-d H:i:s', $data['paytime']);
				$arr['['.$this->lang['lang_plugin_abonus_core_model_68'].']'] = $data['paymoney3'];
				case 'upgrade1_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_69'].']'] = ((!(empty($data['oldlevel']['bonus1'])) ? $data['oldlevel']['bonus1'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_70'].']'] = ((!(empty($data['oldlevel']['bonus2'])) ? $data['oldlevel']['bonus2'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_71'].']'] = ((!(empty($data['oldlevel']['bonus3'])) ? $data['oldlevel']['bonus3'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_72'].']'] = ((!(empty($data['newlevel']['bonus1'])) ? $data['newlevel']['bonus1'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_73'].']'] = ((!(empty($data['newlevel']['bonus2'])) ? $data['newlevel']['bonus2'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_74'].']'] = ((!(empty($data['newlevel']['bonus3'])) ? $data['newlevel']['bonus3'] . '%' : ''));
				case 'upgrade1_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_75'].']'] = ((!(empty($data['oldlevel']['bonus2'])) ? $data['oldlevel']['bonus2'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_76'].']'] = ((!(empty($data['oldlevel']['bonus3'])) ? $data['oldlevel']['bonus3'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_77'].']'] = ((!(empty($data['newlevel']['bonus2'])) ? $data['newlevel']['bonus2'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_78'].']'] = ((!(empty($data['newlevel']['bonus3'])) ? $data['newlevel']['bonus3'] . '%' : ''));
				case 'upgrade3_advanced': $arr['['.$this->lang['lang_plugin_abonus_core_model_79'].']'] = ((!(empty($data['oldlevel']['bonus3'])) ? $data['oldlevel']['bonus3'] . '%' : ''));
				$arr['['.$this->lang['lang_plugin_abonus_core_model_80'].']'] = ((!(empty($data['newlevel']['bonus3'])) ? $data['newlevel']['bonus3'] . '%' : ''));
			}
		...
		public function upgradeLevelByOrder($openid) 
		{
			...
			if (($leveltype == 4) || ($leveltype == 5)) 
			{
				...
				{
					$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_81'].'' : $set['levelname']), 'bonus' => $set['bonus']);
				}
			...
			else if ((0 <= $leveltype) && ($leveltype <= 3)) 
			{
				...
				foreach ($agents as $agent ) 
				{
					...
					if (empty($oldlevel['id'])) 
					{
						$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_82'].'' : $set['levelname']), 'bonus' => $set['bonus']);
					}
					if ($leveltype == 0) 
					{
		...
		public function upgradeLevelByAgent($openid) 
		{
			...
			if (($leveltype == 6) || ($leveltype == 8)) 
			{
				...
				foreach ($agents as $agent ) 
				{
					...
					if (empty($oldlevel['id'])) 
					{
						$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_83'].'' : $set['levelname']), 'bonus' => $set['bonus']);
					}
					if ($leveltype == 6) 
					{
			...
			else 
			{
				...
				if (empty($oldlevel['id'])) 
				{
					$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_84'].'' : $set['levelname']), 'bonus' => $set['bonus']);
				}
				if ($leveltype == 7) 
				{
		...
		public function upgradeLevelByCommissionOK($openid) 
		{
			...
			if (empty($oldlevel['id'])) 
			{
				$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_85'].'' : $set['levelname']), 'bonus' => $set['bonus']);
			}
		...
		public function upgradeLevelByBonus($openid) 
		{
			...
			if (empty($oldlevel['id'])) 
			{
				$oldlevel = array('levelname' => (empty($set['levelname']) ? ''.$this->lang['lang_plugin_abonus_core_model_86'].'' : $set['levelname']), 'bonus1' => $set['bonus1'], 'bonus2' => $set['bonus2'], 'bonus3' => $set['bonus3'], 'bonusmoney' => 0);
			}
