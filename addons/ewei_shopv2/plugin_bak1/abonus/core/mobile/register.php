...
class Register_EweiShopV2Page extends AbonusMobileLoginPage 
{
	public function main() 
	{
		...
		{
			$apply_set['applytitle'] = ''.$this->lang['lang_plugin_abonus_core_mobile_register_0'].'';
		}
		else 
		{
		...
		if ($_W['ispost']) 
		{
			if ($set['become'] != '1') 
			{
				show_json(0, ''.$this->lang['lang_plugin_abonus_core_mobile_register_1'].'' . $set['texts']['agent'] . ''.$this->lang['lang_plugin_abonus_core_mobile_register_2'].'!');
			}
			if ($template_flag == 1) 
			{
