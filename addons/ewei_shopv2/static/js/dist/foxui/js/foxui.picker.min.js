var FoxUIPicker = function (params) {
    ...
    self.show = function () {
        ...
        var titleHTML = '';
        var cancelButtonHTML = "<a href='javascript:' class='text-cancel fui-picker-cancel'>cancel</a>";
        ...
        "<div class='right'><a href='javascript:' class='text-success fui-picker-confirm'>comfirm</a></div>" +
        "</div>";
