jQuery.extend({
    ...
    isMobile: function(str) {
        ...
        //新添加判断国际电话号码的正则
        // if($.trim(str) !== '' && /^(\+|00){0,2}(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\d{1,14}$/.test(str)){
        //     check_mobile = true;
        // }
        //判断马来西亚的手机号码正则
        // if($.trim(str) !== '' && /^(\+?6?01){1}(([145]{1}(\-|\s)?\d{7,8})|([236789]{1}(\s|\-)?\d{7}))$/.test(str)){
        //     check_mobile = true;
        // }
        if(str.length > 11){
            check_mobile = false;
        ...
        //中国电话号码正则
        // if($.trim(str) !== '' && /^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/.test(str)){
        //     check_mobile = true;
        // }
