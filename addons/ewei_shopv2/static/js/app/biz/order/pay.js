define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.pay = function(btn) {
        ...
        if (type == 'wechat') {
            ...
            FoxUI.confirm(lang_js_biz_order_pay_0+'?', lang_js_biz_order_pay_1, function() {
            ...
            var pay_type = btn.data('paytype');
            var orderid = modal.params.orderid;
            modal.payRM(orderid,id,pay_type)
        }
        else {
            modal.complete(btn, type)
        }
            ...
            function onBridgeReady() {
                WeixinJSBridge.invoke('getBrandWCPayRequest', {
                    ...
                    if (res.err_msg == 'get_brand_wcpay_request:ok') {
                        ...
                        FoxUI.toast.show(lang_js_biz_order_pay_2)
                    } else {
    ...
    modal.payRM = function(btn,id,pay_type){
        location.href = core.getUrl('order/pay/payRM', {
            id: modal.params.orderid,
            weixin_id:id,
            pay_type:pay_type
        });
