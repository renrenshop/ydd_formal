        ...
        $('#package-buy-a').unbind('click').click(function() {
            ...
            $(".goods-item").each(function(index) {
                ...
                if (optionid === undefined) {
                    ...
                    FoxUI.toast.show(lang_js_biz_goods_packdetail_0+'!');
                    stop = 1;
                    return false
                }
                goods[index] = {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status > 0) {
                        ...
                        $(".dispatching-info").html(lang_js_biz_goods_packdetail_1+'！')
                    }
                    if (default_option) {
    ...
    modal.optionPicker = function(action) {
        picker.open({
            ...
            onConfirm: function(total, optionid, optiontitle) {
                ...
                $('.option-selector').html(lang_js_biz_goods_packdetail_2+": "+lang_js_biz_goods_packdetail_3+"x" + total + " " + optiontitle);
                if (action == 'buy') {
