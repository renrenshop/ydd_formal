define(['core', 'tpl', 'biz/goods/picker', 'biz/plugin/diyform'], function(core, tpl, picker, diyform) {
    ...
    modal.bindEvents = function() {
        ...
        $('.btn-submit').unbind('click').click(function() {
            ...
            var html = $(this).html();
            btn.attr('stop', 1).html(lang_js_biz_member_cart_0+'...');
    ...
    modal.changeMode = function() {
        ...
        if (modal.status == 'cart') {
            ...
            $('.editmode').show();
            modal.status = 'edit';
            $('.btn-edit').html(lang_js_biz_member_cart_1);
            modal.caculateEdit()
        } else {
            $('.cartmode').show();
            $('.editmode').hide();
            modal.status = 'cart';
            $('.btn-edit').html(lang_js_biz_member_cart_2)
        }
    };
    ...
    modal.remove = function() {
        ...
        FoxUI.confirm(lang_js_biz_member_cart_3+'?', function() {
    ...
    modal.toFavorite = function() {
        ...
        FoxUI.confirm(lang_js_biz_member_cart_4+'?', function() {
