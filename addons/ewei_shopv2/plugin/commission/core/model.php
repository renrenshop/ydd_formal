					...
					else 
					{
						...
						else 
						{
                            ...
                            for($i=1;$i<=$set['level'];$i++){
                                $message = str_replace("[".$i."级佣金金额]", $data["commission".$i], $message);
                            }
...
//            ppp($touser, $tm, $tag, $msg, $datas,$tm[$tag],$tm["templateid"],$msgbk);die;
