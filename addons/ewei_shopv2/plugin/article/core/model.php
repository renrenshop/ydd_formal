	...
	class ArticleModel extends PluginModel 
	{
		public function doShare($aid, $shareid, $myid) 
		{
			...
			if ((0 < $givecredit) || (0 < $givemoney)) 
			{
				...
				$message = array( 'first' => array('value' => '您的奖励已到帐！', 'color' => '#4a5077'), 'keyword2' => array('title' => '业务状态', 'value' => '分享得奖励', 'color' => '#4a5077'), 'keyword3' => array('title' => '业务内容', 'value' => '用户通过您的分享进入文章《' . $article['article_title'] . '》，系统奖励您' . $p . '。', 'color' => '#4a5077'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '奖励已发放成功，请到会员中心查看。', 'color' => '#4a5077') );
