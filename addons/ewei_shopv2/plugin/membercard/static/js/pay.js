        ...
        $.getJSON(
            ...
            function (data) {
                ...
                if (type == 'wechat') {
                    ...
                    FoxUI.confirm(lang_js_membercard_js_pay_0, lang_js_membercard_js_pay_1, function () {
                        modal.complete(btn, type)
                    }, function () {
                        btn.removeAttr('stop')
                    })
            ...
            function onBridgeReady(){
                WeixinJSBridge.invoke('getBrandWCPayRequest', {
                    ...
                    if (res.err_msg == 'get_brand_wcpay_request:ok') {
                        ...
                        FoxUI.toast.show(lang_js_membercard_js_pay_2);
                        btn.removeAttr('stop')
                    } else {
                        btn.removeAttr('stop');
                        alert(res.err_msg)
    ...
    modal.complete = function (btn, type) {
        ...
        core.json('membercard/pay/complete', {
            ...
            if (pay_json.status == 1) {
               ...
               return
                text = lang_js_membercard_js_pay_3;
                button = lang_js_membercard_js_pay_4;
                ...
                FoxUI.message.show({
                    ...
                    buttons: [{
                        ...
                        text: lang_js_membercard_js_pay_5, extraClass: 'btn-default', onclick: function () {
