...
class Picker_EweiShopV2Page extends PluginMobilePage 
{
	...
	public function date_list() 
	{
		...
		$weekarray = array(
		    $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_8'],
            $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_2'],
            $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_3'],
            $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_4'],
            $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_5'],
            $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_6'],
            $this->lang['_plugin_cycelbuy_core_mobile_trade_picker_date_list_7']
        );
		if (!(empty($tdate))) 
		{
			$year = date('Y', $ttime);
