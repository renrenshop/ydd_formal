...
class SignModel extends PluginModel 
{
	public function getSet() 
	{
		...
		{
			$set['textsign'] = ''.$this->lang['lang_plugin_sign_core_model_0'].'';
		}
		if (empty($set['textsigned'])) 
		{
			$set['textsigned'] = ''.$this->lang['lang_plugin_sign_core_model_1'].'';
		}
		if (empty($set['textsignold'])) 
		{
			$set['textsignold'] = ''.$this->lang['lang_plugin_sign_core_model_2'].'';
		}
		if (empty($set['textsignforget'])) 
		{
			$set['textsignforget'] = ''.$this->lang['lang_plugin_sign_core_model_3'].'';
		}
		if (empty($_W['shopset']['trade']['credittext'])) 
		{
			$set['textcredit'] = ''.$this->lang['lang_plugin_sign_core_model_4'].'';
		}
		else 
		{
		...
		if (empty($_W['shopset']['trade']['credittext'])) 
		{
			$set['textmoney'] = ''.$this->lang['lang_plugin_sign_core_model_5'].'';
		}
		else 
		{
