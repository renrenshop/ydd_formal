...
//            file_put_contents(dirname(__FILE__).'/mobile_info.txt',json_encode($option));

            $result = sendSms($option);
//            file_put_contents(dirname(__FILE__).'/mobile_result.txt',json_encode($result));
            logging_run($option, 'option', 'sms');
            logging_run($result, 'result', 'sms');
