...
class Bind_EweiShopV2Page extends MobileLoginPage 
{
	...
	public function main() 
	{
		...
		if (!(p('threen'))) 
		{
			...
			{
				$this->message($this->lang['lang_module_member_bind_0']);
			}
		}
		...
		if ($_W['ispost']) 
		{
			...
			{
				show_json(0, $this->lang['lang_module_member_bind_1']);
			}
			...
			{
				show_json(0, $this->lang['lang_module_member_bind_2']);
			}
			if (m('bind')->iswxm($member) && m('bind')->iswxm($member2)) 
			{
				...
				{
					show_json(-1, '<center>'.$this->lang['lang_module_member_bind_3'].'<br>'.$this->lang['lang_module_member_bind_4'].'<br>'.$this->lang['lang_module_member_bind_5'].'</center>');
				}
			}
			if (!(m('bind')->iswxm($member2))) 
			{
				...
				{
					show_json(-1, '<center>'.$this->lang['lang_module_member_bind_6'].'<br>'.$this->lang['lang_module_member_bind_7'].'<br>'.$this->lang['lang_module_member_bind_8'].'</center>');
				}
			}
			if (!(m('bind')->iswxm($member))) 
			{
				...
				{
					show_json(-1, '<center>'.$this->lang['lang_module_member_bind_9'].'<br>'.$this->lang['lang_module_member_bind_10'].'<br>'.$this->lang['lang_module_member_bind_11'].'</center>');
				}
			}
		}
