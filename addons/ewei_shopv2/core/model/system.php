...
class System_EweiShopV2Model
{
    ...
    {
        $shopmenu = array( "shop" => array( "title" => "店铺", "subtitle" => "店铺首页", "icon" => "store", "items" => array( array( "title" => "首页", "route" => "", "items" => array( array( "title" => "幻灯片 ", "route" => "adv", "desc" => "店铺首页幻灯片管理" ), array( "title" => "导航图标", "route" => "nav", "desc" => "店铺首页导航图标管理" ), array( "title" => "广告", "route" => "banner", "desc" => "店铺首页广告管理" ), array( "title" => "魔方推荐", "route" => "cube", "desc" => "店铺首页魔方推荐管理" ), array( "title" => "商品推荐", "route" => "recommand", "desc" => "店铺首页商品推荐管理" ), array( "title" => "排版设置", "route" => "sort", "desc" => "店铺首页排版设置" ) ) ), array( "title" => "商城", "items" => array( array( "title" => "公告管理", "route" => "notice", "desc" => "店铺公告管理" ), array( "title" => "评价管理", "route" => "comment", "desc" => "店铺商品评价管理" ), array( "title" => "退货地址", "route" => "refundaddress", "desc" => "店铺退货地址管理" ) ) ),
            array( "title" => "配送方式", "items" => array( array( "title" => "普通快递", "route" => "dispatch", "desc" => "店铺普通快递管理" ),
...
//                "desc" => "订单批量发货"
//            )
        ) ) ) ), "store" => array( "title" => "门店", "subtitle" => "门店", "icon" => "mendianguanli", "items" => array( array( "title" => "门店管理", "items" => array( array( "title" => "门店管理", "route" => "", "extends" => array( "store.diypage.settings", "store.diypage.page", "store.goods", "store.goods.goodsoption" ) ), array( "title" => "店员管理", "route" => "saler" ), array( "title" => "关键词设置", "route" => "set" ) ) ), array( "title" => "门店商品管理", "items" => array( array( "title" => "记次时商品管理", "route" => "verifygoods", "extends" => array( "store.verifygoods.detail", "store.verifygoods.verifygoodslog" ) ) ) ), array( "title" => "记次时商品统计", "route" => "verify.log" ), array( "title" => "核销订单记录", "route" => "verifyorder.log" ) ) ), "sale" => array( "title" => "营销", "subtitle" => "营销设置", "icon" => "yingxiao", "items" => array( array( "title" => "基本功能", "items" => array( array( "title" => "满额立减", "route" => "enough", "desc" => "满额立减设置", "keywords" => "营销" ), array( "title" => "满额包邮", "route" => "enoughfree", "desc" => "满额包邮设置", "keywords" => "营销" ), array( "title" => "抵扣设置", "route" => "deduct", "desc" => "抵扣设置", "keywords" => "营销" ), array( "title" => "充值优惠", "route" => "recharge", "desc" => "充值优惠设置", "keywords" => "营销" ), array( "title" => "积分优惠", "route" => "credit1", "desc" => "积分优惠设置", "keywords" => "营销" ), array( "title" => "套餐管理", "route" => "package", "keywords" => "营销" ), array( "title" => "赠品管理", "route" => "gift", "keywords" => "营销" ), array( "title" => "全返管理", "route" => "fullback", "keywords" => "营销" ),
//            array(
//                "title" => "找人代付",
//                "route" => "peerpay",
//                "keywords" => "营销"
//            ),
            array( "title" => "绑定送积分", "route" => "bindmobile" ) ) ), array( "title" => "优惠券", "route" => "coupon", "iscom" => "coupon", "items" => array( array( "title" => "全部优惠券" ), array( "title" => "手动发送", "route" => "sendcoupon", "desc" => "手动发送优惠券" ), array( "title" => "购物送券", "route" => "shareticket", "extends" => array( "sale.coupon.goodssend", "sale.coupon.usesendtask", "sale.coupon.goodssend.add", "sale.coupon.usesendtask.add" ) ), array( "title" => "发放记录", "route" => "log", "desc" => "优惠券发放记录" ), array( "title" => "分类管理", "route" => "category", "desc" => "优惠券分类管理" ), array( "title" => "其他设置", "route" => "set", "desc" => "优惠券设置" ) ) ),
//            array(
//                "title" => "微信卡券",
//                "iscom" => "wxcard",
//                "items" => array(
...
//                            ),
                    ...
                    ), array( "title" => "交易", "items" => array( array( "title" => "交易设置", "route" => "trade" ), array( "title" => "支付设置", "route" => "payset" ), array( "title" => "支付管理", "route" => "payment" ) ) ),
                    array(
                        "title" => "消息推送",
                        "items" => array(
                            array(
...
//                            )
//                        )
//                    ), array( "title" => "其他", "items" => array( array( "title" => "会员设置", "route" => "member" ), array( "title" => "分类层级", "route" => "category" ), array( "title" => "联系方式", "route" => "contact" ), array( "title" => "地址库设置", "route" => "area" ), array( "title" => "物流信息接口", "route" => "express" ) ) ), array( "title" => "工具", "items" => array( array( "title" => "七牛存储", "route" => "qiniu", "iscom" => "qiniu" ), array( "title" => "商品价格修复", "route" => "goodsprice" ), array( "title" => "模板消息修复", "route" => "templatetool" ), array( "title" => "清空海报缓存", "route" => "postertool" ), array( "title" => "支付证书验证", "route" => "wxpaycert" ) ) ),
                    array( "title" => "入口", "route" => "cover", "items" => array( array( "title" => "商城入口", "route" => "shop" ), array( "title" => "会员中心入口", "route" => "member" ), array( "title" => "订单入口", "route" => "order" ), array( "title" => "收藏入口", "route" => "favorite" ), array( "title" => "购物车入口", "route" => "cart" ), array( "title" => "优惠券入口", "route" => "coupon" ) ) ) ) ) );
        if( !p("app") ) 
        {
            unset($shopmenu["app"]);
        }
