...
<div class="panel panel-cut" id="js-account-display" ng-controller="AccountDisplay" ng-cloak>
	<div class="panel-heading">
		...
		<span class="panel-heading-left"><i class="wi wi-wechat" style="font-size: 24px; margin-right: 10px; vertical-align:middle;"></i>请选择您要操作的商城</span>
		<div class="font-default pull-right">
			...
			<?php  if(!empty($account_info['uniacid_limit']) && (!empty($account_info['founder_uniacid_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
				...
				<a href="./index.php?c=account&a=post-step" class="color-default"><i class="fa fa-plus"></i>新增商城</a>
				<?php  } ?>
			...
			<a href="<?php  echo url('account/manage', array('account_type' => ACCOUNT_TYPE_OFFCIAL_NORMAL))?>" class="color-default"><i class="wi wi-wechatstatistics"></i>商城管理</a>
			<?php  } ?>
		</div>
	</div>
	<div class="panel-body" >
		...
		<div class="cut-list clearfix" ng-if="accountList" infinite-scroll='loadMore()' infinite-scroll-disabled='busy' infinite-scroll-distance='0' infinite-scroll-use-document-bottom="true">
			<div class="item" ng-repeat="detail in accountList" style="height: 240px;">
				<div class="content">
					<img ng-src="{{detail.logo}}" class="icon-account" onerror="this.src='./resource/images/nopic-107.png'" style="width: 100%;height: auto;margin: 0;"/>
					<div class="name" ng-bind="detail.name" style="padding-top: 6px;"></div>
					<!--<div class="type">-->
				...
				<div class="mask">
					<a ng-href="{{detail.switchurl}}" class="entry">
						...
						<div>进入商城 <i class="wi wi-angle-right"></i></div>
					</a>
