...
<div class="page-content">
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
        ...
        <div class='form-group-title'>支付类型</div>

        <div class="form-group">
            <label class="col-lg control-label">支持的支付类型</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.trade.edit')) { ?>
                ...
                <div class="input-group fixsingle-input-group">
                    <label class="checkbox-inline">
                        <input type="checkbox" name="data[pay_type][]" value="<?php  echo $item['type'];?>"
                               <?php  if(in_array($item['type'],$data['pay_type'])) { ?>checked<?php  } ?>> <?php  echo $item['name'];?>
                    </label>
                </div>
                <?php  } } ?>

                <span class='help-block'>当商品支付时，买家可以选择以上勾选的类型</span>
                <?php  } else { ?>
                <div class='form-control-static'>
