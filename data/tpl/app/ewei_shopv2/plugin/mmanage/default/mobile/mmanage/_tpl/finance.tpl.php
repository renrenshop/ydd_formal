...
<?php if (file_exists('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_plugin_mmanage_template_mobile_default__tpl_finance.php')){include('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_plugin_mmanage_template_mobile_default__tpl_finance.php');}?>
<script type="text/html" id="tpl_credit">
    <%each list as item%>
