...
<?php if (file_exists('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_goods_wholesalePicker.php')){include('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_goods_wholesalePicker.php');}?>
		...
		<div class="option-picker-inner picker-bulk">
			<div class="header">
				...
				<div class="inner">
					...
					<div class="price"><%if goods.minprice>0%><small><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_0']?></small><%goods.minprice%>-<%/if%><small><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_1']?></small><%goods.maxprice%></div>
				</div>
			...
			<%if hasoption==2%>
				...
				<div class="body" id="body_<%item.id%>" data-id="<%item.id%>"  style="display: none;">
					...
					<div class="item optiondata" data-optionid="<%if  item.id < item2.id%><%options[item.id+'_'+item2.id].id%><%else%><%options[item2.id+'_'+item.id].id%><%/if%>"  data-total="0">
						...
						<div class="right">
							<div class="total"><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_2']?>:<span class="stock">	<%if  item.id < item2.id%><%options[item.id+"_"+item2.id].stock%><%else%><%options[item2.id+"_"+item.id].stock%><%/if%></span></div>
			...
			<%if hasoption==1%>
				<div class="body">
					...
					<div class="item optiondata" data-optionid="<%options[item.id].id%>"  data-total="0">
						...
						<div class="right">
							<div class="total"><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_3']?>:<span class="stock"><%options[item.id].stock%></span></div>
							<div class="fui-number">
								<div class="minus disabled">-</div>
								<input class="num" type="tel" name="" value="0">
								<div class="plus">+</div>
			...
			<%if hasoption==0%>
				<div class="body">
					<div class="item optiondata" data-optionid="0"  data-total="0">
						...
						<div class="right">
							<div class="total"><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_4']?>:<span class="stock"><%goods.total%></span></div>
							<div class="fui-number">
								<div class="minus disabled">-</div>
								<input class="num" type="tel" name="" value="0">
								<div class="plus">+</div>
			...
			<div class="counts">
				...
				<div class="inner">
					<p  id="UnitPrice"></p>
					<p class="countprice"><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_5']?>: <?php  echo $lang['lang_template_mobile_goods_wholesalePicker_6']?><span id='totalprice'></span></p>
				</div>
			</div>
		</div>
		<div class="fui-navbar">
			<a href="javascript:;" class="nav-item btn cartbtn" style='display:none'><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_7']?></a>
			<a href="javascript:;" class="nav-item btn buybtn"  style='display:none' ><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_8']?></a>
			<a href="javascript:;" class="nav-item btn confirmbtn"  style='display:none'><?php  echo $lang['lang_template_mobile_goods_wholesalePicker_9']?></a>
		</div>
	</div>
</script>