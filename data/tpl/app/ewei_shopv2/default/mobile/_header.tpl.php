...
<?php if (file_exists('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile__header.php')){include('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile__header.php');}?>
<!doctype html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <title><?php  echo $_W['shopset']['shop']['name'];?></title>
        ...
        <script src="../addons/ewei_shopv2/lang/<?php  echo $_W['lang_type']?>/_static_js_app.js"></script>
        <script src="../addons/ewei_shopv2/lang/<?php  echo $_W['lang_type']?>/_static_js_plugin.js"></script>
