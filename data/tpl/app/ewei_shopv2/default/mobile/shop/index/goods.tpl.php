...
<?php if (file_exists('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_shop_index_goods.php')){include('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_shop_index_goods.php');}?>
<?php  if(!empty($indexrecommands)) { ?>
	<div class="fui-line" style="background: #f4f4f4;">
		<div class="text text-danger"><i class="icon icon-likefill"></i> <?php  echo $lang['lang_template_mobile_shop_index_goods_0']?></div>
	</div>
			...
			<div class="fui-goods-item" data-goodsid="<?php  echo $item['id'];?>" data-type="<?php  echo $item['type'];?>">
				...
				<div class="detail">
					<a href="<?php  echo mobileUrl('goods/detail', array('id'=>$item['id']))?>">
						<div class="name">
							<?php  if($item['ispresell']==1) { ?><i class="fui-tag fui-tag-danger"><?php  echo $lang['lang_template_mobile_shop_index_goods_1']?></i><?php  } ?>
							<?php  echo $item['title'];?>
						</div>
					</a>
					<div class="price">
						<span class="text"><?php  echo $lang['lang_template_mobile_shop_index_goods_2']?><?php  echo $item['minprice'];?>
						</span>
						<span class="buy">
