...
<?php if (file_exists('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_member_favorite.php')){include('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_member_favorite.php');}?>
...
<div class='fui-page  fui-page-current member-cart-page'>
	...
	<div class="title"><?php  echo $lang['lang_template_mobile_member_favorite_0']?></div>
	<div class="fui-header-right" >
		<a class="btn-edit" style="display: none;"><?php  echo $lang['lang_template_mobile_member_favorite_1']?></a>
	</div>
    </div>
    ...
    <div class='fui-content ' >
		...
		<div class='content-empty' style='display:none;'>
			 <i class='icon icon-like'></i><br/><?php  echo $lang['lang_template_mobile_member_favorite_2']?>~<br/><a href="<?php  echo mobileUrl()?>" class='btn btn-default-o external'><?php  echo $lang['lang_template_mobile_member_favorite_3']?>~</a>
		</div>
		  <div class='fui-list-group container' style="display:none;margin-top: 0"></div>
		  <div class='infinite-loading'><span class='fui-preloader'></span><span class='text'> <?php  echo $lang['lang_template_mobile_member_favorite_4']?>...</span></div>
		</div>
		<div class="fui-footer editmode">
		<div class="fui-list noclick">
			<div class="fui-list-media">
			<label class="checkbox-inline editcheckall"><input type="checkbox" name="checkbox" class="fui-radio fui-radio-danger " />&nbsp;<?php  echo $lang['lang_template_mobile_member_favorite_5']?></label>
			</div>
			<div class="fui-list-inner"></div>

			<div class='fui-list-angle'>
			<div class="btn  btn-danger btn-delete  disabled"><?php  echo $lang['lang_template_mobile_member_favorite_6']?></div>
			</div>
		</div>
    </div>
