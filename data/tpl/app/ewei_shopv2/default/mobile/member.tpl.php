...
<?php if (file_exists('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_member_index.php')){include('/www/wwwroot/fxv2_d/addons/ewei_shopv2/lang/'.$_W['lang_type'].'/_template_mobile_member_index.php');}?>
...
<div class='fui-page  fui-page-current'>
    <div class="fui-header">
		...
		<div class="title"><?php  echo $lang['lang_template_mobile_member_index_0']?></div>
	...
	<div class='fui-content member-page navbar'>
		<div style="overflow: hidden;height: 9rem;position: relative;background: #fff">
			<div class="headinfo" style="z-index:100;border: none;">
				...
				<div class="child">
					...
					<?php  if(empty($_W['shopset']['trade']['closerecharge'])) { ?><a href="<?php  echo mobileUrl('member/recharge')?>"><div class="btn"><?php  echo $lang['lang_template_mobile_member_index_1']?></div></a><?php  } ?>
				</div>
				<div class="child userinfo">
					...
					[<?php  if(empty($_W['shopset']['shop']['levelname'])) { ?><?php  echo $lang['lang_template_mobile_member_index_2']?><?php  } else { ?><?php  echo $_W['shopset']['shop']['levelname'];?><?php  } ?>]
					<?php  } else { ?>
			...
			<div class="child">
				...
				<?php  if($open_creditshop) { ?><a href="<?php  echo mobileUrl('creditshop')?>" class="external"><div class="btn"><?php  echo $lang['lang_template_mobile_member_index_3']?></div></a><?php  } ?>
			</div>
		</div>
		...
		<div class='member_card'>
			...
			<div class='title'><?php  echo $lang['lang_template_mobile_member_index_32']?></div>
			<?php  if(count($list_membercard['list'])) { ?>
			<div class='card-num'><?php  echo $lang['lang_template_mobile_member_index_33']?><?php  echo count($list_membercard['list'])?><?php  echo $lang['lang_template_mobile_member_index_34']?></div>
			<?php  } else { ?>
			<div class='card-num'><?php  echo $lang['lang_template_mobile_member_index_35']?></div>
			<?php  } ?>
		</div>
		</a>
		<?php  } ?>
        ...
        <?php  if(p('task')->get_unread()) { ?>
            <div class="fui-cell-group fui-cell-click" style="border-top: 1px solid #ebebeb;border-bottom: 1px solid #ebebeb;    margin-bottom: 0.5rem;">
                <a class="fui-cell external" href="<?php  echo mobileUrl('task')?>">
                    ...
                    <div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_36']?></p><span class="task-red-mark"></span></div>
        ...
        <?php  } else if(p('task')->TasknewEntrance()) { ?>
            <div class="fui-cell-group fui-cell-click" style="border-top: 1px solid #ebebeb;border-bottom: 1px solid #ebebeb;    margin-bottom: 0.5rem;">
                <a class="fui-cell" href="<?php  echo mobileUrl('task')?>">
                    <div class="fui-cell-icon"><i class="icon icon-gifts"></i></div>
                    <div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_13']?></p></div>
                    <div class="fui-cell-remark"></div>
                </a>
            </div>
        <?php  } ?>
	...
	<div class="fui-cell-group fui-cell-click" style="margin-top: 0">
		<a class="fui-cell external" href="<?php  echo mobileUrl('order')?>">
			...
			<div class="fui-cell-text"><?php  echo $lang['lang_template_mobile_member_index_7']?></div>
			<div class="fui-cell-remark" style="font-size: 0.65rem;"><?php  echo $lang['lang_template_mobile_member_index_8']?></div>
		</a>
		...
		<div class="fui-icon-group selecter <?php  if($check_cycelbuy) { ?>col-5<?php  } else { ?>col-4<?php  } ?>">
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>0))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_9']?></div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>1))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_10']?></div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>2))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_11']?></div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>4))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_12']?></div>
			</a>
			<?php  if($check_cycelbuy) { ?>
				<a class="fui-icon-col external before" href="<?php  echo mobileUrl('cycelbuy/order/list')?>">
					...
					<div class="text"><?php  echo $lang['lang_template_mobile_member_index_37']?></div>
				</a>
			<?php  } ?>
		</div>
	</div>
			...
			<div class="fui-cell-group fui-cell-click external">
				<a class="fui-cell"  href="<?php  echo mobileUrl('member/bind')?>">
					<div class="fui-cell-text">
						...
						<?php  echo $lang['lang_template_mobile_member_index_4']?>
						<div class="fui-cell-tip"><?php  echo $lang['lang_template_mobile_member_index_5']?></div>
					</div>
					<div class="fui-cell-remark"></div>
				</a>
			</div>
			...
			<div class="fui-cell-group fui-cell-click external">
				<a class="fui-cell"  href="<?php  echo mobileUrl('mmanage')?>" data-nocache="true">
					<div class="fui-cell-text">
						...
						<div class="fui-cell-tip"><?php  echo $lang['lang_template_mobile_member_index_6']?></div>
					</div>
					<div class="fui-cell-remark"></div>
				</a>
			</div>
	...
	<div class="fui-cell-group fui-cell-click">
		<a class="fui-cell external" href="<?php  echo mobileUrl('newstore/norder')?>">
			...
			<div class="fui-cell-text"><?php  echo $lang['lang_template_mobile_member_index_46']?></div>
			<div class="fui-cell-remark" style="font-size: 0.65rem;"><?php  echo $lang['lang_template_mobile_member_index_47']?></div>
		</a>
		<div class="fui-icon-group selecter">
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('newstore/norder',array('status'=>0))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_39']?></div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('newstore/norder',array('status'=>1))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_40']?></div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('newstore/norder',array('status'=>3))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_41']?></div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('newstore/norder',array('status'=>4))?>">
				...
				<div class="text"><?php  echo $lang['lang_template_mobile_member_index_42']?></div>
			</a>
		</div>
	</div>
	<?php  } ?>
	...
	<div class="fui-cell-group fui-cell-click">
		<a class="fui-cell external" href="<?php  echo mobileUrl('verifygoods')?>">
			<div class="fui-cell-icon"><i class="icon icon-list"></i></div>
			<div class="fui-cell-text"><?php  echo $lang['lang_template_mobile_member_index_43']?></div>
		...
		<div class="fui-icon-group selecter" style="overflow: scroll;">
			<ul class="banner-ul">
				...
				<div></div>
				<span>  <?php  if($item['cangetcard']) { ?>  <?php  echo $lang['lang_template_mobile_member_index_44']?> <?php  } else { ?><?php  echo $lang['lang_template_mobile_member_index_45']?><?php  } ?></span>
	...
	<?php  if($hascoupon) { ?>
		<div class="fui-cell-group fui-cell-click">
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('sale/coupon')?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_14']?></p></div>
			...
			<a class="fui-cell"  href="<?php  echo mobileUrl('sale/coupon/my')?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_15']?></p></div>
		...
		<div class="fui-cell-group fui-cell-click">
			<a class="fui-cell"  href="<?php  echo mobileUrl('lineup')?>">
				<div class="fui-cell-icon"><i class="icon icon-profile"></i></div>
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_16']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
		</div>
		<?php  } ?>
		...
		<div class="fui-cell-group fui-cell-click">
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('member/rank');?>">
				...
				<div class="fui-cell-text"><p><?php  echo $_W['shopset']['trade']['credittext'];?><?php  echo $lang['lang_template_mobile_member_index_17']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<?php  } ?>
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('member/rank/order_rank');?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_18']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<?php  } ?>
		</div>
	    ...
	    <div class="fui-cell-group fui-cell-click">
			<a class="fui-cell" href="<?php  echo mobileUrl('member/cart');?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_19']?></p></div>
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('member/favorite');?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_20']?></p></div>
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('member/history');?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_21']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
			...
			<a class="fui-cell external" href="<?php  echo mobileUrl('member/fullback');?>" data-nocache="true">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_22']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
			<?php  } ?>
		</div>
		...
		<div class="fui-cell-group fui-cell-click">
			...
			<a class="fui-cell" href="<?php  echo mobileUrl('member/withdraw')?>">
				...
				<div class="fui-cell-text"><p><?php  echo $_W['shopset']['trade']['moneytext'];?><?php  echo $lang['lang_template_mobile_member_index_24']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
		    <?php  } ?>
			<a class="fui-cell" href="<?php  echo mobileUrl('member/log')?>">
				...
				<div class="fui-cell-text"><p>
				    <?php  if($_W['shopset']['trade']['withdraw']==1) { ?><?php  echo $_W['shopset']['trade']['moneytext'];?><?php  echo $lang['lang_template_mobile_member_index_25']?><?php  } else { ?><?php  echo $lang['lang_template_mobile_member_index_26']?><?php  } ?>
				    </p></div>
				<div class="fui-cell-remark"></div>
			</a>
		</div>
		<div class="fui-cell-group fui-cell-click">
			<a class="fui-cell" href="<?php  echo mobileUrl('member/address')?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_27']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
		</div>
	<?php  if($hasqa) { ?>
		<div class="fui-cell-group fui-cell-click">
			<a class="fui-cell external" href="<?php  echo mobileUrl('qa')?>">
				...
				<div class="fui-cell-text"><p><?php  echo $lang['lang_template_mobile_member_index_28']?></p></div>
				<div class="fui-cell-remark"></div>
			</a>
		</div>
	<?php  } ?>
	...
	<div class="fui-cell-group fui-cell-click transparent">
		<a class="fui-cell external changepwd" href="<?php  if(!empty($member['mobileverify'])) { ?><?php  echo mobileUrl('member/changepwd')?><?php  } else { ?><?php  echo mobileUrl('member/bind')?><?php  } ?>">
			<div class="fui-cell-text" style="text-align: center;"><p><?php  echo $lang['lang_template_mobile_member_index_29']?></p></div>
		</a>
		<a class="fui-cell external btn-logout">
			<div class="fui-cell-text" style="text-align: center;"><p><?php  echo $lang['lang_template_mobile_member_index_30']?></p></div>
		</a>
	</div>
		...
		<div class="verify-pop pop">
			...
			<div class="qrcode">
				...
				<div class="inner-btn" style="padding: 0.5rem">
					<div class="btn btn-warning" style="width: 100%; margin: 0"><?php  echo $lang['lang_template_mobile_member_index_31']?></div>
				</div>
			</div>
		</div>
	</div>
